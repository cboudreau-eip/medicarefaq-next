...
export const simpleFAQBatch4: SimpleFAQArticleData[] = [
  ...
  // does-medicare-cover-gender-reassignment-surgery moved to coverage-data.ts
  {
    ...
    seo: {
      ...
      description: 'Knowing when you can change Medicare Supplement Plan can be difficult. There are factors you should know which are discussed further in this resource article.',
  ...
  },
  {
    ...
    seo: {
      title: 'What is the Medicare Advantage 5-Star Special Enrollment Period?',
      description: 'The Medicare Advantage 5-star special enrollment period allows you to enroll in a 5-star Medicare Advantage plan outside of the standard enrollment period.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-advantage-5-star-special-enrollment-period/',
      ogImage: 'https://www.medicarefaq.com/wp-content/uploads/five-star-snp-featured-image.jpeg',
    },
    title: 'What is the Medicare Advantage 5-Star Special Enrollment Period?',
    summary: '',
    ...
    sections: [
      ...
      {
        heading: 'What is a 5-Star Medicare Advantage Rating?',
        paragraphs: [
        ],
        listItems: [
          'Quality of Care',
