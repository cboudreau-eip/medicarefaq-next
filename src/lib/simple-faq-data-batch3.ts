...
export const simpleFAQBatch3: SimpleFAQArticleData[] = [  {
  ...
  // does-medicare-cover-atrial-fibrillation-afib moved to coverage-data.ts
  {
    ...
    richSections: [
      ...
      { type: "image", src: "https://d2xsxph8kpxj0f.cloudfront.net/310519663444965628/gUNDzJhadva78ZtnmXvVsR/medicare-cta-banner-find-plan-short-4CSv5jcpyyMJCXLKrN3fpo.png", alt: "Find the Right Medicare Plan for You", link: "/find-plans/" },
