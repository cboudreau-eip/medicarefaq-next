...
export const simpleFAQBatch3: SimpleFAQArticleData[] = [  {
  ...
  // does-medicare-cover-atrial-fibrillation-afib moved to coverage-data.ts
  {
    ...
    richSections: [
      ...
      { type: "paragraph", content: "You may also be eligible before age 65 if you have received [Social Security Disability Insurance (SSDI)](/faqs/is-medicare-free/) for 24 consecutive months, have been diagnosed with ALS (Lou Gehrig's disease), or have end-stage renal disease (ESRD). In those cases, Medicare enrollment is handled differently and often begins automatically." },
