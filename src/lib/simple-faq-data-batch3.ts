...
export const simpleFAQBatch3: SimpleFAQArticleData[] = [  {
  ...
  },
  {
    ...
    seo: {
      ...
      description: 'Medicare coverage isn’t always mandatory. But, if you delay enrollment, penalties can occur. Learn if Medicare is mandatory and your options!',
    ...
    title: 'Is Medicare Mandatory?',
    summary: 'For most, Medicare isn’t mandatory, but there are a lot of variables you’ll want to consider before choosing to opt-out. Without careful consideration, you will not only be underprepared for healthcare costs, but you may also face costly penalties if you sign up down the road.',
    category: 'Medicare FAQ',
    dateUpdated: 'June 6, 2025',
    author: 'David Haass',
    reviewer: 'Ashlee Zareczny',
    readTime: '',
    sections: [
