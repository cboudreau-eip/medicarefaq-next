...
export const simpleFAQBatch3: SimpleFAQArticleData[] = [  {
    ...
    seo: {
      title: 'Medicare Preventive Services: What Is Covered at No Cost (2026)',
      description: 'Medicare covers a wide range of preventive screenings, vaccines, and exams at no cost to you when you use a participating provider. Learn what is covered and how to access it.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-preventive-services/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'Medicare Preventive Services Guide',
    summary: 'Medicare covers dozens of preventive services at no cost to you, including cancer screenings, cardiovascular tests, diabetes care, mental health screenings, and vaccines. These services are available under Part B when you see a participating provider and the service is billed as preventive.',
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'Medicare Part B covers a broad range of preventive services at no cost to you when you see a participating provider and the service is billed as preventive. This means no deductible and no coinsurance for covered preventive care. The goal is to catch health problems early, before they become more serious and more expensive to treat.' },
      { type: 'callout', calloutType: 'info', calloutTitle: 'No Cost Only When Billed as Preventive', calloutText: 'If your provider addresses a new or existing medical problem during the same visit as a preventive service, the treatment portion may be billed separately and subject to standard cost-sharing. Always confirm with your provider how the visit will be billed.' },
      { type: 'heading', level: 2, text: 'Cancer Screenings', id: 'cancer-screenings' },
      { type: 'table', title: 'Medicare-Covered Cancer Screenings', headers: ['Screening', 'Frequency', 'Who Is Eligible'], rows: [
      ...
      { type: 'heading', level: 2, text: 'Cardiovascular and Diabetes Screenings', id: 'cardiovascular-diabetes' },
      { type: 'table', title: 'Cardiovascular and Diabetes Preventive Services', headers: ['Service', 'Frequency', 'Notes'], rows: [
      ...
      { type: 'heading', level: 2, text: 'Mental Health and Cognitive Screenings', id: 'mental-health' },
      { type: 'paragraph', content: 'Medicare covers annual depression screenings at no cost in a primary care setting. Cognitive impairment assessments are also covered as part of the Annual Wellness Visit. If your provider identifies a concern during a screening, follow-up treatment visits may have standard cost-sharing.' },
      { type: 'heading', level: 2, text: 'Vaccines Covered by Medicare', id: 'vaccines' },
      { type: 'table', title: 'Medicare-Covered Vaccines', headers: ['Vaccine', 'Coverage', 'Notes'], rows: [
      ...
      { type: 'faq', faqs: [
        { question: 'Does Medicare cover an annual physical exam?', answer: 'Medicare does not cover a traditional annual physical. However, it does cover the Annual Wellness Visit (AWV) each year and the one-time Welcome to Medicare Preventive Visit. These are preventive reviews, not physicals, and do not include a head-to-toe physical examination.' },
        { question: 'Are preventive services covered under Medicare Advantage?', answer: 'Yes. Medicare Advantage plans must cover all Medicare-required preventive services at no cost when you use in-network providers. Some plans offer additional preventive benefits beyond what Original Medicare requires.' },
        { question: 'What if my doctor recommends a preventive service that Medicare does not cover?', answer: 'You will be responsible for the cost. Ask your provider in advance whether a recommended service is covered by Medicare as preventive. You can also check the Medicare coverage tool at [medicare.gov](https://www.medicare.gov/).' },
      ]},
    ],
  ...
  },
  {
    ...
    seo: {
      title: 'Qualified Health Plans and Medicare: What to Do When You Turn 65 (2026)',
      description: 'If you have a Marketplace Qualified Health Plan (QHP) and are approaching Medicare eligibility, you need to act. Learn when to drop your QHP, how ACA subsidies change, and what happens if you keep both.',
      canonical: 'https://www.medicarefaq.com/faqs/qualified-health-plans-medicare/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'Qualified Health Plans and Medicare',
    summary: 'If you are enrolled in an ACA Marketplace Qualified Health Plan (QHP) and are approaching age 65, you need to understand how Medicare eligibility affects your coverage and your premium tax credits. In most cases, you will need to drop your QHP when Medicare begins.',
    category: 'Medicare FAQ',
    dateUpdated: 'May 12, 2026',
    author: 'David Haass',
    reviewer: 'Ashlee Zareczny',
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'A Qualified Health Plan (QHP) is a health insurance plan sold through the ACA Marketplace ([Healthcare.gov](https://www.healthcare.gov/) or a state exchange) that meets the coverage standards set by the Affordable Care Act. Many people use QHPs with premium tax credits (subsidies) to afford coverage before they reach Medicare eligibility at age 65. Once you become eligible for Medicare, the rules change significantly.' },
      { type: 'heading', level: 2, text: 'You Cannot Receive ACA Subsidies Once You Are Medicare-Eligible', id: 'no-subsidies' },
      { type: 'paragraph', content: 'This is the most important rule: once you are eligible for Medicare Part A (even if you have not enrolled), you lose eligibility for premium tax credits on a Marketplace QHP. If you continue receiving subsidies after becoming Medicare-eligible, you may have to repay them when you file your taxes. The IRS considers Medicare-eligible individuals ineligible for the premium tax credit regardless of whether they actually enroll in Medicare.' },
      { type: 'callout', calloutType: 'warning', calloutTitle: 'Eligibility, Not Enrollment, Is What Matters', calloutText: 'You lose ACA subsidy eligibility the moment you become eligible for Medicare Part A, not when you actually enroll. For most people, this is the month they turn 65. If you delay enrolling in Medicare but are still eligible, you cannot legally receive premium tax credits on a QHP.' },
      { type: 'heading', level: 2, text: 'What to Do When You Turn 65', id: 'what-to-do' },
      { type: 'table', title: 'QHP to Medicare Transition Steps', headers: ['Step', 'Action', 'Timing'], rows: [
      ...
      { type: 'heading', level: 2, text: 'Special Enrollment Period for Losing QHP Coverage', id: 'sep' },
      { type: 'paragraph', content: 'When you voluntarily cancel your QHP to enroll in Medicare, this does not trigger a Medicare Special Enrollment Period. Your Medicare enrollment is governed by your Initial Enrollment Period (the 7-month window around your 65th birthday). If you are already past your IEP, you may need to wait for the General Enrollment Period (January 1 through March 31) and could face late enrollment penalties.' },
      { type: 'heading', level: 2, text: 'Can You Keep a QHP Alongside Medicare?', id: 'keep-both' },
      { type: 'paragraph', content: 'Technically you can keep a QHP after enrolling in Medicare, but it is almost never beneficial. You will not receive subsidies, so you will pay full unsubsidized QHP premiums on top of your Medicare premiums. Medicare will be primary, and the QHP will be secondary. In most cases, a Medigap plan or Medicare Advantage plan is a far more cost-effective way to supplement Medicare.' },
      { type: 'faq', faqs: [
        { question: 'What if I want to delay Medicare Part B and keep my QHP?', answer: 'You can delay Part B without penalty only if you have coverage through your own or your spouse\'s current employer group health plan. A QHP from the Marketplace does not qualify as a reason to delay Part B without penalty. Delaying Part B while on a QHP will result in a late enrollment penalty.' },
        { question: 'Does enrolling in Medicare count as a qualifying life event for the Marketplace?', answer: 'No. Enrolling in Medicare does not create a Special Enrollment Period for the Marketplace. However, losing your QHP because you enrolled in Medicare may qualify you for a Marketplace SEP to enroll a spouse or dependent who was on your plan.' },
  ...
  },
  {
    ...
    seo: {
      title: 'Is Medicare Mandatory? What Happens If You Opt Out in 2026',
      description: 'Medicare is not legally mandatory, but opting out comes with serious financial consequences. Learn when you can delay enrollment without penalty and what happens if you refuse Medicare.',
      canonical: 'https://www.medicarefaq.com/faqs/is-medicare-mandatory/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'Is Medicare Mandatory? What Happens If You Opt Out',
    summary: 'Medicare is not legally required, but choosing to delay or refuse enrollment without a qualifying reason can result in permanent premium penalties and gaps in coverage. Understanding when you can safely delay Medicare, and when you cannot, is one of the most important decisions you will make as you approach age 65.',
    category: 'Medicare FAQ',
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'No federal law forces you to enroll in Medicare. You will not be arrested or fined for declining it. However, the financial consequences of delaying or refusing Medicare without a valid reason can be severe and permanent. For most Americans turning 65, enrolling in Medicare on time is not just advisable. It is one of the most important financial decisions they will make.' },
      { type: 'heading', level: 2, text: 'Is Medicare Part A Mandatory?', id: 'is-part-a-mandatory' },
      { type: 'paragraph', content: '[Medicare Part A](/original-medicare/medicare-parts/medicare-part-a/) (hospital insurance) is premium-free for most people who have worked and paid Medicare taxes for at least 10 years (40 quarters). Because it costs nothing, most people accept it automatically. However, if you are receiving Social Security benefits when you turn 65, you are automatically enrolled in Part A and Part B. Opting out of Part A while receiving Social Security is not permitted without also giving up your Social Security benefits.' },
      { type: 'callout', calloutType: 'info', calloutTitle: 'Automatic Enrollment If You Receive Social Security', calloutText: 'If you are already collecting Social Security or Railroad Retirement Board benefits when you turn 65, you will be automatically enrolled in Medicare Parts A and B. Your Medicare card will arrive in the mail about 3 months before your 65th birthday. You can decline Part B, but you cannot decline Part A while keeping Social Security.' },
      { type: 'heading', level: 2, text: 'Is Medicare Part B Mandatory?', id: 'is-part-b-mandatory' },
      { type: 'paragraph', content: '[Medicare Part B](/original-medicare/medicare-parts/medicare-part-b/) (medical insurance) is optional in the sense that you can decline it. However, declining Part B without having qualifying employer-sponsored coverage means you will face a permanent late enrollment penalty when you eventually do enroll. The penalty is 10% of the standard Part B premium for every 12-month period you were eligible but not enrolled. At the 2026 standard premium of $202.90 per month, a 3-year delay adds $60.87 to your monthly premium permanently.' },
      { type: 'table', title: 'Part B Late Enrollment Penalty Examples (2026)', headers: ['Years Delayed', 'Penalty Percentage', 'Monthly Premium Increase', 'New Monthly Premium'], rows: [
        ['1 year', '10%', '+$20.29', '$223.19'],
        ['2 years', '20%', '+$40.58', '$243.48'],
        ['3 years', '30%', '+$60.87', '$263.77'],
        ['5 years', '50%', '+$101.45', '$304.35'],
      ]},
      { type: 'heading', level: 2, text: 'When Can You Legally Delay Medicare Without Penalty?', id: 'when-can-you-delay' },
      { type: 'paragraph', content: 'There is one primary situation in which you can delay Medicare Part B enrollment without facing a late enrollment penalty: you or your spouse are actively employed and covered under a group health plan from an employer with 20 or more employees. In this case, your employer coverage is considered creditable, and you can delay Part B until that coverage ends. When it does, you have an 8-month [Special Enrollment Period (SEP)](/faqs/medicare-special-enrollment-periods) to enroll in Part B without penalty.' },
      { type: 'table', title: 'Can You Delay Medicare Without Penalty?', headers: ['Your Situation', 'Can You Delay?', 'Notes'], rows: [
      ...
      { type: 'heading', level: 2, text: 'What About Medicare Part D?', id: 'is-part-d-mandatory' },
      { type: 'paragraph', content: '[Medicare Part D](/original-medicare/medicare-parts/medicare-part-d/) (prescription drug coverage) is also optional, but the same penalty logic applies. If you go 63 or more days without creditable drug coverage after becoming eligible for Part D, you will owe a late enrollment penalty when you eventually enroll. The penalty is 1% of the national base beneficiary premium ($38.99 in 2026) multiplied by the number of full months you lacked creditable coverage. Unlike Part B, the Part D penalty is recalculated each year as the base premium changes.' },
      { type: 'heading', level: 2, text: 'Can You Opt Out of Medicare Entirely?', id: 'opt-out-entirely' },
      { type: 'paragraph', content: 'Technically, yes, but the consequences are significant. To refuse Medicare Part A while still receiving Social Security benefits is not permitted. If you want to opt out of Part A entirely, you would have to repay all Social Security benefits you have received and forgo future benefits. For Part B and Part D, you can decline enrollment, but you will face permanent penalties when you later enroll. Very few people have a financial reason to opt out of Medicare entirely.' },
      { type: 'callout', calloutType: 'warning', calloutTitle: 'TRICARE Beneficiaries Must Enroll in Part B', calloutText: 'If you are a military retiree with TRICARE, you are required to enroll in Medicare Part B when you become eligible at 65. Failing to do so will result in loss of your TRICARE coverage. This is one situation where Medicare enrollment is effectively mandatory.' },
      { type: 'heading', level: 2, text: 'Frequently Asked Questions', id: 'faqs' },
      { type: 'faq', faqs: [
        { question: 'What happens if I never sign up for Medicare?', answer: 'If you never enroll in Medicare Part B, you will face a permanent late enrollment penalty when you eventually do sign up. You will also be responsible for 100% of covered medical costs during the period you were uninsured, since Medicare would not be paying any claims.' },
        { question: 'Can I have Medicare and private insurance at the same time?', answer: 'Yes. Many people have both Medicare and additional coverage such as a Medigap plan, employer retiree insurance, or Medicaid. Medicare coordinates with other coverage according to specific rules that determine which plan pays first.' },
        { question: 'Is Medicare mandatory if I have VA benefits?', answer: 'No, but it is strongly recommended. VA benefits only cover care received at VA facilities. If you need care outside the VA system, Medicare would cover it. Enrolling in Part B gives you a safety net for non-VA care and does not affect your VA benefits.' },
        { question: 'Can I refuse Medicare if I have good employer coverage?', answer: 'If you have active employer coverage from a company with 20 or more employees, you can delay Part B without penalty. However, once that coverage ends, you must enroll within 8 months to avoid the late enrollment penalty.' },
  ...
  },
  {
    ...
    seo: {
      title: 'Medicare Paperless Premium Billing',
      description: 'Medicare has been improving its paperless billing options. You can now choose to receive your Medicare Summary Notices and the Medicare and You handbook electronically.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-paperless-billing/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'Medicare Paperless Premium Billing',
    summary: 'Medicare has been improving its paperless billing options, and you can now choose to receive your Medicare Summary Notices and the Medicare and You handbook electronically. If you pay your own Part B premiums because you are not yet on Social Security, you can arrange automatic payments. Paperless options for Medicare Advantage, Part D plans, and Medigap plans vary depending on which insurance company issues the policy.',
    category: 'Medicare FAQ',
  ...
  // does-medicare-cover-atrial-fibrillation-afib moved to coverage-data.ts
  {
    ...
    seo: {
      title: 'How to Apply for Medicare in 2026: Step-by-Step Guide',
      description: 'How to apply for Medicare Part A and Part B in 2026. Step-by-step instructions, enrollment windows, documents needed, and how to avoid late penalties.',
      canonical: 'https://www.medicarefaq.com/faqs/applying-for-medicare/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'How to Apply for Medicare',
    summary: 'Step-by-step instructions for applying for Medicare Part A and Part B in 2026, including all three application methods, enrollment windows, required documents, how to add Part B if you already have Part A, and how to avoid permanent late penalties.',
    category: 'Enrollment',
    ...
    sections: [],
    richSections: [
      { type: "paragraph", content: "To apply for Medicare, visit ssa.gov/medicare, call 1-800-772-1213, or visit your local Social Security office. Most people become eligible at age 65, though you can apply up to 3 months before your birthday month. If you are already receiving Social Security or Railroad Retirement Board benefits, you will be enrolled in [Medicare Part A and Part B](/original-medicare) automatically and your card will arrive about 3 months before you turn 65." },
      { type: "paragraph", content: "If you are not yet collecting Social Security, you will need to sign up yourself. The steps below walk you through the full process, whether you are enrolling for the first time, adding Part B to existing Part A coverage, or applying for Medicare based on a disability." },
      { type: "callout", calloutType: "warning", calloutTitle: "Do Not Miss Your Window", calloutText: "If you miss your Initial Enrollment Period and do not have qualifying employer coverage, you could face a permanent 10% penalty on your Part B premium for every 12 months you were eligible but did not enroll. At 2026 rates, a 3-year delay means paying $240.50/month instead of $202.90 for life." },
      { type: "heading", level: 2, text: "Step 1: Confirm When You Are Eligible", id: "eligibility" },
      { type: "paragraph", content: "Most people become eligible for Medicare at age 65. You can enroll during a 7-month Initial Enrollment Period (IEP) that starts 3 months before the month of your 65th birthday, includes your birthday month, and ends 3 months after. Enrolling in the first 3 months of your IEP gives you the earliest possible coverage start date." },
      { type: "paragraph", content: "You may also be eligible before age 65 if you have received [Social Security Disability Insurance (SSDI)](/faqs/medicare-and-disability) for 24 consecutive months, have been diagnosed with ALS (Lou Gehrig's disease), or have end-stage renal disease (ESRD). In those cases, Medicare enrollment is handled differently and often begins automatically." },
      { type: "table", title: "Medicare Eligibility Pathways", headers: ["Situation", "When You Become Eligible", "How You Enroll"], rows: [
        ["Turning 65, already on Social Security", "3 months before your 65th birthday", "Automatic. Card arrives in the mail."],
        ["Turning 65, not on Social Security", "3 months before your 65th birthday", "You must apply at [ssa.gov](https://www.ssa.gov/), by phone, or in person."],
        ["Under 65 with SSDI for 24 months", "25th month of receiving SSDI", "Automatic enrollment in Parts A and B."],
        ["ALS diagnosis", "Month SSDI begins", "Automatic enrollment in Parts A and B."],
        ["End-stage renal disease (ESRD)", "Varies by treatment type", "Must apply through Social Security."],
      ]},
      { type: "heading", level: 2, text: "Step 2: Choose How to Apply", id: "how-to-apply" },
      { type: "paragraph", content: "The Social Security Administration (SSA) handles Medicare enrollment. There are three ways to apply:" },
      ...
      { type: "heading", level: 2, text: "Step 3: Gather Your Documents", id: "documents" },
      ...
      { type: "heading", level: 2, text: "Step 4: Submit Your Application", id: "submit" },
      { type: "paragraph", content: "Once you have your documents ready, complete your application using one of the three methods above. The online application takes about 10-30 minutes. After submitting, you will receive a confirmation number. Keep this for your records. You should receive your Medicare card within 2-4 weeks. You can also access a digital copy of your card through your Medicare.gov account." },
      { type: "heading", level: 2, text: "How to Apply for Medicare Part A Specifically", id: "apply-for-part-a" },
      { type: "paragraph", content: "[Medicare Part A](/original-medicare/medicare-parts/medicare-part-a) (hospital insurance) is premium-free for most people who have worked and paid Medicare taxes for at least 10 years (40 quarters). Because it costs nothing, most people accept it automatically. If you are not automatically enrolled and need to apply for Part A specifically, you do so through the same Social Security application process described above." },
      { type: "paragraph", content: "If you worked fewer than 40 quarters but at least 30 quarters, you can still get Part A by paying a reduced premium ($284/month in 2026). If you worked fewer than 30 quarters, the full premium is $518/month in 2026. In either case, you apply through Social Security." },
      { type: "table", title: "Part A Premium Based on Work History (2026)", headers: ["Quarters Worked", "Monthly Part A Premium"], rows: [
        ["40 or more (10+ years)", "$0 (premium-free)"],
      ...
      { type: "paragraph", content: "When you can enroll in Medicare depends on your specific situation. There are three main [enrollment periods](/faqs/medicare-initial-enrollment-period/) you should know about:" },
      ...
      { type: "heading", level: 2, text: "Use the Medicare Enrollment Timeline Tool", id: "timeline-tool" },
      { type: "paragraph", content: "Not sure when your enrollment window opens or exactly when your coverage will start? Our [Medicare Decision Kit](/tools/decision-kit/) generates a personalized enrollment timeline based on your date of birth. Enter your birthday and get a custom PDF showing your IEP dates, coverage start date, and key deadlines, all in one place." },
      { type: "image", src: "/images/cta-banner-find-plan.jpg", alt: "Find the Right Medicare Plan for You", link: "https://demographics.medicarecompared.com/ms/" },
      { type: "heading", level: 2, text: "Avoiding Late Enrollment Penalties", id: "penalties" },
      { type: "paragraph", content: "One of the biggest mistakes new Medicare beneficiaries make is missing their enrollment window. If you do not sign up for Part B when you are first eligible and you do not have qualifying employer coverage, you will face a [late enrollment penalty](/medicare-enrollment/late-penalties) that lasts for as long as you have Part B." },
      ...
      {
        type: 'eddie-pro-tip',
        content: 'The single most important thing you can do is apply 3 months before your 65th birthday. That one step ensures your coverage starts on the first day of your birthday month, and it gives you time to choose a Medigap plan during your open enrollment window when insurers cannot turn you down. I have seen too many people wait until their birthday and then scramble. Three months early is the sweet spot.',
      },
      ...
      { type: "faq", faqs: [
        ...
        { question: "Can I have both employer coverage and Medicare at the same time?", answer: "Yes. If you [work past 65](/medicare-enrollment/working-past-65) at a company with 20+ employees, your employer plan is typically primary and Medicare is secondary. Many people enroll in premium-free Part A while keeping their employer plan, then add Part B when they retire." },
        { question: "How do I apply for Medicare Part A only?", answer: "You apply for Part A through Social Security, the same way you apply for full Medicare. If you want Part A without Part B, you can decline Part B during the application. Most people who are still working with employer coverage take this approach: enroll in premium-free Part A now and add Part B when they retire." },
      ]},
    ],
  ...
  },
  {
    ...
    richSections: [
      ...
      { type: "list", ordered: false, items: [
        ...
        "If you are enrolling after 65 (for example, after leaving [employer coverage](/medicare-enrollment/working-past-65)), issue-age-rated plans are especially attractive because your rate is locked at your enrollment age",
      ...
      { type: "list", ordered: false, items: [
        ...
        "Health status - during your [Medigap Open Enrollment Period](/faqs/medicare-initial-enrollment-period/), insurers cannot charge more for pre-existing conditions. Outside that window, medical underwriting may apply."
      ]},
...

  {
    ...
    seo: {
      title: 'Average Cost of Medicare Supplement Plans in 2026',
      description: 'Medicare Supplement (Medigap) plan premiums vary by plan type, age, gender, location, and pricing method. Learn what drives the cost and what you can expect to pay for the most popular plans in 2026.',
      canonical: 'https://www.medicarefaq.com/faqs/average-cost-of-medicare-supplement-plans/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'Average Cost of Medicare Supplement Plans',
    summary: 'The cost of a Medicare Supplement (Medigap) plan depends on the plan letter you choose, your age, your gender, where you live, and how the insurer prices its policies. While premiums vary widely, understanding the key pricing factors can help you find a plan that fits your budget without sacrificing coverage.',
    category: 'Medicare Supplements',
    dateUpdated: 'May 12, 2026',
    author: 'David Haass',
    reviewer: 'Ashlee Zareczny',
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'Medicare Supplement plans, also called Medigap, help pay for costs that Original Medicare does not cover, such as copayments, coinsurance, and deductibles. Because all insurers must offer the same standardized benefits for each plan letter, the main difference between policies is price. Premiums can range from under $100 per month to over $400 per month depending on several factors.' },
      { type: 'heading', level: 2, text: 'Average Monthly Premiums by Plan Type (2026)', id: 'average-premiums' },
      { type: 'table', title: 'Estimated Average Monthly Premiums for a 65-Year-Old Female Non-Smoker', headers: ['Plan', 'Average Monthly Premium', 'What It Covers'], rows: [
      ...
      { type: 'callout', calloutType: 'info', calloutTitle: 'Premiums Vary Significantly by Location', calloutText: 'The figures above are national averages for a 65-year-old female non-smoker. Actual premiums can be 30-50% higher or lower depending on your state and ZIP code. States like New York and Massachusetts have community rating laws that can make premiums higher at age 65 but more stable over time.' },
      { type: 'heading', level: 2, text: 'What Factors Affect Your Premium?', id: 'pricing-factors' },
      { type: 'table', title: 'Medigap Pricing Factors', headers: ['Factor', 'How It Affects Cost'], rows: [
      ...
      { type: 'heading', level: 2, text: 'The Three Pricing Methods', id: 'pricing-methods' },
      { type: 'paragraph', content: 'Not all Medigap insurers price their policies the same way. The pricing method affects how your premium changes over time, not just what you pay today.' },
      { type: 'table', title: 'Medigap Pricing Methods Compared', headers: ['Method', 'How It Works', 'Long-Term Cost'], rows: [
      ...
      { type: 'heading', level: 2, text: 'How to Get the Best Rate', id: 'best-rate' },
      { type: 'paragraph', content: 'Because benefits are standardized, the best strategy is to compare premiums from multiple insurers for the same plan letter. Working with an independent Medicare insurance agent who can quote multiple carriers is the most efficient way to find the lowest price for identical coverage. The best time to shop is during your [Medigap Open Enrollment Period, the 6-month window](https://www.medicare.gov/) starting the month you turn 65 and enroll in Part B, when insurers cannot deny you coverage or charge more based on health conditions.' },
      { type: 'faq', faqs: [
        { question: 'Is Plan G or Plan N cheaper?', answer: 'Plan N has lower monthly premiums than Plan G, typically by $30 to $60 per month. However, Plan N has copays of up to $20 for office visits and up to $50 for emergency room visits. If you visit the doctor frequently, Plan G may cost less overall despite the higher premium.' },
        { question: 'Do Medigap premiums increase every year?', answer: 'Yes, most Medigap premiums increase annually due to general inflation and, for attained-age rated policies, due to your age. You can shop for a lower-priced policy from another insurer at any time, but outside of your open enrollment period you may be subject to medical underwriting.' },
  ...
  },
  {
    ...
    seo: {
      focusKeyword: "",
      title: "Medicare and Power of Attorney: Who Can Speak for You",
      description: "Learn how Power of Attorney and Medicare authorized representative rules work, so you can protect your healthcare decisions and appoint a spokesperson.",
    ...
    richSections: [
      ...
      { type: "table", title: "", headers: ["POA Type", "What It Covers", "Does It Survive Incapacity?"], rows: [["General Power of Attorney", "Broad legal and financial decisions", "No: becomes invalid if you become incapacitated"], ["Durable Power of Attorney", "Broad legal and financial decisions", "Yes: remains valid even if you become incapacitated"], ["Healthcare Power of Attorney (HCPOA)", "Medical decisions only", "Yes: specifically designed for incapacity situations"], ["Limited / Special Power of Attorney", "Specific tasks only (e.g., signing one document)", "Depends on the document"]], footnote: "For Medicare purposes, a Durable Power of Attorney or Healthcare Power of Attorney is most relevant. A general POA that lapses at incapacity is of limited use in a medical emergency." },
      { type: "heading", level: 2, text: "Does Medicare Recognize a Power of Attorney?", id: "does-medicare-recognize-poa" },
      { type: "paragraph", content: "Medicare (administered by CMS) does not automatically recognize a state-issued Power of Attorney as granting someone the right to access your Medicare account or make coverage decisions. Medicare has its own authorized representative system that operates separately from state POA laws. However, a valid POA document, particularly a Durable POA or Healthcare POA, can be submitted to Medicare as part of the authorized representative designation process." },
      { type: "paragraph", content: "In practice, if someone presents a valid POA document to Medicare or a Medicare plan, the plan may accept it as evidence of authorization. But the safest approach is to formally designate the person as your Medicare Authorized Representative using the official CMS process." },
      { type: "heading", level: 2, text: "What Is a Medicare Authorized Representative?", id: "medicare-authorized-rep" },
      { type: "paragraph", content: "A **Medicare Authorized Representative** is someone you formally designate to act on your behalf with Medicare. Once designated, they can:" },
      { type: "list", ordered: false, items: ["File Medicare claims on your behalf", "Request and receive information about your Medicare coverage", "File appeals and grievances with Medicare", "Enroll you in or disenroll you from Medicare Advantage or Part D plans", "Speak with Medicare customer service on your behalf", "Request a Medicare Summary Notice (MSN) or Explanation of Benefits"] },
      { type: "paragraph", content: "An authorized representative **cannot** make medical treatment decisions on your behalf. That requires a separate Healthcare Power of Attorney or advance directive. The authorized representative role is specifically about managing your Medicare insurance coverage and benefits." },
      { type: "heading", level: 2, text: "How to Designate a Medicare Authorized Representative", id: "how-to-designate" },
      { type: "list", ordered: true, items: ["**Complete CMS Form 1696.** The official form is \"Appointment of Representative\" (CMS-1696). Both you and your representative must sign it. The form is available at [cms.gov](https://www.cms.gov/).", "**Submit the form.** For Original Medicare matters, submit to your Medicare Administrative Contractor (MAC) or to 1-800-MEDICARE. For Medicare Advantage or Part D matters, submit directly to your plan.", "**Provide supporting documentation if needed.** If you are incapacitated and cannot sign, a court-appointed guardian or someone with a valid Durable POA may be able to act on your behalf. The plan or Medicare will review the legal documents.", "**Confirm the designation.** Once processed, your representative should receive written confirmation. Keep a copy of the signed form."] },
      { type: "callout", calloutType: "tip", calloutTitle: "Do This Before a Crisis", calloutText: "The best time to designate an authorized representative is **before** you need one. If you wait until you are hospitalized or incapacitated, the process becomes significantly more complicated. Designating a representative now, even if you are in good health, is a simple step that can prevent major headaches for your family later." },
      { type: "heading", level: 2, text: "Medicare Advantage, Part D, and Medigap: Separate Authorization Rules", id: "private-plans" },
      { type: "paragraph", content: "If you have a [Medicare Advantage plan](/faqs/medicare-advantage-vs-medicare-supplement), a [Part D plan](/faqs/medicare-and-prescription-drugs-whats-covered-and-whats-not), or a [Medigap policy](/faqs/what-is-a-medicare-supplement-plan-and-who-needs-one), each of those private insurers has its own process for recognizing an authorized representative. You will generally need to contact each plan separately and submit their required authorization form or a copy of your POA document. Do not assume that a designation with Medicare (CMS) automatically carries over to your private supplemental plans." },
      { type: "heading", level: 2, text: "Advance Directives: The Medical Decision Layer", id: "advance-directives" },
      { type: "paragraph", content: "For medical treatment decisions, not just insurance management, you need an **advance directive**. This is a separate legal document from a POA and from the Medicare authorized representative designation. Common advance directives include:" },
      { type: "list", ordered: false, items: ["**Living Will:** Documents your wishes about specific medical treatments (e.g., resuscitation, mechanical ventilation, artificial nutrition) if you cannot communicate", "**Healthcare Power of Attorney (HCPOA) / Healthcare Proxy:** Names a specific person to make medical decisions for you if you are incapacitated", "**POLST / MOLST Form:** A physician-signed medical order (not just a directive) specifying your treatment preferences; used in acute care settings"] },
      { type: "paragraph", content: "Medicare covers advance care planning conversations with your doctor as a preventive service. You can discuss and document your wishes during your [Annual Wellness Visit](/faqs/medicare-annual-wellness-visit) at no cost to you." },
      { type: "heading", level: 2, text: "Frequently Asked Questions", id: "faqs" },
      { type: "faq", faqs: [{ question: "Can a family member access my Medicare information without formal authorization?", answer: "No. Medicare takes privacy seriously under HIPAA. Even a spouse or adult child cannot access your Medicare account or speak on your behalf without being formally designated as an authorized representative." }, { question: "Does a Durable Power of Attorney work for Medicare?", answer: "A Durable POA can be submitted as supporting documentation, but it is not automatically recognized by Medicare. The safest approach is to also complete CMS Form 1696 to formally designate your agent as a Medicare Authorized Representative." }, { question: "What happens if I become incapacitated and have no authorized representative?", answer: "Medicare may require a court-appointed guardian or conservator to act on your behalf. This process is time-consuming and expensive. Designating a representative in advance avoids this situation entirely." }, { question: "Can I designate different people for Medicare and for medical decisions?", answer: "Yes, and many people do. You might designate a financially savvy family member as your Medicare Authorized Representative for insurance matters, and a different trusted person as your Healthcare Power of Attorney for medical decisions." }, { question: "Does my Medicare Advantage plan need its own authorization form?", answer: "Yes. Private Medicare Advantage and Part D plans each have their own authorization process. Contact your plan directly to find out what documentation they require." }] },
    ],
  ...
  },
  {
    ...
    seo: {
      title: 'Medicare History: When Did Medicare Start and How Has It Changed?',
      description: 'Medicare was signed into law in 1965, but the push for national health insurance began decades earlier. Learn the full history of Medicare, from its origins to the major reforms that shaped it today.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-history/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'Medicare History: When Did Medicare Start in the U.S.?',
    summary: 'Medicare was signed into law by President Lyndon B. Johnson on July 30, 1965. But the push for national health insurance in the United States began decades earlier, and the program has undergone major reforms in the years since. Understanding Medicare history helps explain why the program is structured the way it is today.',
    category: 'Medicare FAQ',
    dateUpdated: 'May 12, 2026',
    author: 'David Haass',
    reviewer: 'Ashlee Zareczny',
    ...
    richSections: [
      ...
      { type: 'heading', level: 2, text: 'Key Milestones in Medicare History', id: 'milestones' },
      { type: 'table', title: 'Major Medicare Reforms and Milestones', headers: ['Year', 'Event'], rows: [
      ...
      { type: 'heading', level: 2, text: 'Medicare Today', id: 'today' },
      { type: 'paragraph', content: 'As of 2026, Medicare covers approximately 68 million Americans. The program is administered by the Centers for Medicare and Medicaid Services (CMS), a division of the U.S. Department of Health and Human Services. Medicare spending accounts for roughly 13% of the federal budget. The program continues to evolve, with ongoing debates about drug pricing, the solvency of the Hospital Insurance Trust Fund, and the growing role of Medicare Advantage plans.' },
      { type: 'faq', faqs: [
        { question: 'When did Medicare start?', answer: 'Medicare was signed into law on July 30, 1965, by President Lyndon B. Johnson. Coverage began on July 1, 1966, for the first enrollees.' },
        { question: 'When was Medicare Part D added?', answer: 'Medicare Part D prescription drug coverage was created by the Medicare Modernization Act of 2003 and took effect on January 1, 2006.' },
        { question: 'How many people are on Medicare?', answer: 'As of 2026, approximately 68 million Americans are enrolled in Medicare, including people age 65 and older and younger individuals with qualifying disabilities or end-stage renal disease.' },
      ]},
    ],
...

  {
    ...
    seo: {
      title: 'Medicare-Approved Braces and Devices: What Is Covered in 2026',
      description: 'Medicare Part B covers medically necessary braces and orthotic devices for the back, neck, arm, and leg. Learn what qualifies, how much you pay, and how to get a Medicare-approved device.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-braces-devices/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'Medicare Approved Braces and Devices',
    summary: 'Medicare Part B covers braces, splints, and orthotic devices when they are medically necessary and ordered by a doctor. Coverage applies to back braces, knee braces, ankle-foot orthotics, cervical collars, wrist splints, and more. You pay 20% of the Medicare-approved amount after your Part B deductible.',
    category: 'Medicare FAQ',
    dateUpdated: 'May 12, 2026',
    author: 'David Haass',
    reviewer: 'Ashlee Zareczny',
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'Medicare Part B covers braces and orthotic devices as a form of Durable Medical Equipment (DME) when they are medically necessary and ordered by a doctor who accepts Medicare. These items must be prescribed to treat a specific diagnosis and must be obtained from a Medicare-enrolled DME supplier.' },
      { type: 'heading', level: 2, text: 'What Braces and Devices Does Medicare Cover?', id: 'what-is-covered' },
      { type: 'table', title: 'Medicare-Covered Braces and Orthotic Devices', headers: ['Device Type', 'Common Uses', 'Coverage Condition'], rows: [
        ['Back brace (lumbar-sacral orthosis)', 'Spinal stenosis, herniated disc, post-surgical support', 'Must be medically necessary; doctor prescription required'],
        ['Knee brace', 'Osteoarthritis, ligament injury, post-surgical', 'Must be medically necessary; off-the-shelf or custom'],
        ['Ankle-foot orthosis (AFO)', 'Drop foot, stroke rehabilitation, neuropathy', 'Prescription required; custom or prefabricated'],
        ['Cervical collar / neck brace', 'Cervical spine injury, post-surgical', 'Medically necessary with physician order'],
        ['Wrist splint / hand orthosis', 'Carpal tunnel, arthritis, fracture recovery', 'Medically necessary; finger splints may qualify'],
        ['Shoulder immobilizer / sling', 'Rotator cuff injury, shoulder surgery', 'Medically necessary with prescription'],
        ['Elbow orthosis', 'Tennis elbow, nerve compression, fracture', 'Medically necessary with prescription'],
      ]},
      { type: 'callout', calloutType: 'info', calloutTitle: 'Off-the-Shelf vs. Custom-Fitted Braces', calloutText: 'Medicare covers both off-the-shelf (prefabricated) and custom-fitted orthotic devices when medically necessary. Custom-fitted devices require a detailed written order from your doctor and must be fitted by a qualified orthotist or prosthetist. Custom devices generally have higher Medicare-approved amounts.' },
      { type: 'heading', level: 2, text: 'How Much Does Medicare Pay?', id: 'cost' },
      { type: 'paragraph', content: 'After you meet your Part B deductible ($257 in 2026), Medicare pays 80% of the Medicare-approved amount for covered braces and devices. You are responsible for the remaining 20% coinsurance. If you have a Medigap plan, it may cover some or all of your 20% share. If you have Medicare Advantage, your plan\'s cost-sharing rules apply instead.' },
      { type: 'heading', level: 2, text: 'How to Get a Medicare-Covered Brace', id: 'how-to-get' },
      { type: 'paragraph', content: 'To get a brace or orthotic device covered by Medicare, follow these steps: First, your doctor must determine the device is medically necessary and provide a written prescription or detailed written order. Second, you must obtain the device from a Medicare-enrolled DME supplier. Using a non-enrolled supplier means Medicare will not pay. Third, the supplier will bill Medicare directly, and you will be responsible for your 20% share.' },
      { type: 'callout', calloutType: 'warning', calloutTitle: 'Always Use a Medicare-Enrolled Supplier', calloutText: 'Buying a brace from a retailer, pharmacy, or online store that is not enrolled in Medicare means you will pay the full cost out of pocket. Always confirm that your supplier is enrolled in Medicare before purchasing a prescribed device.' },
      { type: 'faq', faqs: [
        { question: 'Does Medicare cover finger splints for arthritis?', answer: 'Medicare may cover finger ring splints or hand orthoses for conditions like osteoarthritis or rheumatoid arthritis if they are deemed medically necessary and prescribed by a physician. Coverage depends on your specific diagnosis and the medical documentation your doctor provides.' },
        { question: 'Does Medicare cover custom orthotics for shoes?', answer: 'Standard shoe inserts and orthotics are generally not covered by Medicare. However, therapeutic shoes and inserts are covered for people with diabetes who have certain foot conditions, under the Therapeutic Shoe Program.' },
        { question: 'Can I get a knee brace covered by Medicare Advantage?', answer: 'Yes. Medicare Advantage plans must cover all services that Original Medicare covers, including medically necessary knee braces. Your cost-sharing (copay or coinsurance) may differ from Original Medicare, so check your plan\'s Summary of Benefits.' },
      ]},
    ],
    relatedSlugs: ["durable-medical-equipment", "medicare-coverage-for-wheelchairs-and-scooters", "does-medicare-cover-medical-alert-systems", "medicare-physician-fee-schedule-lookup-tool"],
  },
  {
    slug: 'what-does-medically-necessary-mean',
    seo: {
      title: 'What Does Medically Necessary Mean?',
      description: 'In the context of Medicare, medically necessary means that the services or products are needed for medical reasons. Learn more to see what meets the requirements.',
      canonical: 'https://www.medicarefaq.com/faqs/what-does-medically-necessary-mean/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'What Does Medically Necessary Mean?',
