  ...
  // does-medicare-cover-atrial-fibrillation-afib moved to coverage-data.ts
  {
    ...
    richSections: [
      ...
      { type: "table", title: "Medicare Eligibility Pathways", headers: ["Situation", "When You Become Eligible", "How You Enroll"], rows: [
        ...
        ["Turning 65, not on Social Security", "3 months before your 65th birthday", "You must apply at ssa.gov, by phone, or in person."],
      ...
      { type: "image", src: "https://d2xsxph8kpxj0f.cloudfront.net/310519663444965628/gUNDzJhadva78ZtnmXvVsR/medicare-cta-banner-find-plan-short-4CSv5jcpyyMJCXLKrN3fpo.png", alt: "Find the Right Medicare Plan for You", link: "https://demographics.medicarecompared.com/ms/" },
