 ...
 * Anthropic Claude API to generate a 2-minute HeyGen video script.
 *
...
Your job is to write clear, conversational 2-minute video scripts for a talking-head presenter (David Haass, a licensed Medicare expert).

Script rules:
- Target 250–280 words total (reads at ~130 words per minute = ~2 minutes)
...
/**
 * Generates a 2-minute video script for the given article using Claude.
 */
