...
export const simpleFAQBatch2: SimpleFAQArticleData[] = [
  ...
  },
  {
    ...
    seo: {
      ...
      description: 'Turning 65 soon? A Medicare pre-enrollment checklist can help you understand what you should be planning for. Our Medicare enrollment checklist can help!',
    ...
    title: 'Medicare Pre Enrollment Checklist',
    summary: 'If you’re about to turn 65, it’s a good idea to begin planning for enrolling in Medicare coverage. To help you prepare for enrollment in the months before your 65th birthday, we’ve made this Medicare turning 65 checklist. Learn more about what you need to do before enrolling for Medicare.',
    category: 'Enrollment',
    dateUpdated: 'September 26, 2023',
    author: 'David Haass',
    reviewer: 'Ashlee Zareczny',
    readTime: '11 min',
    sections: [
