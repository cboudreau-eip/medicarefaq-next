...
export const simpleFAQBatch2: SimpleFAQArticleData[] = [
  ...
  },
  {
    ...
    richSections: [
      ...
      },
      {
        ...
        level: 2,
        id: "what-is-soa",
        text: "What is a Medicare Scope of Appointment and Why Does it Matter to You?",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        ...
        level: 2,
        id: "when-and-how",
        text: "When and How to Complete Your Scope of Appointment in 2026",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "paragraph",
        content: "The form can be completed in several ways:",
      },
      {
        type: "list",
        ordered: false,
      ...
      },
      {
        type: "heading",
        level: 2,
        id: "what-agent-can-discuss",
        text: "Controlling Your Medicare Conversation: What an Agent Can and Cannot Discuss",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        ...
        text: "Avoiding Pitfalls: Common Misunderstandings and Your Rights",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        type: "callout",
        calloutType: "warning",
        calloutTitle: "How to Report a Violation",
        calloutText:
      ...
      },
      {
        ...
        text: "Beyond the SOA: Key Considerations for Your 2026 Medicare Plan",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "paragraph",
        content: "Before any appointment, gather this information:",
      },
      {
        type: "list",
        ordered: false,
      ...
      },
      {
        ...
        level: 2,
        id: "faqs",
        text: "Your Questions Answered: Medicare Scope of Appointment FAQs",
      },
      {
        type: "faq",
        faqs: [
          {
            question: "What exactly is a Medicare Scope of Appointment (SOA)?",
            answer:
              "The SOA is a CMS-mandated form that authorizes an agent to discuss only the specific types of Medicare plans you select. It protects you from unsolicited sales pitches and keeps the conversation focused on your actual interests.",
          },
          {
            question: "When does an SOA need to be completed before a Medicare appointment?",
            answer:
              "The SOA must be completed before any discussion of specific plan benefits or costs. For scheduled appointments, the standard expectation is 48 hours in advance, though same-day completion is permitted when you initiate the contact or walk in without a prior appointment.",
          },
          {
            question: "Can a Scope of Appointment be completed on the same day as my Medicare appointment?",
            answer:
              "Yes. In 2026, CMS rules allow same-day SOA completion when you walk into an agent's office or initiate a same-day meeting yourself. This flexibility ensures you can get information when you need it without bureaucratic delays.",
          },
          {
            question: "What happens if an agent discusses plans not listed on my signed SOA?",
            answer:
              "An agent is strictly prohibited from discussing any plan type not checked on your SOA. If this happens, you can end the appointment immediately and report the violation to CMS or the plan carrier. The agent's retained copy of the SOA serves as documentation.",
          },
          {
            question: "How long must agents retain Scope of Appointment forms?",
            answer:
          ...
          {
            question: "What if I change my mind after signing an SOA?",
            answer:
              "Signing an SOA creates no enrollment obligation whatsoever. You can listen, ask questions, and decide not to enroll in anything. You can also request a new SOA at any time if you want to expand or change the plan types being discussed.",
          },
          {
      ...
      },
      {
        ...
        level: 2,
        id: "conclusion",
        text: "Making Your Medicare Decisions with Confidence in 2026",
      },
      {
        type: "paragraph",
        content:
  ...
  // does-medicare-cover-cologuard moved to coverage-data.ts
  {
    ...
    seo: {
      title: 'How Does Medicare Work with Retiree Insurance? (2026 Guide)',
      description: 'Retiree health insurance from a former employer is not creditable coverage for Medicare. Learn how Medicare coordinates with retiree plans, when to enroll, and how to avoid late enrollment penalties.',
    ...
    summary: 'If your former employer offers retiree health insurance, you may assume it protects you from Medicare enrollment deadlines. It does not. Retiree coverage is not considered creditable coverage for Medicare Part B or Part D purposes, which means delaying enrollment can result in permanent late enrollment penalties. This guide explains how Medicare and retiree insurance work together and what steps to take to protect yourself.',
    category: 'Medicare FAQ',
    dateUpdated: 'May 11, 2026',
    author: 'David Haass',
    reviewer: 'Ashlee Zareczny',
    ...
    richSections: [
      ...
      { type: 'list', ordered: true, items: [
        ...
        '**Enroll in Part D if retiree drug coverage is not creditable.** Use the Medicare Plan Finder at Medicare.gov to compare plans in your area.',
      ]},
      { type: 'heading', level: 2, text: 'Frequently Asked Questions', id: 'faqs' },
      { type: 'faq', faqs: [
        { question: 'Does retiree insurance count as creditable coverage for Part B?', answer: 'No. Retiree health insurance is not creditable coverage for Part B. Only active employer-sponsored group coverage allows you to delay Part B without penalty. When you retire, your 8-month SEP begins immediately.' },
        { question: 'Can I drop retiree insurance once I have Medicare?', answer: 'Yes, but think carefully before doing so. Once you drop retiree coverage, you generally cannot get it back. If your retiree plan provides good secondary coverage at a reasonable cost, keeping it alongside Medicare may be more cost-effective than purchasing a separate Medigap plan.' },
        { question: 'What if my retiree plan is better than Medicare?', answer: 'Even if your retiree plan has generous benefits, you still need to enroll in Medicare Part B on time to avoid the late enrollment penalty. Most retiree plans assume Medicare is primary and reduce their own benefits accordingly once you are Medicare-eligible.' },
        { question: 'Is retiree drug coverage creditable for Part D?', answer: 'It depends on the plan. Your employer is required to notify you annually whether the retiree drug coverage is creditable. If it is, you can delay Part D enrollment without penalty. If it is not, enroll in a Part D plan during your Initial Enrollment Period.' },
      ]},
    ],
  ...
  },
  {
    ...
    seo: {
      title: 'Medicare Pre-Enrollment Checklist: What to Do Before You Turn 65 (2026)',
      description: 'Use this Medicare pre-enrollment checklist to prepare for your 65th birthday. Covers when to enroll, what documents you need, which plan types to compare, and how to avoid costly mistakes.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-enrollment-checklist/',
    ...
    richSections: [
      ...
      { type: 'paragraph', content: 'Whether you apply online, by phone, or in person at a Social Security office, you will need certain documents on hand. Gathering these in advance makes the application process much smoother.' },
      { type: 'list', ordered: false, items: [
      ...
      { type: 'table', title: 'Two Main Coverage Paths After Original Medicare', headers: ['Coverage Path', 'How It Works', 'Best For'], rows: [
        ['Original Medicare + [Medicare Supplement (Medigap)](/faqs/what-is-medicare-supplement-insurance) + [Part D](/faqs/what-is-medicare-part-d)', 'Medigap pays costs Original Medicare leaves behind; Part D covers prescriptions', 'People who want predictable costs, freedom to see any doctor nationwide, and minimal out-of-pocket exposure'],
      ...
      { type: 'heading', level: 2, text: 'Medicare Enrollment Checklist Summary', id: 'checklist-summary' },
      { type: 'table', title: 'Pre-Enrollment Checklist at a Glance', headers: ['Timing', 'Action Item', 'Status'], rows: [
        ['6 months before 65', 'Check your Social Security work record and confirm eligibility', '☐'],
        ['6 months before 65', 'Decide whether to keep employer coverage or enroll in Part B', '☐'],
        ['6 months before 65', 'Research Medigap plans while you still have guaranteed issue rights', '☐'],
        ['3 months before 65', 'Apply for Medicare online, by phone, or in person', '☐'],
        ['3 months before 65', 'Gather required documents (ID, Social Security card, employer letter if applicable)', '☐'],
        ['At 65 (with Part B)', 'Enroll in a Medigap plan during your 6-month Open Enrollment Period', '☐'],
        ['At 65', 'Compare and enroll in a Part D drug plan using Medicare Plan Finder', '☐'],
        ['At 65', 'Apply for Extra Help or Medicare Savings Programs if eligible', '☐'],
        ['After enrolling', 'Set up premium auto-pay through Medicare Easy Pay', '☐'],
        ['After enrolling', 'Schedule your Welcome to Medicare preventive visit', '☐'],
      ]},
      { type: 'heading', level: 2, text: 'Frequently Asked Questions', id: 'faqs' },
      { type: 'faq', faqs: [
  ...
  },
  {
    ...
    seo: {
      title: 'Are Medicare Premiums Tax-Deductible? (2026 Guide)',
      description: 'Medicare premiums can be tax-deductible if your total medical expenses exceed 7.5% of your AGI. Learn which premiums qualify, how to claim the deduction, and special rules for the self-employed.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-supplemental-insurance-tax-deductible/',
      ogImage: 'https://www.medicarefaq.com/wp-content/uploads/medicare-premiums-and-taxable-deductions.jpg',
    },
    title: 'Are Medicare Premiums Tax-Deductible?',
    summary: 'Medicare premiums can be tax-deductible, but only under specific conditions. For most people, the deduction requires itemizing and having total medical expenses that exceed 7.5% of adjusted gross income. Self-employed individuals have a more favorable path to deducting premiums.',
    category: 'Costs & Savings',
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'Medicare premiums are considered a qualified medical expense by the IRS, which means they can potentially be deducted on your federal income tax return. However, whether you can actually take the deduction depends on how you file and how large your total medical expenses are relative to your income.' },
      { type: 'heading', level: 2, text: 'Which Medicare Premiums Are Deductible?', id: 'which-premiums' },
      { type: 'table', title: 'Medicare Premiums and Tax Deductibility', headers: ['Premium Type', '2026 Standard Amount', 'Tax-Deductible?'], rows: [
      ...
      { type: 'heading', level: 2, text: 'The 7.5% AGI Threshold for Itemizers', id: 'agi-threshold' },
      { type: 'paragraph', content: 'If you itemize deductions on Schedule A of Form 1040, you can deduct qualified medical expenses that exceed 7.5% of your adjusted gross income (AGI). Medicare premiums count toward this threshold along with other out-of-pocket medical costs such as deductibles, copayments, dental, vision, and long-term care insurance premiums.' },
      { type: 'callout', calloutType: 'info', calloutTitle: 'Example Calculation', calloutText: 'If your AGI is $50,000, the 7.5% threshold is $3,750. If your total qualified medical expenses (including Medicare premiums) are $6,000, you can deduct $2,250 ($6,000 minus $3,750). You must itemize deductions to claim this; it is not available if you take the standard deduction.' },
      { type: 'heading', level: 2, text: 'Self-Employed Individuals: A Better Option', id: 'self-employed' },
      { type: 'paragraph', content: 'If you are self-employed and not eligible for employer-sponsored health coverage through a spouse, you may be able to deduct 100% of your Medicare premiums as an above-the-line deduction on Schedule 1 of Form 1040. This deduction reduces your AGI directly and does not require itemizing. It applies to Parts B, D, Medicare Advantage, and Medigap premiums.' },
      { type: 'heading', level: 2, text: 'Premiums Paid with Pre-Tax Dollars Are Not Deductible', id: 'pre-tax-warning' },
      { type: 'paragraph', content: 'If your Medicare premiums are paid through a Health Reimbursement Arrangement (HRA), a cafeteria plan, or deducted pre-tax from a pension, you cannot also claim them as a personal deduction. Double-dipping is not allowed. Only premiums paid with after-tax dollars qualify.' },
      { type: 'heading', level: 2, text: 'Other Deductible Medicare Costs', id: 'other-costs' },
      { type: 'paragraph', content: 'Beyond premiums, other Medicare-related expenses that count toward the 7.5% threshold include: Part A and Part B deductibles, copayments and coinsurance, prescription drug costs not covered by Part D, and costs for services Medicare does not cover (such as most dental, vision, and hearing care).' },
      { type: 'faq', faqs: [
        { question: 'Can I deduct Medicare premiums if I take the standard deduction?', answer: 'No. The medical expense deduction requires itemizing on Schedule A. If your total itemized deductions are less than the standard deduction ($15,000 for single filers and $30,000 for married filing jointly in 2026), it generally makes more sense to take the standard deduction and you cannot claim the medical expense deduction.' },
        { question: 'Are Medicare Advantage premiums deductible?', answer: 'Yes. Medicare Advantage premiums are treated the same as other Medicare premiums for tax purposes and qualify as a deductible medical expense.' },
  ...
  },
  {
    ...
    seo: {
      title: 'Medicare and Workers\u2019 Compensation: How They Work Together (2026)',
      description: 'If you are on Medicare and receive a workers\u2019 compensation settlement or ongoing payments, special rules apply. Learn how Medicare coordinates with workers\u2019 comp and what a Medicare Set-Aside is.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-and-workers-comp/',
      ogImage: 'https://www.medicarefaq.com/wp-content/uploads/medicare-and-workers-compensation.jpg',
    },
    title: 'Medicare and Workers\u2019 Compensation',
    summary: 'When you are on Medicare and also receiving workers\u2019 compensation benefits, Medicare is generally the secondary payer for work-related injuries. Understanding the coordination rules, conditional payments, and Medicare Set-Aside requirements can protect you from unexpected billing issues.',
    category: 'Medicare FAQ',
    dateUpdated: 'May 12, 2026',
    author: 'David Haass',
    reviewer: 'Ashlee Zareczny',
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'If you are a Medicare beneficiary and suffer a work-related injury or illness, both Medicare and workers\u2019 compensation (WC) may be involved in paying for your care. The rules governing which payer goes first and how settlements are handled are set by the Medicare Secondary Payer (MSP) Act.' },
      { type: 'heading', level: 2, text: 'Who Pays First: Medicare or Workers\u2019 Comp?', id: 'who-pays-first' },
      { type: 'paragraph', content: 'Workers\u2019 compensation is the primary payer for medical expenses related to a work injury. Medicare is secondary, meaning it only pays after workers\u2019 comp has paid its share. If workers\u2019 comp denies a claim or delays payment, Medicare may make a conditional payment to cover your care, but it will seek reimbursement once the WC claim is resolved.' },
      { type: 'table', title: 'Medicare and Workers\u2019 Comp: Payer Order', headers: ['Situation', 'Primary Payer', 'Secondary Payer'], rows: [
        ['Active workers\u2019 comp claim for work-related injury', 'Workers\u2019 compensation', 'Medicare (conditional)'],
        ['Workers\u2019 comp denies or delays payment', 'Medicare (conditional payment)', 'Workers\u2019 comp (must reimburse Medicare)'],
        ['Non-work-related medical expenses', 'Medicare', 'Other supplemental coverage'],
      ]},
      { type: 'heading', level: 2, text: 'Conditional Payments and Reimbursement', id: 'conditional-payments' },
      { type: 'paragraph', content: 'If Medicare pays for treatment related to your work injury while your WC claim is pending, those are called conditional payments. Medicare has the right to recover these payments from any WC settlement or award you receive. You or your attorney must notify the Benefits Coordination and Recovery Center (BCRC) when a WC claim is filed and when a settlement is reached.' },
      { type: 'callout', calloutType: 'warning', calloutTitle: 'Notify Medicare Before Settling', calloutText: 'Before finalizing a workers\u2019 compensation settlement, you must address any Medicare conditional payments and, if applicable, set up a Medicare Set-Aside arrangement. Failing to do so can result in Medicare refusing to pay for future related care until the set-aside funds are exhausted.' },
      { type: 'heading', level: 2, text: 'What Is a Medicare Set-Aside (MSA)?', id: 'msa' },
      { type: 'paragraph', content: 'A Medicare Set-Aside (MSA) is a portion of a workers\u2019 compensation settlement that is allocated to pay for future medical expenses related to the work injury that Medicare would otherwise cover. The Centers for Medicare and Medicaid Services (CMS) reviews proposed MSA amounts for settlements that meet certain thresholds. Once the MSA funds are exhausted, Medicare will begin paying for covered future care.' },
      { type: 'heading', level: 2, text: 'Periodic Payments vs. Lump-Sum Settlements', id: 'periodic-vs-lump-sum' },
      { type: 'paragraph', content: 'Workers\u2019 comp benefits can be paid as ongoing periodic payments or as a lump-sum settlement. With periodic payments, Medicare typically pays for medical expenses not covered by WC. With a lump-sum settlement, Medicare may not pay for related medical expenses until the settlement amount allocated for medical care has been spent down, even if the settlement did not specifically designate funds for medical costs.' },
      { type: 'faq', faqs: [
        { question: 'Does Medicare cover injuries that workers\u2019 comp does not?', answer: 'Medicare may cover medical expenses for a work-related injury if workers\u2019 comp denies the claim or does not cover a specific treatment. However, Medicare will make a conditional payment and seek reimbursement if WC later pays.' },
        { question: 'What happens if I do not reimburse Medicare after a WC settlement?', answer: 'Medicare has the right to recover conditional payments from your settlement. If you do not reimburse Medicare, it can pursue collection through the Department of Justice and may refuse to pay for future related care.' },
  ...
  },
  {
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'Medicare prescription drug coverage is available through two different plan structures. A Prescription Drug Plan (PDP) is a standalone plan that adds drug coverage to Original Medicare (Parts A and B). A Medicare Advantage Prescription Drug plan (MAPD) is a Medicare Advantage plan that includes drug coverage as part of a bundled package. You cannot enroll in both a PDP and an MAPD at the same time.' },
      { type: 'heading', level: 2, text: 'Side-by-Side Comparison', id: 'comparison' },
      { type: 'table', title: 'PDP vs. MAPD Comparison', headers: ['Feature', 'PDP (Standalone Part D)', 'MAPD (Medicare Advantage + Drug)'], rows: [
      ...
      { type: 'paragraph', content: 'A standalone PDP is the right choice if you want to stay on Original Medicare and pair it with a [Medigap (Medicare Supplement)](/faqs/what-is-medicare-supplement-insurance) plan. Medigap plans are not compatible with Medicare Advantage, so if you want comprehensive coverage with no network restrictions and predictable costs, the combination of Original Medicare + Medigap + PDP is the traditional approach.' },
      ...
      { type: 'heading', level: 2, text: 'Switching Between PDP and MAPD', id: 'switching' },
      { type: 'paragraph', content: 'You can switch between a PDP and an MAPD during the Annual Enrollment Period (October 15 through December 7) each year, with changes taking effect January 1. If you want to switch from an MAPD back to Original Medicare with a Medigap plan, keep in mind that Medigap insurers can use medical underwriting outside of guaranteed issue periods, which may affect your eligibility.' },
      { type: 'faq', faqs: [
        { question: 'Can I have a PDP and a Medicare Advantage plan at the same time?', answer: 'No. If you enroll in a Medicare Advantage plan that includes drug coverage (MAPD), you cannot also enroll in a standalone PDP. If you enroll in a Medicare Advantage plan without drug coverage (MAPD-only plans are rare), you may be able to add a PDP, but this is uncommon.' },
        { question: 'What happens to my PDP if I switch to Medicare Advantage?', answer: 'Your PDP will be automatically disenrolled when your Medicare Advantage plan takes effect. You do not need to cancel it separately.' },
