...
export const simpleFAQBatch1: SimpleFAQArticleData[] = [
  ...
  },
  {
    ...
    summary: 'Many Medicare Advantage plans include an OTC benefit card that gives you a periodic allowance to spend on health and wellness products at participating stores. The average plan offers about $400 per year, though amounts vary widely by carrier and plan type. Original Medicare does not offer this benefit.',
    ...
    richSections: [
      ...
      { type: 'callout', calloutType: 'warning', calloutTitle: 'Fewer Plans Offering OTC in 2026', calloutText: 'According to the Better Medicare Alliance, fewer Medicare Advantage plans include OTC benefits in 2026 compared to 2025. If your current plan reduced or eliminated its OTC allowance, you may want to compare plans during the next Annual Enrollment Period.' },

      { type: 'heading', level: 2, text: 'What Changed with OTC Benefits in 2026? (VBID Ending)', id: 'vbid-changes-2026' },
      { type: 'paragraph', content: 'One of the biggest changes for 2026 involves the end of the CMS Value-Based Insurance Design (VBID) model. Through 2025, this program allowed Medicare Advantage plans to bundle OTC credits, healthy food allowances, and utility bill assistance into a single benefit card. Starting in 2026, CMS ended the VBID model and plans now use the Special Supplemental Benefits for the Chronically Ill (SSBCI) program instead.' },
      { type: 'paragraph', content: 'Here is what this means for you:' },
      { type: 'list', ordered: false, items: [
      ...
      { type: 'callout', calloutType: 'info', calloutTitle: 'OTC Spending Is Not Affected', calloutText: 'The chronic condition requirement only applies to healthy food and utility bill credits. If you simply want to buy OTC health products (vitamins, bandages, pain relievers), no verification is needed. Your OTC allowance works the same as before.' },

      { type: 'heading', level: 2, text: 'What Can You Buy with an OTC Card?', id: 'what-otc-covers' },
      { type: 'paragraph', content: 'Eligible items vary by plan, but most OTC benefit cards cover a broad range of health and wellness products. The following categories are commonly approved across carriers:' },
      { type: 'list', ordered: false, items: [
      ...
      { type: 'paragraph', content: 'Items that are typically not covered include cosmetics, food or beverages (unless your plan has a separate food benefit), cleaning supplies, and prescription medications. Always check your plan\'s OTC catalog for the complete list of approved products.' },

      { type: 'heading', level: 2, text: 'Where Can You Use Your OTC Card?', id: 'where-to-use' },
      { type: 'paragraph', content: 'Most OTC benefit cards are accepted at major national retailers. The specific stores depend on your carrier and plan, but common options include:' },
      { type: 'list', ordered: false, items: [
        'CVS Pharmacy',
        'Walgreens',
        'Walmart',
      ...
      { type: 'paragraph', content: 'Many plans now offer online ordering with home delivery, which is especially convenient if you have mobility limitations or live in a rural area. Check your plan\'s Summary of Benefits or call the member services number on your ID card for the full list of participating locations.' },

      { type: 'heading', level: 2, text: 'Tips to Maximize Your OTC Benefit', id: 'maximize-otc-benefit' },
      { type: 'paragraph', content: 'Research shows that only about 30% of Medicare Advantage members actually use their OTC allowances. That means roughly 70% of eligible members are leaving money on the table. Here are some tips to make sure you get the full value of your benefit:' },
      ...
      { type: 'callout', calloutType: 'info', calloutTitle: 'Unused Balances Do Not Roll Over', calloutText: 'Most plans reset your OTC allowance at the beginning of each month or quarter. Any unused balance is forfeited. Plan your purchases so you use your full allowance each period.' },

      { type: 'heading', level: 2, text: 'How to Check Your OTC Balance', id: 'check-otc-balance' },
      { type: 'paragraph', content: 'You can check your remaining OTC balance in several ways depending on your carrier:' },
      { type: 'list', ordered: false, items: [
      ...
      { type: 'heading', level: 2, text: 'Frequently Asked Questions', id: 'otc-faqs' },
      { type: 'faq', faqs: [
        { question: 'How much is the Medicare OTC card benefit in 2026?', answer: 'The average Medicare Advantage plan offers approximately $400 per year in OTC benefits. Amounts range from $25 per quarter on basic plans to over $250 per month on some Dual Special Needs Plans. Check your specific plan\'s Summary of Benefits for your exact allowance.' },
        { question: 'Does Original Medicare include an OTC card?', answer: 'No. OTC benefit cards are only available through Medicare Advantage plans. If you have Original Medicare (Parts A and B only), you do not receive an OTC card. You would need to enroll in a Medicare Advantage plan to access this benefit.' },
        { question: 'Can I use my OTC card for food or groceries?', answer: 'Standard OTC cards are limited to health and wellness products. However, some plans (particularly D-SNP plans) offer a separate healthy food allowance on the same card. Starting in 2026, using your card for food requires verification of a qualifying chronic condition such as diabetes or high blood pressure.' },
        { question: 'What changed with OTC benefits in 2026?', answer: 'CMS ended the Value-Based Insurance Design (VBID) model in 2026. This means healthy food and utility bill credits now require chronic condition verification through the SSBCI program. OTC-only spending on health products is not affected and does not require any verification.' },
  ...
  },
  {
    ...
    relatedSlugs: ["how-is-medicare-part-d-changing-in-2026", "medicare-part-d-payment-plan-2026", "why-some-drugs-are-covered-under-part-b-instead-of-part-d", "part-d-formulary", "how-can-seniors-save-on-prescription-drug-costs", "medicare-extra-help-program", "mapd-vs-part-d", "medicare-covered-alternatives-to-knee-replacement"],
  },
  {
  ...
  },
  {
    ...
    seo: {
      title: 'Medicare 8-Minute Rule Explained: How Physical Therapy Billing Works (2026)',
      description: 'The Medicare 8-minute rule determines how physical therapists bill for timed services. Learn how units are calculated, what common CPT codes cost, and how to read your therapy bill.',
    ...
    richSections: [
      ...
      {
        type: 'table',
        headers: ['Total Timed Minutes', 'Billable Units', 'What This Means'],
        rows: [
          ['Less than 8 minutes', '0 units (cannot bill)', 'Provider cannot charge Medicare for this service'],
          ['8 to 22 minutes', '1 unit', 'Minimum time to bill one unit is 8 minutes'],
          ['23 to 37 minutes', '2 units', 'Must exceed 22 minutes (one full unit + 8 more)'],
          ['38 to 52 minutes', '3 units', 'Most common for a standard 45-minute session'],
          ['53 to 67 minutes', '4 units', 'Typical for longer or multi-service sessions'],
          ['68 to 82 minutes', '5 units', 'Extended treatment sessions'],
        ],
      ...
      },
      {
        type: 'heading',
        level: 2,
        id: 'common-cpt-codes-and-costs',
        text: 'Common Therapy CPT Codes and What They Cost in 2026',
      },
      {
        type: 'paragraph',
        content: 'Understanding which CPT codes your therapist bills helps you predict your out-of-pocket costs. Below are the most common timed therapy codes subject to the 8-minute rule, along with their 2026 Medicare-approved amounts per unit:',
      },
      {
        type: 'table',
        headers: ['CPT Code', 'Description', '2026 Medicare Rate (per unit)', 'Your 20% Coinsurance'],
        rows: [
          ['97110', 'Therapeutic exercise (strengthening, flexibility, endurance)', '$35.00', '$7.00'],
          ['97140', 'Manual therapy (mobilization, manipulation)', '$27.72', '$5.54'],
          ['97112', 'Neuromuscular re-education (balance, coordination, posture)', '$34.00', '$6.80'],
          ['97530', 'Therapeutic activities (functional movement patterns)', '$33.50', '$6.70'],
          ['97116', 'Gait training (walking retraining)', '$31.00', '$6.20'],
          ['97035', 'Ultrasound (per 15-minute unit)', '$14.50', '$2.90'],
        ],
        footnote: 'Rates shown are approximate 2026 national averages from the Medicare Physician Fee Schedule. Actual rates vary by geographic locality. Medicare pays 80% of the approved amount after your Part B deductible ($283 in 2026) is met.',
      },
      {
        type: 'heading',
        level: 2,
        id: 'cost-comparison',
        text: 'What a Typical PT Session Costs You',
      },
      {
        type: 'paragraph',
        content: 'A standard 45-minute physical therapy session typically generates 3 billable units. Here is what that session costs under different Medicare coverage scenarios, assuming the provider bills 2 units of therapeutic exercise (97110) and 1 unit of manual therapy (97140):',
      },
      {
        type: 'table',
        headers: ['Coverage Type', 'Medicare-Approved Amount', 'Medicare Pays (80%)', 'You Pay', 'Notes'],
        rows: [
          ['Original Medicare (Part B only)', '$97.72', '$78.18', '$19.54 per session', 'After $283 annual deductible is met'],
          ['Original Medicare + Medigap Plan G', '$97.72', '$78.18', '$0 per session', 'Medigap covers the 20% coinsurance; you only pay the $283 annual deductible once'],
          ['Original Medicare + Medigap Plan N', '$97.72', '$78.18', '$0 to $20 per session', 'Plan N may apply up to a $20 copay for some office visits'],
          ['Medicare Advantage (HMO/PPO)', '$97.72', 'Varies', '$20 to $50 copay per visit', 'Many MA plans use flat copays instead of 20% coinsurance; must use in-network providers'],
        ],
        footnote: 'Costs assume the Part B deductible has already been met for the year. If you have not yet met your deductible, you pay 100% of the Medicare-approved amount until you reach $283.',
      },
      {
        type: 'paragraph',
        content: 'Over a typical course of treatment (12 to 24 sessions), the difference adds up. A beneficiary on Original Medicare alone would pay approximately $235 to $469 in coinsurance. With [Medigap Plan G](/faqs/medicare-supplement-plan-g-benefits), the total out-of-pocket cost for the entire course of therapy is $283 (the annual deductible) regardless of how many sessions you attend.',
      },
      {
        type: 'heading',
        level: 2,
        id: 'how-to-read-your-therapy-bill',
        text: 'How to Read Your Physical Therapy Bill',
      },
      {
        type: 'paragraph',
        content: 'After each therapy session, your provider submits a claim to Medicare. You will receive a Medicare Summary Notice (MSN) showing what was billed. Here is how to interpret the key fields:',
      },
      {
        type: 'list',
        ordered: true,
        items: [
          '**Date of Service**: The date you received treatment.',
          '**CPT Code**: The 5-digit procedure code (e.g., 97110 for therapeutic exercise). Each timed code represents one 15-minute unit.',
          '**Units**: The number of billing units charged. A "3" next to CPT 97110 means 3 units (45 minutes) of therapeutic exercise.',
          '**Charges**: What the provider billed. This is often higher than the Medicare-approved amount.',
          '**Medicare-Approved Amount**: The maximum Medicare allows for the service. This is the number that matters for your cost-sharing.',
          '**Medicare Paid**: 80% of the approved amount (after your deductible is met).',
          '**You Owe**: Your 20% coinsurance, or $0 if Medigap covers it.',
        ],
      },
      {
        type: 'callout',
        calloutType: 'warning',
        calloutTitle: 'Red Flags to Watch For',
        calloutText: 'Compare the units billed to the actual time you spent in therapy. If your session lasted 30 minutes but the bill shows 4 units (53 to 67 minutes), something is wrong. Also watch for untimed codes like hot packs (97010) being billed as timed codes. Keep a log of your session start and end times to verify accuracy.',
      },
      {
        type: 'heading',
        level: 2,
        id: 'how-to-dispute-a-therapy-bill',
        text: 'How to Dispute a Therapy Bill',
      },
      {
        type: 'paragraph',
        content: 'If you believe your physical therapy bill is incorrect, you have the right to challenge it. Medicare has a formal appeals process, but many billing errors can be resolved before reaching that stage.',
      },
      {
        type: 'list',
        ordered: true,
        items: [
          '**Request an itemized bill.** Ask your provider for a detailed statement showing each CPT code, the number of units, and the time spent on each service. Compare this to your own records of the session.',
          '**Ask for the treatment log.** Your therapist is required to document the exact minutes spent on each timed service. Request a copy and compare it to the units billed.',
          '**Contact the billing department.** Many overbilling issues are clerical errors. Call the provider\'s billing office, explain the discrepancy, and ask for a correction.',
          '**Call Medicare.** If the provider will not correct the bill, call 1-800-MEDICARE (1-800-633-4227) to report the issue. Medicare can review the claim and request an adjustment.',
          '**File a formal appeal.** If you receive a Medicare Summary Notice showing a charge you disagree with, you have 120 days to file a redetermination request with your Medicare Administrative Contractor (MAC). Instructions are printed on the MSN itself.',
        ],
      },
      {
        type: 'paragraph',
        content: 'If you suspect intentional fraud (billing for services never provided, or consistently inflating units), you can report it to the HHS Office of Inspector General at 1-800-HHS-TIPS or online at oig.hhs.gov.',
      },
      {
        type: 'heading',
        level: 2,
      ...
      },
      {
        ...
        rows: [
          ['Timed (time-based)', 'Per 15-minute unit', 'Therapeutic exercise (97110), manual therapy (97140), neuromuscular re-education (97112), gait training (97116)', 'Yes'],
          ['Untimed (service-based)', 'Once per session', 'Evaluation/assessment (97161-97163), hot/cold packs (97010), electrical stimulation unattended (97014)', 'No'],
        ],
      ...
      },
      {
        ...
        text: 'Therapy Spending Thresholds in 2026',
      },
      {
        type: 'paragraph',
      ...
      {
        type: 'paragraph',
        content: 'However, Medicare applies two important thresholds in 2026:',
      },
      {
        type: 'list',
        ordered: false,
      ...
      },
      {
        ...
        calloutText: 'If your therapy costs approach the $2,480 KX modifier threshold, make sure your provider is documenting medical necessity thoroughly. Medicare can request records to verify that continued treatment is appropriate. Ask your therapist to provide you with a copy of your plan of care and progress notes.',
      },
      {
        type: 'heading',
        level: 2,
      ...
      {
        type: 'eddie-pro-tip',
        content: 'After every physical therapy session, ask your therapist for a printout of the daily treatment log showing exactly which services were performed and how many minutes were spent on each one. This takes 30 seconds and gives you a paper trail to compare against your Medicare Summary Notice when it arrives. I have had clients catch billing errors worth hundreds of dollars simply because they had their own records to compare. If your therapist uses an electronic system, ask them to print or email you the session summary before you leave. Most are happy to do it once you explain why.',
      },
      {
        type: 'heading',
        level: 2,
      ...
      },
      {
        ...
        faqs: [
          ...
          {
            question: 'How many units is a 45-minute physical therapy session?',
            answer: 'A 45-minute session of timed services equals 3 billable units under the 8-minute rule (38 to 52 minutes = 3 units). However, if part of your session includes untimed services like an evaluation or hot packs, only the timed portion counts toward the unit calculation.',
          },
          {
          ...
          },
          {
            ...
            answer: 'There is no hard visit limit for outpatient physical therapy in 2026. Medicare covers medically necessary therapy services without a fixed number of visits. However, claims exceeding $2,480 per year for PT and speech therapy combined require the KX modifier, and claims exceeding $3,000 may be subject to targeted medical review.',
          },
          {
            question: 'What is the difference between timed and untimed therapy codes?',
            answer: 'Timed codes are billed per 15-minute unit and are subject to the 8-minute rule. Examples include therapeutic exercise (97110) and manual therapy (97140). Untimed (service-based) codes are billed once per session regardless of time. Examples include evaluations (97161-97163) and unattended electrical stimulation (97014). Only timed codes are subject to the 8-minute billing calculation.',
          },
          {
            question: 'What should I do if I think my therapist overbilled Medicare?',
            answer: 'First, request an itemized bill and the daily treatment log showing minutes spent on each service. Compare the units billed to the actual time. If there is a discrepancy, contact the billing department to request a correction. If unresolved, call 1-800-MEDICARE to report the issue or file a formal appeal within 120 days of receiving your Medicare Summary Notice.',
          },
          {
            question: 'How much does one unit of physical therapy cost under Medicare in 2026?',
            answer: 'The cost varies by CPT code and geographic location. The most common code, therapeutic exercise (97110), has a 2026 Medicare-approved rate of approximately $35 per unit nationally. Medicare pays 80% ($28), and you pay 20% ($7) in coinsurance after meeting your $283 annual Part B deductible. With Medigap Plan G, your coinsurance is covered.',
          },
        ],
      },
    ],
    relatedSlugs: ["medicare-coverage-for-physical-therapy", "does-medicare-cover-hip-replacement", "does-medicare-cover-knee-replacement", "medicare-supplement-plan-g-benefits", "medicare-prior-authorization", "does-medicare-cover-home-health-care", "understanding-medicare-assignment-what-it-means-and-why-it-matters"],
  },
  {
  ...
  },
  {
    ...
    seo: {
      title: 'Medigap Open Enrollment Period Rules for 2026',
      description: 'Learn when your six-month Medigap Open Enrollment Period starts, what protections apply, how pre-existing conditions work, and what happens afterward.',
      canonical: 'https://www.medicarefaq.com/faqs/medicare-supplement-open-enrollment/',
      ogImage: '/images/medicarefaq-cover.jpg',
    },
    title: 'Medigap Open Enrollment Period',
    summary: 'The Medigap Open Enrollment Period is a six-month federal window that begins when you are both 65 or older and enrolled in Medicare Part B. During this period, insurers cannot deny you a Medigap policy they sell, use medical underwriting, or charge you more because of your health. After the window closes, your options may depend on underwriting, guaranteed-issue rights, and state law.',
    category: 'Medicare Supplements',
    ...
    sections: [],
    richSections: [
      { type: 'paragraph', content: 'The Medigap Open Enrollment Period (OEP) is the main federal window for buying a [Medicare Supplement (Medigap)](/medicare-supplement-plans/) policy without medical underwriting. It lasts six months and begins automatically on the first day of the month in which you are both age 65 or older and enrolled in Medicare Part B.' },
      { type: 'callout', calloutType: 'info', calloutTitle: 'Need an Enrollment Checklist?', calloutText: 'This page explains the enrollment rules. When you are ready to compare plan letters, quotes, and effective dates, use our [practical Medigap enrollment checklist](/blog/the-best-time-to-enroll-in-a-medicare-supplement-plan-and-why-it-matters/).' },
      { type: 'callout', calloutType: 'warning', calloutTitle: 'There Is No Federal Annual Medigap Open Enrollment Period', calloutText: 'The fall Medicare Annual Enrollment Period does not reopen your original Medigap window. After the six-month period ends, medical underwriting may apply unless you have a federal guaranteed-issue right or an additional state protection.' },
      { type: 'heading', level: 2, text: 'When Does Your Medigap OEP Begin?', id: 'when-it-begins' },
      { type: 'paragraph', content: 'Your Medigap OEP begins on the first day of the month you are both 65 or older and enrolled in Part B. If you turn 65 in June and Part B starts June 1, your OEP runs June 1 through November 30. If you delay Part B while covered through current employment, your OEP generally waits until Part B begins, even if you are already older than 65.' },
      { type: 'table', title: 'Medigap OEP Timing Examples', headers: ['Scenario', 'Part B Start Date', 'OEP Window'], rows: [
        ...
        ['Receive Medicare due to disability before 65', 'Varies', 'A new six-month OEP generally begins when you turn 65 while enrolled in Part B'],
      ]},
      { type: 'paragraph', content: 'You can verify the federal rule on Medicare.gov\'s [Medigap enrollment timing page](https://www.medicare.gov/health-drug-plans/medigap/ready-to-buy/when). People under 65 may have additional Medigap rights under state law, but those rights vary.' },

      { type: 'heading', level: 2, text: 'What Protections Apply During Your OEP?', id: 'protections' },
      { type: 'paragraph', content: 'During your Medigap OEP, an insurer must sell you any Medigap policy it offers, even if you have health problems. It cannot use medical underwriting to deny you, delay your application, or charge you a higher premium because of your health history.' },
      { type: 'list', ordered: false, items: [
        'You can apply for any Medigap policy the insurer sells for which you are eligible',
        'The insurer cannot deny your application because of a current or past health condition',
        'The insurer cannot add a health-based surcharge to your premium',
        'Your premium may still vary for non-health factors allowed under state law, such as age, location, tobacco use, or household discounts'
      ]},
      { type: 'callout', calloutType: 'info', calloutTitle: 'Open Enrollment and Guaranteed-Issue Rights Are Related but Different', calloutText: 'Your Medigap OEP is a broad six-month purchase protection tied to age and Part B. Federal guaranteed-issue rights apply in specific situations outside that window and may limit which policies you can buy.' },

      { type: 'heading', level: 2, text: 'How Do Pre-Existing Conditions Affect Coverage?', id: 'pre-existing-conditions' },
      { type: 'paragraph', content: 'An insurer cannot deny you or charge more because of a pre-existing condition during your OEP. In limited circumstances, however, the policy may delay coverage related to that condition for up to six months. Prior creditable coverage can reduce or eliminate this waiting period, especially when you had at least six months of continuous coverage before applying.' },
      { type: 'paragraph', content: 'A pre-existing-condition waiting period does not postpone the entire Medigap policy. Other covered benefits can begin on the policy effective date. Review our guide to [Medigap and pre-existing conditions](/faqs/medicare-supplement-plans-and-pre-existing-conditions/) and ask the insurer to explain any waiting period in writing before you enroll.' },

      { type: 'heading', level: 2, text: 'Which Plans Can You Buy During Your OEP?', id: 'which-plans' },
      { type: 'paragraph', content: 'During your OEP, you can buy any standardized Medigap plan an insurer sells for which you are eligible. Plan G covers most Original Medicare cost sharing except the Part B deductible. Plan N can have a lower premium but includes certain copayments and does not cover Part B excess charges.' },
      { type: 'paragraph', content: 'Plans C and F are available only to people who were eligible for Medicare before January 1, 2020. Massachusetts, Minnesota, and Wisconsin use different standardized plan structures, so residents should compare their state-specific options rather than relying on the standard letter-plan chart.' },

      { type: 'heading', level: 2, text: 'What Happens After Your OEP Ends?', id: 'after-oep' },
      { type: 'paragraph', content: 'Once your six-month OEP closes, an insurer may use medical underwriting in most states. It may ask health questions, charge more because of your health, or deny your application. Medigap has no federal late enrollment penalty, but waiting can affect your access to a policy and the price you are offered.' },
      { type: 'paragraph', content: 'You may still have a federal [guaranteed-issue right](/faqs/medicare-guaranteed-issue/) after certain coverage changes. Some states also offer additional protections, including birthday or anniversary rules. These rights are situation-specific, so confirm the policy choices and application deadline before ending existing coverage.' },

      { type: 'heading', level: 2, text: 'How Is Medigap OEP Different From Other Enrollment Periods?', id: 'other-enrollment-periods' },
      { type: 'table', title: 'Enrollment Periods Are Not Interchangeable', headers: ['Enrollment period', 'What it controls', 'Does it create a new federal Medigap OEP?'], rows: [
        ['Medigap Open Enrollment Period', 'Your protected federal window to buy Medigap', 'This is the Medigap window'],
        ['Medicare Initial Enrollment Period', 'Initial enrollment in Medicare Parts A and B and related choices', 'No, but your Part B start can trigger Medigap OEP'],
        ['Medicare Annual Enrollment Period', 'Medicare Advantage and Part D changes from October 15 through December 7', 'No'],
        ['Medicare Advantage Open Enrollment Period', 'Limited changes for current Medicare Advantage members from January 1 through March 31', 'No'],
      ]},
      { type: 'paragraph', content: 'A valid opportunity to leave Medicare Advantage does not automatically guarantee that you can buy every Medigap policy. Confirm whether a trial right, guaranteed-issue right, state protection, or medical underwriting applies before changing your Medicare Advantage coverage.' },

      { type: 'heading', level: 2, text: 'How to Enroll During Your OEP', id: 'how-to-enroll' },
      { type: 'paragraph', content: 'First confirm your Part B effective date. Then compare standardized plan letters, request equivalent quotes from multiple insurers, and choose a policy effective date that coordinates with any employer, retiree, or other supplemental coverage. Medigap policies sold today do not include outpatient prescription coverage, so review a separate Part D plan if you do not have other creditable drug coverage.' },
      { type: 'list', ordered: true, items: [
        'Confirm your Part B effective date and the last day of any current coverage',
        'Compare the benefits of the Medigap plan letters available to you',
        'Request quotes using the same age, ZIP code, tobacco status, effective date, and household assumptions',
        'Get the insurer name, policy form, premium, discount terms, and effective date in writing',
        'Do not cancel existing coverage until the replacement policy is approved and its start date is confirmed'
      ]},
      { type: 'faq', faqs: [
        { question: 'Can I be denied a Medigap plan during my Open Enrollment Period?', answer: 'No. During your federal Medigap OEP, an insurer must sell you any Medigap policy it offers for which you are eligible. It cannot use your health history to deny the application or charge a higher premium. Non-health pricing factors allowed under state law can still affect the premium.' },
        { question: 'Can a Medigap insurer ask health questions during my OEP?', answer: 'An application may include health information, but the insurer cannot use medical underwriting to deny you or charge more because of your health during your OEP. The insurer may need information to determine whether a pre-existing-condition waiting period applies, so answer application questions completely and accurately.' },
        { question: 'Does the Medigap OEP apply to Medicare Advantage plans?', answer: 'No. The Medigap OEP applies only to Medicare Supplement policies used with Original Medicare. Medicare Advantage has separate enrollment periods and plan rules. You cannot use Medigap to pay Medicare Advantage cost sharing, and an opportunity to leave Medicare Advantage does not automatically create a new Medigap OEP.' },
        { question: 'What if I enrolled in Medicare Advantage first and now want Medigap?', answer: 'You may have a federal trial right in certain situations, including some first-time Medicare Advantage enrollments, but the details depend on how and when you joined. Confirm the Medicare Advantage disenrollment period and your Medigap purchase protection before leaving the plan so you do not create an unexpected coverage gap.' },
        { question: 'Can I buy Medigap after my OEP ends?', answer: 'Yes, you can apply, but medical underwriting may apply in most states. An insurer may deny the application or charge more because of your health unless you have a federal guaranteed-issue right or a state protection. Check your rights before cancelling any policy you already have.' },
        { question: 'Do I need to wait until October to enroll in Medigap?', answer: 'No. The October 15 through December 7 Medicare Annual Enrollment Period is mainly for Medicare Advantage and Part D changes. It does not create a federal annual Medigap window. Your initial Medigap OEP is tied to being 65 or older and enrolled in Part B.' },
      ]},
    ],
