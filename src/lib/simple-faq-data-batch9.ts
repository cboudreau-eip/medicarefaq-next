...
export const simpleFAQBatch9: SimpleFAQArticleData[] = [
  {
    ...
    relatedSlugs: [
      ...
      "medicare-part-d", "does-medicare-cover-end-stage-renal-disease", "does-medicare-cover-varicose-veins", "medicare-and-mail-order-prescriptions", "medicare-diabetes"],
  }];
