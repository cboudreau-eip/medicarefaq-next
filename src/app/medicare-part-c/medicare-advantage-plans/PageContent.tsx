              ...
              <section id="enrollment" className="mb-16">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { period: (<><Link href="/enrollment/annual-enrollment-period" className="text-teal-700 underline hover:text-teal-900">Annual Enrollment Period</Link> (AEP)</>), dates: "October 15 – December 7 each year", desc: "Switch between Original Medicare and Medicare Advantage, or change MA plans. Coverage starts January 1." },
