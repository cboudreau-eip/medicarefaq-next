"use client";
/**
 * West Virginia Medicare Supplement Comparison Page
 * Route: /medicare-supplements/west-virginia/
 * Key differentiators: No birthday rule, Plan G from $138/mo (LifeShield National),
 *                      Highmark BCBS WV dominant local carrier, under-65 coverage available,
 *                      attained-age rating dominates, SHIP free counseling at 1-877-987-4463
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/west-virginia-medigap-data";
    ...
    <div className="bg-white border border-slate-200 rounded-xl p-5 hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-slate-900 text-base">{carrier.name}</h3>
        ...
        <div className="flex items-center gap-3">
          <div className={`px-2.5 py-1 rounded-lg border text-xs font-bold ${getScoreColor(carrier.score)}`}>
            {carrier.score}/5.0
          </div>
          <div className="text-right">
            <p className="text-xs text-slate-500">Plan G</p>
            <p className="font-bold text-slate-900">{carrier.planGMonthly}/mo</p>
          </div>
        </div>
      </div>
      <div className="mt-3 flex flex-wrap gap-3 text-xs text-slate-600">
        <span className="flex items-center gap-1">
          <Star className="w-3.5 h-3.5 text-amber-500" /> AM Best: {carrier.amBest}
        </span>
        <span className="flex items-center gap-1">
          <DollarSign className="w-3.5 h-3.5 text-emerald-500" /> Plan N: {carrier.planNMonthly}/mo
        </span>
      </div>
      <p className="mt-3 text-sm text-slate-600 leading-relaxed">{carrier.highlight}</p>
      <div className="mt-4 flex flex-wrap gap-2">
        <div className="flex flex-wrap gap-2 w-full sm:w-auto">
          <ZipFormModal
            pageSection="west_virginia_carrier_card"
            triggerId={`west-virginia-carrier-${rank}`}
            coverageType="ms"
            title={`Get ${carrier.name} Rates in Your ZIP Code`}
            subtitle={`See exact ${carrier.name} Medicare Supplement rates for your area in West Virginia.`}
            buttonLabel="Compare Plans"
            trigger={
              <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-4 py-2.5 rounded-lg transition-colors text-sm">
          ...
          <a
            ...
            onClick={() =>
              trackPhoneClick({
                ...
                page_section: "west_virginia_carrier_card",
              })
            }
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border border-slate-300 hover:border-blue-400 text-slate-700 font-medium px-4 py-2.5 rounded-lg transition-colors text-sm"
          >
...
export default function WestVirginiaPageContent() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" />
            <span className="text-teal-400">West Virginia</span>
          </div>
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
              <span className="text-2xl font-black text-white">WV</span>
            </div>
          ...
          <p className="text-lg text-slate-300 mb-6 max-w-2xl">
            Compare the top-rated Medigap carriers in West Virginia. Plan G starts at{" "}
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> WV Medigap enrollees
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <DollarSign className="w-4 h-4 text-teal-400" />
              <span>
                Plan G from <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> in Charleston
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <TrendingDown className="w-4 h-4 text-teal-400" />
              <span>
                Plan N from <strong className="text-white">$98/mo</strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Award className="w-4 h-4 text-amber-400" />
              <span>
                <strong className="text-white">{STATE_STATS.carriers}</strong> carriers licensed in WV
              </span>
            </div>
          </div>
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="west_virginia_hero"
              triggerId="west-virginia-hero-compare"
              coverageType="ms"
              title="Compare West Virginia Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of West Virginia."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare WV Rates <ArrowRight className="w-4 h-4" />
                </button>
              }
            />
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  phone_number: "(888) 335-8996",
                  page_section: "west_virginia_hero",
                })
              }
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                West Virginia Has No Birthday Rule: Your Initial Plan Choice Matters
              </p>
              <p className="text-sm text-amber-800">
                Unlike California, Oregon, and other states with birthday rules, West Virginia does{" "}
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Highmark BCBS WV dominant local carrier</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 95,000 West Virginia residents have Medicare Supplement Insurance, also
            called Medigap. West Virginia follows standard federal Medigap rules, offering plans
          ...
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            West Virginia does not have a birthday rule or anniversary rule, which means your
          ...
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G premiums in Charleston range from $138/mo (LifeShield National) to $195/mo
            (AARP/UHC) for a 65-year-old. Highmark BCBS of West Virginia is the dominant local
            carrier with deep provider networks across the state, while LifeShield National and
            MedMutual Protect offer the lowest premiums.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in West Virginia, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Charleston. Rates in
            Huntington, Morgantown, and Parkersburg may vary slightly.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in West Virginia
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Charleston for a 65-year-old female
            nonsmoker. Rates may include available household discounts. West Virginia uses
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                Lowest Plan G for the general public: $138/mo (LifeShield National).
                Source: WV OIC, FairSquare Medicare, MoneyGeek, May 2026.
              </p>
            </div>
          </div>
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="west_virginia_premium_table"
              triggerId="west-virginia-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your West Virginia ZIP Code"
              subtitle="Premiums vary by city in West Virginia. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            in West Virginia. Here is how they compare.
          </p>
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Avg. monthly premium (Charleston)", g: "$138-$195", n: "$98-$142", bold: true },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office visits
                and up to $50 for ER visits that do not result in inpatient admission. West Virginia
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  West Virginia has no birthday rule, so your initial enrollment decision is the
                  most important one you will make.
                </strong>{" "}
                Do not just pick the cheapest premium today. Consider long-term rate stability:
                attained-age plans (most carriers) will increase every year as you age. LifeShield
                National at $138/mo is the best value Plan G for most West Virginia seniors.
                Highmark BCBS of West Virginia is the dominant local carrier with deep provider
                networks in Charleston, Huntington, and Morgantown, but their premiums tend to be
                higher. If you want the highest financial strength rating, State Farm (A++) at
                $165/mo with local agents statewide is a strong pick.
              </>
            }
          />
        </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                CMS Medicare Plan Finder, WV Office of the Insurance Commissioner, FairSquare Medicare
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl">
              West Virginia has no birthday rule, so your Open Enrollment Period is your best
              chance to lock in coverage without health questions. Plan G starts at $138/mo in
              Charleston. Compare all available carriers in your area before enrolling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="west_virginia_bottom_cta"
                triggerId="west-virginia-bottom-cta-compare"
                coverageType="ms"
                title="Compare West Virginia Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of West Virginia."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "west_virginia_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
