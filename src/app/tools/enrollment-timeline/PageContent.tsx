      ...
      <div className="bg-gradient-to-r from-[#1B2A4A] to-[#2D4A7A] rounded-2xl p-6 md:p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            className="invoca-phone inline-flex items-center gap-2 bg-[#C41230] hover:bg-[#A30F28] text-white font-bold px-6 py-3.5 rounded-lg transition-colors shadow-lg"
          >
