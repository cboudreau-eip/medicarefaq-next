...
const sitemapSections = [
  {
    ...
    links: [
      { label: "Home", href: "/" },
      { label: "Compare Rates", href: "/medicare-supplement-plans" },
  ...
  },
  {
    ...
    links: [
      { label: "Medicare Supplement Overview", href: "/medicare-supplement-plans" },
      { label: "Medigap Plan G", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-g" },
      { label: "Medigap Plan F", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-f" },
      { label: "Medigap Plan N", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-n" },
      { label: "Medigap Plan C", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-c" },
      { label: "Medigap Plan D", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-d" },
      { label: "Medigap Plan B", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-b" },
      { label: "Medigap Plan A", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-a" },
      { label: "Medigap Plan K", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-k" },
      { label: "Medigap Plan L", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-l" },
      { label: "Medigap Plan M", href: "/medicare-supplement-plans/medicare-supplement-plans/plan-m" },
      { label: "High-Deductible Plan G", href: "/medicare-supplement-plans/medicare-supplement-plans/high-deductible-plan-g" },
      { label: "High-Deductible Plan F", href: "/medicare-supplement-plans/medicare-supplement-plans/high-deductible-plan-f" },
      { label: "Compare Medigap Plans", href: "/medicare-supplement-plans/compare-medigap-plans" },
      { label: "Medigap Eligibility", href: "/medicare-supplement-plans/medigap-eligibility" },
      { label: "Medigap Plans 2026", href: "/medicare-supplement-plans/medicare-supplement-plans-2026" },
      { label: "Medigap Carriers", href: "/medicare-supplement-plans/medicare-supplement-carriers" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "HMO Plans", href: "/medicare-part-c/medicare-advantage-plan-hmo" },
      { label: "PPO Plans", href: "/medicare-part-c/medicare-advantage-plan-ppo" },
      { label: "PFFS Plans", href: "/medicare-part-c/medicare-advantage-plan-pffs" },
      { label: "SNP Plans", href: "/medicare-part-c/medicare-advantage-plan-snp" },
  ...
  },
  {
    ...
    links: [
      { label: "Caregiver Guide Overview", href: "/guide-to-being-a-caregiver" },
      { label: "Caregiver Assistance", href: "/guide-to-being-a-caregiver/caregiver-assistance" },
      { label: "Who Qualifies as a Caregiver", href: "/guide-to-being-a-caregiver/who-qualifies-as-a-caregiver-under-medicare-rules" },
      { label: "How to Become a Caregiver", href: "/guide-to-being-a-caregiver/how-to-become-a-caregiver" },
      { label: "4 Types of Caregivers", href: "/guide-to-being-a-caregiver/what-are-the-4-types-of-caregivers" },
      { label: "What Is a Caregiver", href: "/guide-to-being-a-caregiver/what-is-a-caregiver" },
      { label: "Role of a Caregiver", href: "/guide-to-being-a-caregiver/role-of-a-caregiver" },
    ],
  },
  {
    title: "About",
