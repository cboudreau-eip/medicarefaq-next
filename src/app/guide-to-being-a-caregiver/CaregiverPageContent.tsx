  ...
  return (
    <>
        ...
        <div className="container max-w-5xl">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="invoca-phone inline-flex items-center gap-2 bg-[#C41230] hover:bg-[#a30f28] text-white font-semibold px-5 py-3 rounded-lg transition-colors"
            >
      ...
      <main className="flex-1 py-12 px-4">
        <div className="container max-w-5xl flex gap-8">
          {/* Table of Contents */}
