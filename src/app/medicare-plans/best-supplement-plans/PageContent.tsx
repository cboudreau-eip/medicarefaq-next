...
const planComparison = [
  ...
  { benefit: "Part A Deductible ($1,736)", g: true, n: true, f: true, gHd: true },
  { benefit: "Part B Deductible ($283)", g: false, n: false, f: true, gHd: false },
...
const topPlans = [
  {
    ...
    deductible: "$283 Part B deductible",
    color: "border-teal-400 bg-teal-50",
    badgeColor: "bg-teal-600",
    desc: "The gold standard of Medigap. Plan G covers everything except the Part B deductible ($283/year). After paying that small deductible, you have virtually zero out-of-pocket costs for the rest of the year. Plan G has been the most popular Medigap plan since Plan F closed to new enrollees in 2020.",
    bestFor: "Most Medicare beneficiaries who want comprehensive, predictable coverage",
    pros: ["Covers nearly everything — only $283/year out-of-pocket", "Nationwide coverage — any Medicare doctor", "No referrals or prior authorization", "Premiums often lower than Plan F was"],
    cons: ["Must pay the $283 Part B deductible", "No prescription drug coverage", "Higher premiums than Plan N"],
  },
  {
    rank: 2,
    name: "Plan N",
    ...
    deductible: "$283 Part B deductible + small copays",
  ...
  },
  {
    ...
    cons: ["Only available if Medicare-eligible before Jan 1, 2020", "Premiums rising faster than Plan G", "Shrinking risk pool drives costs up", "Paying more for just $283 of extra coverage vs Plan G"],
  },
  {
    rank: 4,
    ...
    avgPremium: "$40 – $80/mo",
    deductible: "$2,950 annual deductible (2026)",
    color: "border-slate-300 bg-slate-50",
    badgeColor: "bg-slate-600",
    desc: "High-Deductible Plan G has the same benefits as regular Plan G, but with a much lower premium. The catch: you pay a $2,950 annual deductible before the plan kicks in. After the deductible, coverage is identical to Plan G. This is a good option for healthy people who want catastrophic protection.",
    ...
    cons: ["$2,950 annual deductible before coverage starts", "Higher out-of-pocket risk than Plan G or N", "Not ideal for people with frequent medical needs", "Must budget for potential deductible costs"],
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Only if you became Medicare-eligible before January 1, 2020. If you turned 65 or qualified for Medicare before that date, you can still enroll in Plan F. However, most experts recommend Plan G instead — it's nearly identical coverage for a lower premium, and the only difference is the $283 Part B deductible.",
  },
  {
        ...
        <div className="container">
          ...
          <div className="bg-gradient-to-br from-blue-700 to-blue-900 rounded-2xl p-8 md:p-10 text-white text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "best_supplement_plans" })} className="invoca-phone inline-flex items-center gap-2 bg-white text-blue-700 font-semibold px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors">
