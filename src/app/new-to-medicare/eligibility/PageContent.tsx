        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "eligibility" })} className="invoca-phone inline-flex items-center gap-2 border border-slate-500 hover:border-white text-white font-semibold px-6 py-3 rounded-lg transition-colors">
          ...
          <aside className="hidden lg:block w-56 shrink-0 order-last">
            <div className="sticky top-24">
              ...
              <div className="mt-8 p-4 bg-teal-50 rounded-xl border border-teal-100">
                ...
                <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "eligibility" })} className="invoca-phone flex items-center gap-2 text-sm font-semibold text-teal-700 hover:text-teal-900">
          ...
          <main className="flex-1 min-w-0 order-first">
            ...
            <section id="next-steps" className="scroll-mt-24">
              <div className="bg-gradient-to-br from-slate-900 to-teal-900 rounded-2xl p-8 md:p-12 text-white">
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "eligibility" })} className="invoca-phone inline-flex items-center gap-2 bg-teal-500 hover:bg-teal-400 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                    Call (888) 335-8996
                  </a>
