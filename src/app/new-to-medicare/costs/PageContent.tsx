        ...
        <div className="flex gap-12">
          ...
          <aside className="hidden lg:block w-56 shrink-0 order-last">
            <div className="sticky top-24">
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "costs" })} className="invoca-phone flex items-center gap-2 text-sm font-semibold text-emerald-700 hover:text-emerald-900">
            ...
            <section className="scroll-mt-24">
              <div className="bg-gradient-to-br from-slate-900 to-emerald-900 rounded-2xl p-8 md:p-12 text-white">
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "costs" })} className="invoca-phone inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                    Call (888) 335-8996
                  </a>
