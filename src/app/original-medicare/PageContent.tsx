        ...
        <div className="container relative z-10">
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm text-slate-400 mb-6 list-none">
              ...
              <li aria-hidden="true"><ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" /></li>
              <li aria-current="page"><span className="text-teal-400">Original Medicare</span></li>
            </ol>
          </nav>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-8">
            The foundation of Medicare coverage — hospital insurance (<strong>Part A</strong>) and medical insurance (<strong>Part B</strong>) provided directly by the federal government.
          </p>
            ...
            <div className="flex-1 min-w-0 max-w-3xl">
              ...
              <section id="overview" className="mb-16">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  <strong>Original Medicare</strong> is the traditional federal health insurance program that has been available since 1966. It consists of two parts: <strong>Part A (Hospital Insurance)</strong> and <strong>Part B (Medical Insurance)</strong>. Together, they provide coverage for hospital stays, doctor visits, outpatient care, preventive services, and more.
                </p>
                <p className="text-slate-600 leading-relaxed mb-8">
                  Unlike <strong>Medicare Advantage (Part C)</strong>, Original Medicare is administered directly by the federal government — not private insurance companies. This means you can see <strong>any doctor or hospital in the country</strong> that accepts Medicare, with no network restrictions.
                </p>
                ...
                <aside aria-label="Important notice: No out-of-pocket maximum" className="bg-amber-50 border-l-4 border-amber-400 p-5 rounded-r-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-800">
                        Original Medicare has <strong>no annual cap</strong> on how much you can spend out-of-pocket. This is why most beneficiaries add a <strong>Medigap</strong> supplement plan or choose Medicare Advantage, which does have an <strong>out-of-pocket maximum</strong>.
                      </p>
                    </div>
                  </div>
                </aside>
              ...
              <section id="part-a" className="mb-16">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  <strong>Medicare Part A</strong> covers inpatient care — hospital stays, skilled nursing facility care, hospice care, and some home health services. Most people qualify for <strong>premium-free Part A</strong> if they or their spouse paid Medicare taxes for at least 10 years (40 quarters).
                </p>
              ...
              <section id="part-b" className="mb-16">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  <strong>Medicare Part B</strong> covers outpatient medical services — doctor visits, preventive care, lab tests, durable medical equipment, mental health services, and more. Unlike Part A, <strong>everyone pays a monthly premium</strong> for Part B, and there's a 20% <strong>coinsurance</strong> with no annual cap.
                </p>
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-green-50 rounded-xl p-6 border border-green-100">
                    <h3 className="font-semibold text-green-800 mb-3 flex items-center gap-2">
                ...
                <aside aria-label="Key takeaway: Part B coinsurance has no annual limit" className="mt-6 bg-blue-50 border-l-4 border-blue-400 p-5 rounded-r-xl">
                  <p className="font-semibold text-blue-900 mb-1">Key Takeaway</p>
                  <p className="text-sm text-blue-800">
                    The 20% Part B coinsurance has <strong>no annual limit</strong>. A single hospital outpatient procedure could cost you thousands. This is the primary reason most people purchase a <strong>Medigap</strong> supplement or choose <strong>Medicare Advantage</strong>.
                  </p>
                </aside>
              </section>
              ...
              <section id="costs" className="mb-16">
                ...
                <dl className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  {[
                    ...
                    <div key={i} className="bg-gradient-to-br from-slate-50 to-white rounded-xl p-5 border border-slate-200">
                      <dt className="text-xs text-slate-500 uppercase tracking-wider mb-1">{stat.label}</dt>
                      <dd className="text-2xl font-bold text-slate-900">{stat.value}
                        <span className="block text-xs text-slate-400 mt-1 font-normal">{stat.sub}</span>
                      </dd>
                    </div>
                  ))}
                </dl>
                ...
                <ul className="grid md:grid-cols-2 gap-4 list-none">
                  {[
                    ...
                    <li key={i} className="flex gap-4 p-5 bg-slate-50 rounded-xl border border-slate-100">
                      <span className="text-2xl" aria-hidden="true">{gap.icon}</span>
                      <div>
              ...
              <section id="supplementing" className="mb-16">
                ...
                <p className="text-slate-600 leading-relaxed mb-8">
                  Because Original Medicare has no <strong>out-of-pocket maximum</strong> and doesn't cover prescriptions, dental, vision, or hearing, most beneficiaries add supplemental coverage. Here are your two main options:
                </p>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-xl border-2 border-blue-200 p-6 hover:border-blue-400 transition-colors">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 mb-2"><strong>Medigap</strong> (Medicare Supplement)</h3>
                    <p className="text-sm text-slate-600 mb-4">
                      Works alongside Original Medicare to cover <strong>deductibles</strong>, <strong>coinsurance</strong>, and <strong>copays</strong>. No networks — see any Medicare provider nationwide.
                    </p>
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "original_medicare" })} className="inline-flex items-center gap-2 bg-white text-blue-700 font-semibold px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors">
                    ...
                    <ZipFormModal
                      ...
                      triggerId="compare-all-plans-original-medicare"
                    />
                  </div>
                </div>
              </section>
              ...
              <nav aria-label="Related pages">
                <ul className="grid sm:grid-cols-3 gap-4 list-none">
                  <li>
                    <Link href="/medicare-supplement-plans" className="group p-5 bg-slate-50 rounded-xl border border-slate-100 hover:border-blue-200 hover:bg-blue-50/50 transition-colors flex flex-col">
                  ...
                  <li>
                    <Link href="/medicare-part-c/medicare-advantage-plans" className="group p-5 bg-slate-50 rounded-xl border border-slate-100 hover:border-blue-200 hover:bg-blue-50/50 transition-colors flex flex-col">
                  ...
                  <li>
                    <Link href="/new-to-medicare/costs" className="group p-5 bg-slate-50 rounded-xl border border-slate-100 hover:border-blue-200 hover:bg-blue-50/50 transition-colors flex flex-col">
