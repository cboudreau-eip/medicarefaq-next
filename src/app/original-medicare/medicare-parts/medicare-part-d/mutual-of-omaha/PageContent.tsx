    ...
    <main className="flex-1">
        ...
        <div className="container max-w-4xl py-10">
          ...
          <section className="mb-10 bg-teal-50 border border-teal-200 rounded-xl p-6">
            ...
            <Link
              href="/medicare-supplement-plans/medigap-by-carrier/mutual-of-omaha-medigap-plans"
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                { label: "Mutual of Omaha Medigap", href: "/medicare-supplement-plans/medigap-by-carrier/mutual-of-omaha-medigap-plans" },
                { label: "Compare Part D Plans", href: "/medicare-supplement-plans" },
              ].map((link, i) => (
                <Link
                  key={i}
                  href={link.href}
