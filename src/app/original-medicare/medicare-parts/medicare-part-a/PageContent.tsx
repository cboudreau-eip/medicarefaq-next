    ...
    <main className="flex-1">
        ...
        <div className="container max-w-5xl">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "medicare_part_a" })} className="invoca-phone inline-flex items-center gap-2 bg-[#E8871E] hover:bg-orange-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="bg-[#1B3A6B] text-white py-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "medicare_part_a" })} className="invoca-phone inline-flex items-center gap-2 bg-[#E8871E] hover:bg-orange-600 text-white font-semibold px-8 py-4 rounded-lg text-lg transition-colors">
