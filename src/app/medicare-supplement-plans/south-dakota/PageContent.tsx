 ...
 * Route: /medicare-supplement-plans/south-dakota/
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="south_dakota_carrier_card"
              triggerId={`south_dakota-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in South Dakota`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of South Dakota.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "south_dakota_carrier_card",
                })
              }
            ...
            <ZipFormModal
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare SD Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
        ...
        <div className="container max-w-4xl">
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 flex items-start gap-4">
            ...
            <div>
              ...
              >
                <Phone className="w-4 h-4" aria-hidden="true" /> Call SD SHIP: 1-833-663-9673
              </a>
            </div>
          </div>
        </div>
