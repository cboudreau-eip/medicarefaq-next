...
export default function SouthDakotaPage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Best Medicare Supplement Plans in South Dakota 2026 | MedicareFAQ",
    description: "Compare the best Medicare Supplement plans in South Dakota. See 2026 rates, carrier rankings, and state-specific rules from MedicareFAQ.",
    url: "https://www.medicarefaq.com/medicare-supplement-plans/south-dakota/",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "South Dakota" },
    ],
  };
