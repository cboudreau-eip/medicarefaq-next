 ...
 * Route: /medicare-supplement-plans/medicare-supplement-plans-2026
 */
        ...
        <div className="container relative z-10">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "medicare_supplement_plans_2026" })} className="invoca-phone inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
