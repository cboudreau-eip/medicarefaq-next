 ...
 * Route: /medicare-supplement-plans/washington/
            ...
            <ZipFormModal
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare WA Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
        ...
        <div className="container py-5">
          <div className="flex items-start gap-4 max-w-4xl">
            <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center shrink-0">
              <RefreshCw className="w-5 h-5 text-blue-700" aria-hidden="true" />
            </div>
            <div>
            ...
            <ZipFormModal
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-bold px-8 py-4 rounded-lg transition-colors text-lg">
                  Compare WA Rates <ArrowRight className="w-5 h-5" aria-hidden="true" />
                </button>
              }
            />
            <a
              ...
              className="invoca-phone inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-bold px-8 py-4 rounded-lg transition-colors border border-white/20 text-lg"
            >
              <Phone className="w-5 h-5" aria-hidden="true" /> (888) 335-8996
            </a>
          </div>
