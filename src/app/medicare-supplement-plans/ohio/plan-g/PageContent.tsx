"use client";
/**
 * Ohio Plan G Rate Comparison Page
 * Route: /medicare-supplement-plans/ohio/plan-g/
...
const PLAN_COMPARISON = [
  ...
  { feature: "Avg. monthly premium (FL)", planG: OHIO_STATS.averagePlanGPremium, planN: OHIO_STATS.averagePlanNPremium },
...
const FAQS = [
  {
    q: "What is the cheapest Plan G in Ohio?",
    a: `HealthSpring (formerly Cigna) currently offers the lowest Plan G premium in ${STATE_NAME} at approximately $106 per month for a 65-year-old. However, rates vary by age, gender, zip code, and tobacco use. Comparing quotes from multiple carriers is the best way to find the lowest rate in your area.`,
  },
  {
    q: "Is Plan G worth it in Ohio?",
  ...
  {
    q: "Can I switch from Plan N to Plan G in Ohio?",
  ...
  {
    q: "Can I use Plan G with any doctor in Ohio?",
  ...
  {
    q: "When is the best time to buy Plan G in Ohio?",
    ...
    <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-20">
          ...
          <div className="grid grid-cols-3 gap-4 mb-10 max-w-2xl">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              ...
              <p className="text-2xl md:text-3xl font-bold text-teal-400">{OHIO_STATS.lowestPlanGPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Average Rate</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{OHIO_STATS.averagePlanGPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <ZipFormModal
              coverageType="ms"
              pageSection="ohio_plan_g_hero"
              triggerId="oh-plan-g-hero-compare"
            ...
            <a
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "ohio_plan_g_hero" })}
      ...
      <section className="py-8">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="ohio_plan_g_mid"
           triggerId="oh-plan-g-mid-compare"
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mt-10">
            <ZipFormModal
             coverageType="ms"
              pageSection="ohio_plan_g_enroll"
             triggerId="oh-plan-g-enroll-compare"
             buttonLabel="Compare Plan G Rates"
             title={`Compare Plan G Rates in ${STATE_NAME}`}
             subtitle="Enter your ZIP code to see personalized Plan G rates from top carriers in your area."
              trigger={
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="ohio_plan_g_bottom"
           triggerId="oh-plan-g-bottom-compare"
           buttonLabel="Compare Plan G Rates"
           title={`Compare Plan G Rates in ${STATE_NAME}`}
           subtitle="Enter your ZIP code to see personalized Plan G rates from top carriers in your area."
            trigger={
              <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl p-10 md:p-14 text-center cursor-pointer hover:shadow-2xl transition-shadow group border-l-4 border-teal-500">
                ...
                <p className="text-blue-300 text-sm mt-4">
                  ...
                  <a
                    href="tel:+18883358996"  data-invoca-phone-number="18883358996"
                    onClick={(e) => { e.stopPropagation(); trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "ohio_plan_g_bottom" }); }}
