            ...
            <ZipFormModal
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare California Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              <Gift className="w-4 h-4 text-amber-600" aria-hidden="true" />
        ...
        <div className="container max-w-4xl">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center shrink-0">
              <CalendarDays className="w-6 h-6 text-amber-700" aria-hidden="true" />
            </div>
            <div>
      ...
      <section className="py-12 bg-white border-t border-slate-100">
        <div className="container max-w-5xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Explore California Medicare Supplement Plans
          </h2>
          <p className="text-slate-600 mb-8">
            Compare rates and coverage details for specific plan types available to California Medicare beneficiaries.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <a
              href="/medicare-supplement-plans/california/plan-g/"
            ...
            >
              ...
              <p className="text-sm text-slate-600 mb-3">
                Compare Plan G premiums from 30+ carriers in California. Covers everything except the Part B deductible.
              </p>
              <p className="text-sm text-teal-700 mt-2 font-medium">California has a birthday rule - you can switch Plan G carriers annually without health questions.</p>
              <div className="flex items-center gap-1 text-teal-600 font-semibold text-sm group-hover:gap-2 transition-all mt-3">
                Compare CA Plan G Rates
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </div>
            </a>
            <a
              href="/medicare-supplement-plans/california/plan-n/"
