"use client";
/**
 * California Plan N Rate Comparison Page
 * Route: /medicare-supplement-plans/california/plan-n/
...
import { CALIFORNIA_CARRIERS, CALIFORNIA_STATS, type CaliforniaCarrier } from "@/lib/california-medigap-data";
...
const carriersByPlanG = [...CALIFORNIA_CARRIERS].sort((a, b) => {
...
const PLAN_COMPARISON = [
  ...
  { feature: "Avg. monthly premium (FL)", planG: CALIFORNIA_STATS.averagePlanNPremium, planN: CALIFORNIA_STATS.averagePlanNPremium },
...
const FAQS = [
  {
    q: "What is the cheapest Plan N in California?",
    a: `HealthSpring (formerly Cigna) currently offers the lowest Plan N premium in ${STATE_NAME} at approximately $166 per month for a 65-year-old. However, rates vary by age, gender, zip code, and tobacco use. Comparing quotes from multiple carriers is the best way to find the lowest rate in your area.`,
  },
  {
    q: "Is Plan N worth it in California?",
  ...
  {
    q: "Can I switch from Plan N to Plan N in California?",
    a: `Yes, but you will likely need to pass medical underwriting unless you have a guaranteed issue right. ${STATE_NAME} has a birthday rule that gives you 60 days starting on your birthday each year to switch to any Plan N from any carrier without medical underwriting. This makes switching much easier than in most states.`,
  },
  {
  ...
  {
    q: "Can I use Plan N with any doctor in California?",
  ...
  {
    q: "When is the best time to buy Plan N in California?",
  ...
  {
    q: "What happens if I miss my Medigap open enrollment in California?",
    a: `If you miss your 6-month open enrollment window, you can still apply for Plan N, but carriers can use medical underwriting to decide whether to accept you and what premium to charge. ${STATE_NAME} has a birthday rule that provides an annual 60-day switching window starting on your birthday. Even if you miss your initial open enrollment, you can switch plans each year without health questions during this window.`,
  },
  {
    q: "How does the California birthday rule work?",
    a: `Yes. ${STATE_NAME} has a Medigap birthday rule that gives you 60 days starting on your birthday each year to switch to any Medigap plan with equal or lesser benefits from any carrier, without medical underwriting. This is one of the strongest consumer protections in the country for Medigap policyholders.`,
  },
];

export default function CaliforniaPlanGContent() {
    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-20">
          ...
          <nav className="flex items-center gap-2 text-sm text-blue-200 mb-8" aria-label="Breadcrumb">
            ...
            <span className="text-blue-400">&gt;</span>
            <Link href="/medicare-supplement-plans/california" className="hover:text-white transition-colors">{STATE_NAME}</Link>
            <span className="text-blue-400">&gt;</span>
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-3xl">
            ...
            Compare rates from {CALIFORNIA_STATS.numberOfCarriers} carriers in {STATE_NAME} to find the lowest premium.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 mb-10 max-w-2xl">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              ...
              <p className="text-2xl md:text-3xl font-bold text-teal-400">{CALIFORNIA_STATS.lowestPlanNPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Average Rate</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{CALIFORNIA_STATS.averagePlanNPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Carriers</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{CALIFORNIA_STATS.numberOfCarriers}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <ZipFormModal
              coverageType="ms"
              pageSection="california_plan_n_hero"
              triggerId="ca-plan-n-hero-compare"
            ...
            <a
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "california_plan_n_hero" })}
      ...
      <section className="py-8">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="california_plan_n_mid"
           triggerId="ca-plan-n-mid-compare"
      ...
      {/* ─── SECTION 6: California-Specific Rules ─── */}
      <section className="py-16 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-bold text-slate-900">Birthday Rule (60 Days)</h3>
              </div>
              <p className="text-sm text-slate-700">
                {STATE_NAME} has one of the strongest birthday rules in the country. Each year, starting on your birthday, you have 60 days to switch to any Medigap plan with equal or lesser benefits from any carrier without medical underwriting. You can switch to a lower-cost Plan N from a different carrier every year if you find a better rate.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-bold text-slate-900">Free Look Period & HICAP</h3>
              </div>
              <p className="text-sm text-slate-700">
                {STATE_NAME} provides a {CALIFORNIA_STATS.freeLookPeriod} free look period after purchasing a Medigap policy. If you are not satisfied, you can cancel for a full refund. {STATE_NAME} also offers the HICAP program (Health Insurance Counseling and Advocacy Program), which provides free, unbiased Medicare counseling.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-6">
            {[
              ...
              {
                step: 4,
                title: `Review your policy during the ${CALIFORNIA_STATS.freeLookPeriod} free look period`,
                desc: `After your policy starts, you have ${CALIFORNIA_STATS.freeLookPeriod} to review it. If you are not satisfied for any reason, you can cancel for a full refund of premiums paid.`,
              },
            ].map((item) => (
          ...
          <div className="mt-10">
            <ZipFormModal
             coverageType="ms"
              pageSection="california_plan_n_enroll"
             triggerId="ca-plan-n-enroll-compare"
             buttonLabel="Compare Plan N Rates"
             title={`Compare Plan N Rates in ${STATE_NAME}`}
             subtitle="Enter your ZIP code to see personalized Plan N rates from top carriers in your area."
              trigger={
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="california_plan_n_bottom"
           triggerId="ca-plan-n-bottom-compare"
           buttonLabel="Compare Plan N Rates"
           title={`Compare Plan N Rates in ${STATE_NAME}`}
           subtitle="Enter your ZIP code to see personalized Plan N rates from top carriers in your area."
            trigger={
              <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl p-10 md:p-14 text-center cursor-pointer hover:shadow-2xl transition-shadow group border-l-4 border-teal-500">
                ...
                <p className="text-blue-200 mb-8 max-w-xl mx-auto">
                  ...
                  Compare rates from {CALIFORNIA_STATS.numberOfCarriers} carriers in {STATE_NAME} to make sure you are not overpaying.
                </p>
                ...
                <p className="text-blue-300 text-sm mt-4">
                  ...
                  <a
                    href="tel:+18884410465"
                    onClick={(e) => { e.stopPropagation(); trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "california_plan_n_bottom" }); }}
      ...
      <section className="py-12 bg-slate-50 border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/medicare-supplement-plans/california" className="inline-flex items-center gap-1.5 text-sm text-blue-700 hover:text-blue-900 bg-white px-4 py-2 rounded-lg border border-slate-200 hover:border-blue-300 transition-colors">
