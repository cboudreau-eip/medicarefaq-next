"use client";
/**
 * Oklahoma Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/oklahoma/
 * Key differentiators: No birthday rule, Plan G from $136/mo (MedMutual Protect, A+),
 *                      Farm Bureau Insurance lowest Plans B/C/D/M, Transamerica all 10 plan types,
 *                      State Farm A++ with local agents in OKC and Tulsa,
 *                      SHIP free counseling at (800) 522-0071
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/oklahoma-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="oklahoma_carrier_card"
              triggerId={`oklahoma-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Oklahoma`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Oklahoma.`}
...
export default function OklahomaPageContent() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Oklahoma</span>
          </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Oklahoma has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at{" "}
            {STATE_STATS.lowestPlanG} in Oklahoma City and averages {STATE_STATS.avgPlanG} statewide.
            We compared {STATE_STATS.carriers} carriers to find the best coverage in the Sooner State.
          </p>
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Users className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> Oklahomans with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> in Oklahoma City
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <TrendingDown className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                Plan N from <strong className="text-white">$96/mo</strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Award className="w-4 h-4 text-amber-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.carriers}</strong> carriers licensed in Oklahoma
              </span>
            </div>
          </div>
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="oklahoma_hero"
              triggerId="oklahoma-hero-compare"
              coverageType="ms"
              title="Compare Oklahoma Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Oklahoma."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare OK Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Oklahoma Has No Birthday Rule: Your Initial Plan Choice Matters
              </p>
              <p className="text-sm text-amber-800">
                Unlike California, Oregon, and other states with birthday rules, Oklahoma does{" "}
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>State Farm A++ rated in Oklahoma</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 180,000 Oklahomans have Medicare Supplement Insurance, also called Medigap.
            Oklahoma follows standard federal Medigap rules, offering plans A through N with no
          ...
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            MedMutual Protect offers the lowest Plan G in Oklahoma at $136/mo, which is $108 below
            the state average of $244/mo. Farm Bureau Insurance is the price leader for Plans B, C,
            D, and M. Transamerica is the only carrier offering all 10 standardized plan types with
            issue-age pricing. State Farm holds the highest AM Best rating (A++) with local agents
            across Oklahoma City, Tulsa, and rural Oklahoma.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Oklahoma has no birthday rule, so your initial Open Enrollment Period is your most
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Compare the Best Medicare Supplement Plans in Oklahoma
          </h2>
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Oklahoma, ranked by the MedicareFAQ Score. Premiums
            shown are for a 65-year-old female nonsmoker in Oklahoma City. Rates in Tulsa and rural
            Oklahoma may vary slightly.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Oklahoma
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Oklahoma City for a 65-year-old female
            nonsmoker. Rates may include available household discounts. Oklahoma uses attained-age
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *USAA is only available to military members, veterans, and eligible family members.
                Lowest Plan G for the general public: $136/mo (MedMutual Protect).
                Source: Oklahoma Insurance Department, FairSquare Medicare, MoneyGeek, May 2026.
              </p>
            </div>
          </div>
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="oklahoma_premium_table"
              triggerId="oklahoma-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Oklahoma ZIP Code"
              subtitle="Premiums vary by city in Oklahoma. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            in Oklahoma. Here is how they compare.
          </p>
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Avg. monthly premium (OKC)", g: "$136-$162", n: "$96-$204", bold: true },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office visits
                and up to $50 for ER visits that do not result in inpatient admission. Oklahoma
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  Oklahoma has no birthday rule, so your initial enrollment decision is the most
                  important one you will make.
                </strong>{" "}
                Do not just pick the cheapest premium today. MedMutual Protect at $136/mo is the
                lowest Plan G in the state, but its attained-age pricing means your rate will
                increase every year. Transamerica at $162/mo uses issue-age pricing that locks in
                your rate at enrollment, which can save you money over the long term. State Farm
                at $152/mo offers the highest financial strength (A++) with local agents in OKC
                and Tulsa. If you want the lowest Plan N, MedMutual Protect at $96/mo is the
                clear winner. For Plans B, C, D, or M, Farm Bureau Insurance has the lowest rates
                in Oklahoma.
              </>
            }
          />
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Oklahoma Medigap Rules You Should Know
          </h2>
          <div className="space-y-4">
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                CMS Medicare Plan Finder, Oklahoma Insurance Department, FairSquare Medicare
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your Oklahoma ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              Oklahoma has no birthday rule, so your Open Enrollment Period is your best chance to
              lock in coverage without health questions. Plan G starts at $136/mo in Oklahoma City.
              Compare all available carriers in your area before enrolling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="oklahoma_bottom_cta"
                triggerId="oklahoma-bottom-cta-compare"
                coverageType="ms"
                title="Compare Oklahoma Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Oklahoma."
                buttonLabel="Compare Plans"
                trigger={
