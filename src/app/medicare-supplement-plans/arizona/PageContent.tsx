...
/**
 * Arizona Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/arizona/
 * Key differentiators: 352,000+ Medigap enrollees, Plan G from $106/mo in Phoenix,
 *                      no birthday/anniversary rule, Sun City and Scottsdale retirement markets,
 *                      Humana SilverSneakers popular, household discount widely available,
 *                      Arizona DIFI regulation, SHIP free counseling at 1-800-432-4040
 */
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="arizona_carrier_card"
              triggerId={`arizona-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Arizona`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Arizona.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "arizona_carrier_card",
                })
              }
...
/* Main Page Content */
export default function ArizonaPageContent() {
  return (
    <article className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Arizona</span>
          </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Arizona has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at
            just {STATE_STATS.lowestPlanG} in Phoenix. We compared{" "}
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan N from <strong className="text-white">$78/mo</strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="arizona_hero"
              triggerId="arizona-hero-compare"
              coverageType="ms"
              title="Compare Arizona Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Arizona."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare AZ Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
      ...
      {/* Sun Belt Retirement Spotlight Banner */}
      <section className="bg-amber-50 border-b border-amber-200">
        <div className="container py-5">
          <div className="flex items-start gap-4 max-w-4xl">
            <div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center shrink-0">
              <Sun className="w-5 h-5 text-amber-700" aria-hidden="true" />
            </div>
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Arizona Is One of the Top Retirement States in the Country
              </p>
              <p className="text-sm text-amber-800">
                Arizona&apos;s Medicare population has grown to over{" "}
                <strong>1.5 million</strong> - fueled by retirees moving to Phoenix,
                Scottsdale, Tucson, Sun City, and Sedona. With over{" "}
                <strong>352,000 Medigap enrollees</strong> and Plan G starting at just{" "}
                <strong>{STATE_STATS.lowestPlanG}/mo</strong> in Phoenix, Arizona offers
                competitive rates and a wide selection of carriers. Enrolling during your
                Open Enrollment Period at 65 is the best way to lock in coverage without
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Plan G from {STATE_STATS.lowestPlanG} in Phoenix</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Award className="w-4 h-4 text-amber-500" aria-hidden="true" />
              <span>Mutual of Omaha rated #1 overall in Arizona</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 352,000 people in Arizona have Medicare Supplement Insurance, or
            Medigap. Arizona is one of the top retirement destinations in the country,
            with Phoenix, Scottsdale, Tucson, and Sun City attracting retirees from
            across the nation. With over 30 carriers licensed in the state, Arizona
            offers a competitive Medigap market where Plan G starts at just $106 per
            month in Phoenix.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G is the most popular Medicare Supplement plan for new enrollees in
            Arizona. It covers nearly all Medicare out-of-pocket costs except the annual
            Part B deductible ($283 in 2026). Arizona uses attained-age rating, meaning
            ...
            rate. Unlike California or Missouri, Arizona has no birthday rule or
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Arizona, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Phoenix. Rates in
            Tucson, Scottsdale, and other regions may vary.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Arizona
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Phoenix. Rates shown are for a
            65-year-old female nonsmoker and may include available household discounts.
            Arizona uses attained-age rating, so premiums will increase as you age.
            Tucson and Scottsdale rates may differ slightly.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                <strong>Lowest available in Arizona (Phoenix):</strong> Plan G from{" "}
                {STATE_STATS.lowestPlanG} | Plan N from $78/mo | Source: FairSquare
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="arizona_premium_table"
              triggerId="arizona-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Arizona ZIP Code"
              subtitle="Premiums vary by city in Arizona. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            enrollees in Arizona. Here is how they compare.
          </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    {
                      feature: "Avg. monthly premium (Phoenix)",
                      g: { text: "$106–$148", bold: true },
                      n: { text: "$78–$108", bold: true },
                    },
                  ].map((row, i) => (
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  In Arizona, Cigna is cheapest at $106/mo, but Mutual of Omaha at
                  $138/mo is the better long-term value.
                </strong>{" "}
                ...
                if you are an active retiree in Scottsdale or Sun City, since their
                SilverSneakers benefit gives you free access to thousands of gyms
                statewide. Arizona has no birthday rule, so your 6-month Open Enrollment
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl">
              Arizona has a competitive Medigap market with over 30 carriers and Plan G
              starting at just $106/mo in Phoenix. Enter your ZIP code to see exact rates
            ...
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="arizona_bottom_cta"
                triggerId="arizona-bottom-cta-compare"
                coverageType="ms"
                title="Compare Arizona Medigap Rates"
                subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Arizona."
                buttonLabel="Compare Plans"
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "arizona_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
