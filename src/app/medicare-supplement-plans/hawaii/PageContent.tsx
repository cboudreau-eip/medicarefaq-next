...
/**
 * Hawaii Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/hawaii/
 * Key differentiators: No birthday rule, USAA lowest Plan G at $134/mo (military only),
 *                      State Farm lowest Plan N at $105/mo, Transamerica all 10 plan types,
 *                      neighbor island availability varies, strong MA market (Kaiser),
 *                      SHIP free counseling at 1-888-875-9229
 */
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="hawaii_carrier_card"
              triggerId={`hawaii-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Hawaii`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Hawaii.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "hawaii_carrier_card",
                })
              }
...
export default function HawaiiPageContent() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Hawaii</span>
          </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Hawaii has no birthday rule, making your initial Open Enrollment Period the most
            important enrollment decision. Plan G starts at {STATE_STATS.lowestPlanG} (USAA,
            military families only). State Farm offers the lowest Plan N at $105/mo with an A++
            rating. Over {STATE_STATS.carriers} carriers serve the Hawaii market.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> Hawaii seniors with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> (USAA, military only)
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <TrendingDown className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                State Farm Plan N: <strong className="text-white">$105/mo</strong> (A++)
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <AlertTriangle className="w-4 h-4 text-amber-400" aria-hidden="true" />
              <span>
                <strong className="text-white">No birthday rule:</strong> initial enrollment is critical
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="hawaii_hero"
              triggerId="hawaii-hero-compare"
              coverageType="ms"
              title="Compare Hawaii Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Hawaii."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare HI Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Hawaii Has No Birthday Rule: Your Initial Plan Choice Is Critical
              </p>
              <p className="text-sm text-amber-800">
                Unlike California, Oregon, and other states with birthday rules, Hawaii does{" "}
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>USAA A++ lowest Plan G at $134/mo</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 95,000 Hawaii residents have Medicare Supplement Insurance, also called
            Medigap. Hawaii follows standard federal Medigap rules, offering plans A through N
            with no state-specific modifications. Plan G is the most popular choice for new
            enrollees, covering nearly all Medicare out-of-pocket costs except the annual Part B
            deductible ($283 in 2026).
          </p>
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            Hawaii has a strong Medicare Advantage market, particularly Kaiser Permanente Hawaii,
            which many seniors choose for its integrated care model. However, Medigap offers
            important advantages: no network restrictions, predictable costs, and coverage that
            works with any Medicare-accepting provider nationwide. For Hawaii residents who travel
            to the mainland for specialty care, Medigap is often the better choice.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G premiums in Honolulu range from $134/mo (USAA, military only) to $259/mo
            (Humana) for a 65-year-old. For the general public, AARP/UHC at $155/mo and
            Transamerica at $151/mo offer the best value. State Farm stands out with an A++
            AM Best rating and the lowest Plan N in Hawaii at just $105/mo.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Hawaii, ranked by the MedicareFAQ Score. Rates
            shown are for a 65-year-old in the Honolulu area and are updated for 2026.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Hawaii Medigap Premium Comparison
          </h2>
          <p className="text-slate-600 mb-6">
            Monthly premiums for a 65-year-old in Honolulu, Hawaii. Rates are for standard Plan
            G, Plan N, and Plan F. Premiums vary by island, age, gender, and tobacco use.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                Rates are for a 65-year-old in Honolulu, Hawaii. N/A indicates the plan is not
                offered by that carrier in Hawaii. USAA is available only to military members,
                veterans, and their families. Plan F is only available to Medicare beneficiaries
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="hawaii_premium_table"
              triggerId="hawaii-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Hawaii ZIP Code"
              subtitle="Enter your ZIP code to see exact rates from all available carriers in your area of Hawaii."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            Hawaii. Here is how they compare.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    { feature: "Monthly premium (lowest HI rate)", g: "$134/mo (USAA, military)", n: "$105/mo (State Farm)" },
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  Hawaii has no birthday rule, so your initial Open Enrollment Period is your
                  most important decision point.
                </strong>{" "}
                If you are a military veteran or family member, USAA at $134/mo is the clear
                first choice with A++ financial strength. For the general public, State Farm at
                $176/mo for Plan G or $105/mo for Plan N is the best combination of financial
                strength and competitive pricing. If you live on a neighbor island, verify
                availability and rates for your specific island before enrolling, as some carriers
                have limited presence outside Oahu. Transamerica is the right choice if you want
                all 10 plan types or issue-age pricing for long-term rate stability.
              </>
            }
          />
        </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="space-y-4">
            {STATE_RULES.map((rule, i) => {
              const icons = [AlertTriangle, Info, MapPin, Clock, Shield, Users];
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl">
              Hawaii has no birthday rule. Your initial Open Enrollment Period is your best
              opportunity to lock in coverage without medical underwriting. Plan G starts at
              $134/mo (USAA, military) or $151/mo (Transamerica) for the general public. Compare
              all carriers before enrolling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="hawaii_bottom_cta"
                triggerId="hawaii-bottom-cta-compare"
                coverageType="ms"
                title="Compare Hawaii Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Hawaii."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "hawaii_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
