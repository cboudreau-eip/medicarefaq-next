"use client";
/**
 * North Dakota Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/north-dakota/
 * Key differentiators: No birthday rule, Sanford Health Plan dominant local carrier,
 *                      Mutual of Omaha lowest Plan G at $127/mo,
 *                      State Farm A++ with local agents, BCBS ND regional option,
 *                      SHIP free counseling at (888) 575-6611
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/north-dakota-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-4">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="north_dakota_carrier_card"
              triggerId={`nd-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in North Dakota`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of North Dakota.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "north_dakota_carrier_card",
                })
              }
...
export default function NorthDakotaPageContent() {
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 py-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">North Dakota</span>
          </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            North Dakota has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at{" "}
            {STATE_STATS.lowestPlanG} in Fargo and averages {STATE_STATS.avgPlanG} statewide.
            We compared {STATE_STATS.carriers} carriers to find the best coverage in the Peace Garden State.
          </p>
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Users className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> ND residents with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> in Fargo
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                <strong className="text-white">{STATE_STATS.carriers}</strong> carriers licensed in ND
              </span>
            </div>
          </div>
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="north_dakota_hero"
              triggerId="nd-hero-compare"
              coverageType="ms"
              title="Compare North Dakota Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of North Dakota."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare ND Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  phone_number: "(888) 335-8996",
                  page_section: "north_dakota_hero",
                })
              }
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                North Dakota Has No Birthday Rule: Your Initial Plan Choice Matters
              </p>
              <p className="text-sm text-amber-800">
                Unlike California, Oregon, and other states with birthday rules, North Dakota does{" "}
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Sanford Health Plan dominant local carrier</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            North Dakota has over 90,000 residents enrolled in Medicare Supplement Insurance,
          ...
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            North Dakota does not have a birthday rule or anniversary rule, which means your
          ...
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G premiums in Fargo range from $127/mo (Mutual of Omaha) to $218/mo
            (AARP/UHC) for a 65-year-old. Sanford Health Plan is the dominant local carrier in
            North Dakota, offering integrated coverage with the Sanford Health system across
            Fargo, Bismarck, and Grand Forks. State Farm stands out with an A++ AM Best rating
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in North Dakota, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Fargo. Rates in Bismarck,
            Grand Forks, and Minot may vary slightly.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in North Dakota
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Fargo for a 65-year-old female
            nonsmoker. Rates may include available household discounts. North Dakota uses
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                Source: ND Insurance Department, FairSquare Medicare, MoneyGeek, May 2026.
                Rates shown for a 65-year-old female nonsmoker in Fargo.
              </p>
            </div>
          </div>
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="north_dakota_premium_table"
              triggerId="nd-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your North Dakota ZIP Code"
              subtitle="Premiums vary by city in North Dakota. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            Plan G and Plan N are the two most popular Medigap plans for new enrollees in North
            Dakota. Plan G offers more complete coverage; Plan N costs less each month but
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Avg. monthly premium (Fargo)", g: "$127-$145", n: "$93-$110", bold: true },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office visits
                and up to $50 for ER visits that do not result in inpatient admission. North Dakota
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  North Dakota has no birthday rule, so your initial enrollment decision is the
                  most important one you will make.
                </strong>{" "}
                Mutual of Omaha at $127/mo is the lowest Plan G in Fargo and has an A+ AM Best
                rating with a strong track record of rate stability. If you want to stay within
                the Sanford Health system, Sanford Health Plan offers integrated coverage across
                Fargo, Bismarck, and Grand Forks. State Farm at $138/mo is the best pick if you
                want an A++ rating and prefer working with a local agent. BCBS of North Dakota is
                a strong regional option if you value local brand recognition and a large provider
                network. Call ND SHIP at {STATE_STATS.shipPhone} for free, unbiased help.
              </>
            }
          />
        </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                CMS Medicare Plan Finder, ND Insurance Department, FairSquare Medicare
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                The North Dakota SHIP (State Health Insurance Assistance Program) provides free,
                unbiased Medicare counseling. Call{" "}
                <strong>{STATE_STATS.shipPhone}</strong> or visit nd.gov/aging to connect with
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl">
              North Dakota has no birthday rule, so your Open Enrollment Period is your best
              chance to lock in coverage without health questions. Plan G starts at $127/mo in
              Fargo. Compare all available carriers in your area before enrolling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="north_dakota_bottom_cta"
                triggerId="nd-bottom-cta-compare"
                coverageType="ms"
                title="Compare North Dakota Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of North Dakota."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "north_dakota_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
