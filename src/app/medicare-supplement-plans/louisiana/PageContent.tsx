...
/**
 * Louisiana Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/louisiana/
 * Key differentiators: Louisiana birthday rule - annual window to switch without underwriting,
 *                      Plan G from $111/mo in New Orleans, 23+ carriers,
 *                      State Farm A++ rated with strong local agent presence,
 *                      under-65 coverage available by law,
 *                      SHIP free counseling at 1-800-259-5300
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/louisiana-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="louisiana_carrier_card"
              triggerId={`louisiana-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Louisiana`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Louisiana.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "louisiana_carrier_card",
                })
              }
...
/* Main Page Content */
export default function LouisianaPageContent() {
  return (
    <article className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Louisiana</span>
          </div>

          <div className="flex items-center gap-3 mb-4 flex-wrap">
            <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
              <span className="text-2xl font-black text-white">LA</span>
            </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Louisiana has over {STATE_STATS.enrollees} Medigap enrollees - Plan G starts
            at just {STATE_STATS.lowestPlanG} in New Orleans. Louisiana has a{" "}
            <strong className="text-white">birthday rule</strong> that gives enrollees an
            annual window to switch carriers without medical underwriting. We compared{" "}
            {STATE_STATS.carriers} carriers to find the best coverage in the Pelican
            State.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan N from <strong className="text-white">$80/mo</strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="louisiana_hero"
              triggerId="louisiana-hero-compare"
              coverageType="ms"
              title="Compare Louisiana Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Louisiana."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare LA Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
      ...
      {/* Louisiana Birthday Rule Spotlight Banner */}
      <section className="bg-amber-50 border-b border-amber-200">
        <div className="container py-5">
          <div className="flex items-start gap-4 max-w-4xl">
            <div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center shrink-0">
              <Gift className="w-5 h-5 text-amber-700" aria-hidden="true" />
            </div>
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Louisiana Birthday Rule: Switch Medigap Carriers Every Year Without
                Underwriting
              </p>
              <p className="text-sm text-amber-800">
                Louisiana has a Medigap birthday rule that gives policyholders an{" "}
                <strong>annual window around their birthday</strong> to switch to an equal
                or lesser Medigap plan from any carrier - without answering health
                questions. This means you can shop for a lower premium once a year without
                medical underwriting. The birthday rule applies to existing Medigap
                policyholders and allows switching to the{" "}
                <strong>same plan level or lower</strong> (e.g., Plan G to Plan G, or Plan
                G to Plan N). Contact the Louisiana Department of Insurance for the exact
                window length and current rules.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Birthday rule: annual switching window</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Award className="w-4 h-4 text-amber-500" aria-hidden="true" />
              <span>State Farm A++ rated with local agents statewide</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 153,000 Louisianans have Medicare Supplement Insurance, or Medigap.
            Louisiana is home to a diverse Medicare population spanning New Orleans, Baton
            Rouge, Shreveport, and the rural parishes. With over 23 carriers licensed in
            the state and Plan G starting at just $111 per month in New Orleans, Louisiana
            offers competitive Medigap pricing with meaningful consumer protections.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Louisiana has a birthday rule that gives existing Medigap policyholders an
            annual window around their birthday to switch to an equal or lesser plan from
            any carrier without medical underwriting. This is a significant consumer
            protection that makes it easier to shop for better rates annually. Plan G is
            the most popular Medigap plan for new enrollees in Louisiana, covering nearly
            all Medicare out-of-pocket costs except the annual Part B deductible ($283 in
            2026). State Farm stands out in Louisiana with the highest possible AM Best
            rating (A++) and an extensive local agent network, while Louisiana Health
            Service offers the lowest Plan G premium in the New Orleans market at $111/mo.
            Louisiana also requires carriers to make all Medigap plans available to
            Medicare beneficiaries under age 65, including those with disabilities.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Compare the Best Medicare Supplement Plans in Louisiana
          </h2>
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Louisiana, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in New Orleans. Rates in
            Baton Rouge, Shreveport, and rural Louisiana may vary.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Louisiana
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in New Orleans. Rates shown are for
            a 65-year-old female nonsmoker and may include available household discounts.
            Louisiana uses attained-age rating - premiums will increase as you age. Use
            Louisiana&apos;s birthday rule each year to shop for a lower rate. Baton Rouge
            and Shreveport rates may differ slightly.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                <strong>Lowest available in Louisiana (New Orleans):</strong> Plan G from{" "}
                {STATE_STATS.lowestPlanG} | Plan N from $80/mo | Source: Louisiana
                Department of Insurance, FairSquare Medicare, May 2026
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="louisiana_premium_table"
              triggerId="louisiana-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Louisiana ZIP Code"
              subtitle="Premiums vary by city in Louisiana. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            enrollees in Louisiana. Here is how they compare.
          </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    {
                      feature: "Avg. monthly premium (New Orleans)",
                      g: { text: "$111-$152", bold: true },
                      n: { text: "$80-$110", bold: true },
                    },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office
                visits and up to $50 for ER visits that do not result in inpatient
                admission.
              </p>
            </div>
          </div>
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  Louisiana&apos;s birthday rule gives you an annual window to shop for
                  better rates - use it every year.
                </strong>{" "}
                Set a reminder a month before your birthday so you have time to compare
                carriers before the window opens. Mutual of Omaha at $142/mo is the best
                long-term value in Louisiana - A+ rated, U.S.-based customer service, and
                a 7% household discount. State Farm at $126/mo is the best choice if you
                want the highest possible financial strength rating (A++) and prefer
                working with a local agent. Louisiana Health Service at $111/mo is the
                cheapest Plan G in New Orleans, but their complaint ratio runs higher than
                the top-tier carriers. For healthy enrollees focused on minimizing monthly
                costs who plan to use the birthday rule to shop again next year, Louisiana
                Health Service is a reasonable starting point. Also: if you or a spouse
                are both enrolling, always ask about the household discount - it can save
                5% to 7% per month.
              </>
            }
          />
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Louisiana Medigap Rules You Should Know
          </h2>

          <div className="space-y-4">
            {STATE_RULES.map((rule, i) => {
              const icons = [Gift, Info, CalendarDays, Clock, Shield, Award];
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                ratings, CMS Medicare Plan Finder, Louisiana Department of Insurance,
                FairSquare Medicare
              </p>
            </div>
          </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your Louisiana ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              Louisiana&apos;s birthday rule means you can shop for a better rate every
              year. With Plan G starting at $111/mo in New Orleans and over 23 carriers
              licensed in the state, there is real competition to take advantage of. State
              Farm brings the highest financial strength rating in the market. Enter your
              ZIP code to compare rates from all available carriers in your area.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="louisiana_bottom_cta"
                triggerId="louisiana-bottom-cta-compare"
                coverageType="ms"
                title="Compare Louisiana Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Louisiana."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "louisiana_bottom_cta",
                  })
                }
                className="invoca-phone inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
