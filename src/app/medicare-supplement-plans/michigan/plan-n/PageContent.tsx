"use client";
/**
 * Michigan Plan N Rate Comparison Page
 * Route: /medicare-supplement-plans/michigan/plan-n/
...
const PLAN_COMPARISON = [
  ...
  { feature: "Avg. monthly premium (FL)", planG: MI_STATS.averagePlanNPremium, planN: MI_STATS.averagePlanNPremium },
...
const FAQS = [
  {
    q: "What is the cheapest Plan N in Michigan?",
    a: `HealthSpring (Cigna) currently offers the lowest Plan N premium in ${STATE_NAME} at approximately $99 per month for a 65-year-old. However, rates vary by age, gender, zip code, and tobacco use. Comparing quotes from multiple carriers is the best way to find the lowest rate in your area.`,
  },
  {
    q: "Is Plan N worth it in Michigan?",
  ...
  {
    q: "Can I switch from Plan N to Plan N in Michigan?",
  ...
  {
    q: "Can I use Plan N with any doctor in Michigan?",
  ...
  {
    q: "When is the best time to buy Plan N in Michigan?",
    ...
    <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-20">
          ...
          <div className="grid grid-cols-3 gap-4 mb-10 max-w-2xl">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              ...
              <p className="text-2xl md:text-3xl font-bold text-teal-400">{MI_STATS.lowestPlanNPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Average Rate</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{MI_STATS.averagePlanNPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <ZipFormModal
              coverageType="ms"
              pageSection="michigan_plan_n_hero"
              triggerId="mi-plan-n-hero-compare"
            ...
            <a
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "michigan_plan_n_hero" })}
      ...
      <section className="py-8">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="michigan_plan_n_mid"
           triggerId="mi-plan-n-mid-compare"
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mt-10">
            <ZipFormModal
             coverageType="ms"
              pageSection="michigan_plan_n_enroll"
             triggerId="mi-plan-n-enroll-compare"
             buttonLabel="Compare Plan N Rates"
             title={`Compare Plan N Rates in ${STATE_NAME}`}
             subtitle="Enter your ZIP code to see personalized Plan N rates from top carriers in your area."
              trigger={
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="michigan_plan_n_bottom"
           triggerId="mi-plan-n-bottom-compare"
           buttonLabel="Compare Plan N Rates"
           title={`Compare Plan N Rates in ${STATE_NAME}`}
           subtitle="Enter your ZIP code to see personalized Plan N rates from top carriers in your area."
            trigger={
              <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl p-10 md:p-14 text-center cursor-pointer hover:shadow-2xl transition-shadow group border-l-4 border-teal-500">
                ...
                <p className="text-blue-300 text-sm mt-4">
                  ...
                  <a
                    href="tel:+18884410465"
                    onClick={(e) => { e.stopPropagation(); trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "michigan_plan_n_bottom" }); }}
