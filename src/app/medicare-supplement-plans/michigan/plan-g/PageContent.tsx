"use client";
/**
 * Michigan Plan G Rate Comparison Page
 * Route: /medicare-supplement-plans/michigan/plan-g/
...
import { MI_CARRIERS, MI_STATS, type MICarrier } from "@/lib/michigan-medigap-data";
...
const carriersByPlanG = [...MI_CARRIERS].sort((a, b) => {
...
const PLAN_COMPARISON = [
  ...
  { feature: "Avg. monthly premium (FL)", planG: MI_STATS.averagePlanGPremium, planN: MI_STATS.averagePlanNPremium },
...
const FAQS = [
  {
    q: "What is the cheapest Plan G in Michigan?",
    a: `HealthSpring (Cigna) currently offers the lowest Plan G premium in ${STATE_NAME} at approximately $99 per month for a 65-year-old. However, rates vary by age, gender, zip code, and tobacco use. Comparing quotes from multiple carriers is the best way to find the lowest rate in your area.`,
  },
  {
    q: "Is Plan G worth it in Michigan?",
  ...
  {
    q: "Can I switch from Plan N to Plan G in Michigan?",
  ...
  {
    q: "Can I use Plan G with any doctor in Michigan?",
  ...
  {
    q: "When is the best time to buy Plan G in Michigan?",
  ...
  {
    q: "What happens if I miss my Medigap open enrollment in Michigan?",
  ...
  {
    q: "Is there a birthday rule in Michigan?",
...
export default function MichiganPlanGContent() {
    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-20">
          ...
          <nav className="flex items-center gap-2 text-sm text-blue-200 mb-8" aria-label="Breadcrumb">
            ...
            <span className="text-blue-400">&gt;</span>
            <Link href="/medicare-supplement-plans/michigan" className="hover:text-white transition-colors">{STATE_NAME}</Link>
            <span className="text-blue-400">&gt;</span>
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-3xl">
            ...
            Compare rates from {MI_STATS.numberOfCarriers} carriers in {STATE_NAME} to find the lowest premium.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 mb-10 max-w-2xl">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              ...
              <p className="text-2xl md:text-3xl font-bold text-teal-400">{MI_STATS.lowestPlanGPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Average Rate</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{MI_STATS.averagePlanGPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Carriers</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{MI_STATS.numberOfCarriers}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <ZipFormModal
              coverageType="ms"
              pageSection="michigan_plan_g_hero"
              triggerId="mi-plan-g-hero-compare"
            ...
            <a
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "michigan_plan_g_hero" })}
      ...
      <section className="py-8">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="michigan_plan_g_mid"
           triggerId="mi-plan-g-mid-compare"
      ...
      {/* ─── SECTION 6: Michigan-Specific Rules ─── */}
      <section className="py-16 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4">
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mt-10">
            <ZipFormModal
             coverageType="ms"
              pageSection="michigan_plan_g_enroll"
             triggerId="mi-plan-g-enroll-compare"
             buttonLabel="Compare Plan G Rates"
             title={`Compare Plan G Rates in ${STATE_NAME}`}
             subtitle="Enter your ZIP code to see personalized Plan G rates from top carriers in your area."
              trigger={
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="michigan_plan_g_bottom"
           triggerId="mi-plan-g-bottom-compare"
           buttonLabel="Compare Plan G Rates"
           title={`Compare Plan G Rates in ${STATE_NAME}`}
           subtitle="Enter your ZIP code to see personalized Plan G rates from top carriers in your area."
            trigger={
              <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl p-10 md:p-14 text-center cursor-pointer hover:shadow-2xl transition-shadow group border-l-4 border-teal-500">
                ...
                <p className="text-blue-200 mb-8 max-w-xl mx-auto">
                  ...
                  Compare rates from {MI_STATS.numberOfCarriers} carriers in {STATE_NAME} to make sure you are not overpaying.
                </p>
                ...
                <p className="text-blue-300 text-sm mt-4">
                  ...
                  <a
                    href="tel:+18884410465"
                    onClick={(e) => { e.stopPropagation(); trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "michigan_plan_g_bottom" }); }}
      ...
      <section className="py-12 bg-slate-50 border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/medicare-supplement-plans/michigan" className="inline-flex items-center gap-1.5 text-sm text-blue-700 hover:text-blue-900 bg-white px-4 py-2 rounded-lg border border-slate-200 hover:border-blue-300 transition-colors">
