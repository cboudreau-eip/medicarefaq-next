...
export default function WyomingPageContentPage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Best Medicare Supplement Plans in Wyoming (2026) | MedicareFAQ",
    description: "Compare the best Medicare Supplement (Medigap) plans in Wyoming for 2026.",
    url: "https://www.medicarefaq.com/medicare-supplement-plans/wyoming/",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Wyoming" },
    ],
  };
