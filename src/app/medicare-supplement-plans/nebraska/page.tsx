...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.medicarefaq.com/medicare-supplement-plans/nebraska/",
  },
  openGraph: {
    title: "Best Medicare Supplement Plans in Nebraska 2026 | MedicareFAQ",
    description:
      "Compare the best Medicare Supplement plans in Nebraska for 2026. See Plan G rates from top carriers, state-specific rules, and get free quotes.",
    url: "https://www.medicarefaq.com/medicare-supplement-plans/nebraska/",
...
export default function NebraskaPage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Best Medicare Supplement Plans in Nebraska 2026 | MedicareFAQ",
    description: "Compare the best Medicare Supplement plans in Nebraska for 2026. See Plan G rates from top carriers, state-specific rules, and get free quotes.",
    url: "https://www.medicarefaq.com/medicare-supplement-plans/nebraska/",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Nebraska" },
    ],
  };
