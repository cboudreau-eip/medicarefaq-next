"use client";
/**
 * Nebraska Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/nebraska/
 * Key differentiators: No birthday rule, Plan G from $152/mo (MedMutual Protect, A+),
 *                      USAA A++ military lowest Plan G at $156/mo,
 *                      Transamerica all 10 plans + issue-age, Philadelphia American best Plans C/D/M,
 *                      SHIP free counseling at (800) 234-7119
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/nebraska-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="nebraska_carrier_card"
              triggerId={`nebraska-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Nebraska`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Nebraska.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "nebraska_carrier_card",
                })
              }
...
export default function NebraskaPageContent() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Nebraska</span>
          </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Nebraska has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at{" "}
            {STATE_STATS.lowestPlanG} in Omaha and averages {STATE_STATS.avgPlanG} statewide.
            We compared {STATE_STATS.carriers} carriers to find the best coverage in the Cornhusker State.
          </p>
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Users className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> Nebraskans with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="nebraska_hero"
              triggerId="nebraska-hero-compare"
              coverageType="ms"
              title="Compare Nebraska Medigap Rates"
              subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Nebraska."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare NE Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Nebraska Has No Birthday Rule: Your Initial Plan Choice Matters
              </p>
              <p className="text-sm text-amber-800">
                Unlike California, Oregon, and other states with birthday rules, Nebraska does{" "}
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>USAA A++ rated in Nebraska (military)</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 290,000 Nebraskans have Medicare Supplement Insurance, also called Medigap.
            Nebraska follows standard federal Medigap rules, offering plans A through N with no
          ...
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            Nebraska does not have a birthday rule or anniversary rule, which means your 6-month
          ...
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G premiums in Omaha range from $152/mo (MedMutual Protect, A+) to $235/mo
            (Mutual of Omaha) for a 65-year-old. MedMutual Protect is the clear price leader at
            27% below the state average. USAA ties for the second-lowest Plan G at $156/mo with
            an A++ rating, but is only available to military members and veterans. For all 10 plan
            types with issue-age pricing, Transamerica at $183/mo is the top pick.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Best Medicare Supplement Companies in Nebraska
          </h2>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Nebraska
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Omaha for a 65-year-old female
            nonsmoker. Rates may include available household discounts. Nebraska uses attained-age
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *USAA is only available to military members, veterans, and eligible family members.
                Lowest Plan G for the general public: $152/mo (MedMutual Protect).
                Source: Nebraska DOI, FairSquare Medicare, MoneyGeek, May 2026.
              </p>
            </div>
          </div>
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="nebraska_premium_table"
              triggerId="nebraska-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Nebraska ZIP Code"
              subtitle="Premiums vary by city in Nebraska. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            in Nebraska. Here is how they compare.
          </p>
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Avg. monthly premium (Omaha)", g: "$152-$183", n: "$117-$120", bold: true },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office visits
                and up to $50 for ER visits that do not result in inpatient admission. Nebraska
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  Nebraska has no birthday rule, so your initial enrollment decision is the most
                  important one you will make.
                </strong>{" "}
                MedMutual Protect at $152/mo is the best overall value in Nebraska: A+ rated,
                lowest Plan G and Plan N in the state, and strong claims-paying history. If you or
                your spouse served in the military, USAA at $156/mo with an A++ rating is the
                clear winner. For all 10 plan types with issue-age pricing that locks your rate at
                enrollment, Transamerica at $183/mo is the top pick for long-term rate stability.
                Do not just chase the lowest premium today. Attained-age pricing means rates will
                increase every year as you age.
              </>
            }
          />
        </div>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Nebraska Medigap Rules You Should Know
          </h2>
          <div className="space-y-4">
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                CMS Medicare Plan Finder, Nebraska Department of Insurance, FairSquare Medicare
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your Nebraska ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              Nebraska has no birthday rule, so your Open Enrollment Period is your best chance to
              lock in coverage without health questions. Plan G starts at $152/mo in Omaha.
              Compare all available carriers in your area before enrolling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="nebraska_bottom_cta"
                triggerId="nebraska-bottom-cta-compare"
                coverageType="ms"
                title="Compare Nebraska Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Nebraska."
                buttonLabel="Compare Plans"
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "nebraska_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
