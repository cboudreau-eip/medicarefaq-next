 ...
 * Route: /medicare-supplement-plans/medigap-by-carrier/[carrierSlug]
        ...
        <div className="container max-w-4xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {carrier.relatedCarriers.map((relSlug) => {
                  ...
                  return (
                    <Link
                      key={relSlug}
                      href={`/medicare-supplement-plans/medigap-by-carrier/${relSlug}`}
          ...
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "medigap_carrier_detail" })} className="invoca-phone inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
