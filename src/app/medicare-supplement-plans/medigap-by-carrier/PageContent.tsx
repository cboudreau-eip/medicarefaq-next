 ...
 * Route: /medicare-supplement-plans/medigap-by-carrier
 */
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "medigap_by_carrier" })} className="invoca-phone inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              {topCarriers.map((carrier) => {
                ...
                return (
                  <Link
                    key={carrier.slug}
                    href={`/medicare-supplement-plans/medigap-by-carrier/${carrier.slug}`}
