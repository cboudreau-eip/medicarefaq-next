"use client";
/**
 * Rhode Island Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/rhode-island/
 * Key differentiators: No birthday rule, community rating NOT required (attained-age dominates),
 *                      USAA lowest Plan G at $148/mo (military only), Humana lowest Plans B/C/F,
 *                      AFLAC lowest Plan N at $123/mo, Transamerica all 10 plan types + issue-age,
 *                      SHIP free counseling at (888) 884-8721
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/rhode-island-medigap-data";
...
export default function RhodeIslandPageContent() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Rhode Island</span>
          </div>
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
              <span className="text-2xl font-black text-white">RI</span>
            </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Rhode Island has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at{" "}
            {STATE_STATS.lowestPlanG} in Providence and averages {STATE_STATS.avgPlanG} statewide.
            We compared {STATE_STATS.carriers} carriers to find the best coverage in the Ocean State.
          </p>
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Users className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> Rhode Islanders with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> in Providence
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <TrendingDown className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                Plan N from <strong className="text-white">$123/mo</strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Award className="w-4 h-4 text-amber-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.carriers}</strong> carriers licensed in Rhode Island
              </span>
            </div>
          </div>
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="rhode_island_hero"
              triggerId="rhode-island-hero-compare"
              coverageType="ms"
              title="Compare Rhode Island Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Rhode Island."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare RI Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  phone_number: "(888) 335-8996",
                  page_section: "rhode_island_hero",
                })
              }
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Rhode Island Has No Birthday Rule: Your Initial Plan Choice Matters
              </p>
              <p className="text-sm text-amber-800">
                Unlike California, Oregon, and other states with birthday rules, Rhode Island does{" "}
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>USAA A++ rated, lowest Plan G in Rhode Island</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 60,000 Rhode Islanders have Medicare Supplement Insurance, also called
            Medigap. Rhode Island follows standard federal Medigap rules, offering plans A through
            N with no state-specific modifications. Plan G is the most popular choice for new
            enrollees, covering nearly all Medicare out-of-pocket costs except the annual Part B
            deductible ($257 in 2026).
          </p>
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            USAA offers the lowest Plan G in Rhode Island at $148/mo (military members and families
            only). For civilians, Humana offers Plan G at $167/mo and the lowest Plans B, C, and F
            in the state. AFLAC offers the lowest Plan N at $123/mo. Transamerica is the only
            carrier offering all 10 standardized plan types with issue-age pricing.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Rhode Island has no birthday rule, so your initial Open Enrollment Period is your most
            important enrollment window. Use it to compare carriers carefully and choose a plan
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Rhode Island, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Providence. Rates in
            Warwick, Cranston, and other cities may vary slightly.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Rhode Island
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Providence for a 65-year-old female
            nonsmoker. Rates may include available household discounts. Rhode Island uses
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *USAA is only available to military members, veterans, and eligible family members.
                Lowest Plan G for the general public: $167/mo (Humana).
                Source: Rhode Island DBR, FairSquare Medicare, MoneyGeek, May 2026.
              </p>
            </div>
          </div>
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="rhode_island_premium_table"
              triggerId="rhode-island-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Rhode Island ZIP Code"
              subtitle="Premiums vary by city in Rhode Island. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            in Rhode Island. Here is how they compare.
          </p>
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Avg. monthly premium (Providence)", g: "$167-$192", n: "$123-$135", bold: true },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office visits
                and up to $50 for ER visits that do not result in inpatient admission. Rhode Island
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  Rhode Island has no birthday rule, so your initial enrollment decision is the
                  most important one you will make.
                </strong>{" "}
                If you have a military background, USAA at $148/mo with an A++ rating is the
                clear winner. For civilians, Humana at $167/mo offers the best value: competitive
                Plan G, the lowest Plans B, C, and F in the state, and an A financial strength
                rating. If you want the lowest Plan N, AFLAC at $123/mo is the top pick. For
                long-term rate stability, Transamerica&apos;s issue-age pricing locks in your
                rate at enrollment. Compare all carriers during your 6-month Open Enrollment
                Period and choose a plan you can keep for the long haul.
              </>
            }
          />
        </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                CMS Medicare Plan Finder, Rhode Island DBR, FairSquare Medicare
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl">
              Rhode Island has no birthday rule, so your Open Enrollment Period is your best
              chance to lock in coverage without health questions. Plan G starts at $148/mo for
              military members and $167/mo for civilians in Providence. Compare all available
              carriers before enrolling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="rhode_island_bottom_cta"
                triggerId="rhode-island-bottom-cta-compare"
                coverageType="ms"
                title="Compare Rhode Island Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Rhode Island."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "rhode_island_bottom_cta",
                  })
                }
                className="invoca-phone inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
