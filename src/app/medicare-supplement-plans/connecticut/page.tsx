...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.medicarefaq.com/medicare-supplement-plans/connecticut/",
  },
  openGraph: {
    title: "Best Medicare Supplement Plans in Connecticut 2026 | MedicareFAQ",
    description:
    ...
    url: "https://www.medicarefaq.com/medicare-supplement-plans/connecticut/",
    type: "website",
  },
};
...
export default function ConnecticutPage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Best Medicare Supplement Plans in Connecticut 2026 | MedicareFAQ",
    description: "Compare the best Medicare Supplement plans in Connecticut for 2026. Guaranteed issue year-round, community rating, no medical underwriting. Plan G from $248/mo. Free quotes.",
    url: "https://www.medicarefaq.com/medicare-supplement-plans/connecticut/",
