...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.medicarefaq.com/medicare-supplement-plans/texas/",
  },
  openGraph: {
    title: "Best Medicare Supplement Plans in Texas 2026 | MedicareFAQ",
    description:
      "Compare the best Medicare Supplement (Medigap) plans in Texas for 2026. See carrier ratings, Plan G and Plan N premiums from top carriers, and find the right coverage for Texas seniors.",
    url: "https://www.medicarefaq.com/medicare-supplement-plans/texas/",
    type: "article",
    images: [
      {
...
export default function Page() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Best Medicare Supplement Plans in Texas 2026 | MedicareFAQ",
    description: "Compare the best Medicare Supplement (Medigap) plans in Texas for 2026. See carrier ratings, Plan G and Plan N premiums from top carriers, and find the right coverage for Texas seniors.",
    url: "https://www.medicarefaq.com/medicare-supplement-plans/texas/",
