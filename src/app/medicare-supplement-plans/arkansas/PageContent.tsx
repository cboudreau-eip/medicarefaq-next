...
/**
 * Arkansas Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/arkansas/
 * Key differentiators: Community pricing (all carriers), no birthday rule,
 *                      Plan G from $118/mo (Aetna) or $168/mo (MedMutual/Wellcare),
 *                      Arkansas Blue Cross Medi-Pak local carrier,
 *                      QualChoice Life lowest Plan K at $92/mo,
 *                      SHIP free counseling at 1-800-224-6330
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/arkansas-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="arkansas_carrier_card"
              triggerId={`arkansas-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Arkansas`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Arkansas.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "arkansas_carrier_card",
                })
              }
...
export default function ArkansasPageContent() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Arkansas</span>
          </div>

          <div className="flex items-center gap-3 mb-4 flex-wrap">
            <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
              <span className="text-2xl font-black text-white">AR</span>
            </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Arkansas uses community pricing for all Medigap plans, meaning your premium is the same
            whether you are 65 or 85. Plan G starts at {STATE_STATS.lowestPlanG} and averages{" "}
            {STATE_STATS.avgPlanG} statewide. We ranked {STATE_STATS.carriers} carriers to find the
            best value in the Natural State.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> Arkansans with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> (Aetna)
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <TrendingDown className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                Plan N from <strong className="text-white">$111/mo</strong> (Aetna)
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Award className="w-4 h-4 text-amber-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.carriers}</strong> carriers licensed in Arkansas
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="arkansas_hero"
              triggerId="arkansas-hero-compare"
              coverageType="ms"
              title="Compare Arkansas Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Arkansas."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare AR Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-blue-900 text-base mb-1">
                Arkansas Uses Community Pricing: Your Age Does Not Affect Your Premium
              </p>
              <p className="text-sm text-blue-800">
                All major Medigap carriers in Arkansas use community pricing, meaning a 65-year-old
                and an 85-year-old pay the same monthly rate for the same plan. Premiums can still
                increase over time due to inflation and claims experience, but your age alone will
                never drive an increase. This is a significant advantage for Arkansas seniors who
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Community pricing: same rate at any age</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Award className="w-4 h-4 text-amber-500" aria-hidden="true" />
              <span>State Farm A++ rated in Arkansas</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            Arkansas has over {STATE_STATS.enrollees} seniors enrolled in Medicare Supplement
            plans, and all major carriers use community pricing. That means your monthly premium is
            the same whether you enroll at 65 or 80, which is a meaningful advantage for seniors
            who delay enrollment or switch plans later in life.
          </p>
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            Plan G is the most popular choice for new enrollees, covering nearly all Medicare
            out-of-pocket costs except the annual Part B deductible ($283 in 2026). The lowest Plan
            G in Arkansas is $118/mo from Aetna, though MedMutual Protect and Wellcare both offer
            $168/mo with stronger financial ratings. Arkansas Blue Cross and Blue Shield offers
            Medi-Pak, the dominant local brand, at around $205/mo in Little Rock.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Arkansas does not have a birthday rule, so your 6-month Open Enrollment Period when you
            first turn 65 and enroll in Part B is your most important enrollment window. After that,
            carriers can use medical underwriting to deny your application or charge higher premiums.
            Compare carefully before you enroll.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Compare the Best Medicare Supplement Plans in Arkansas
          </h2>
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Arkansas, ranked by the MedicareFAQ Score. Premiums
            shown are for a 65-year-old in Little Rock. Because Arkansas uses community pricing,
            these rates apply regardless of age.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Arkansas
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Little Rock. All carriers use community
            pricing in Arkansas, so these rates apply at any age. Rates effective May 2026.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                All carriers use community pricing in Arkansas: rates are the same regardless of age.
                Source: MoneyGeek, Arkansas Insurance Department, May 2026.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="arkansas_premium_table"
              triggerId="arkansas-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Arkansas ZIP Code"
              subtitle="Enter your ZIP code to see exact rates from all available carriers in your area of Arkansas."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            in Arkansas. Here is how they compare.
          </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Avg. monthly premium (Little Rock)", g: "$168-$224", n: "$111-$175", bold: true },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office visits
                and up to $50 for ER visits that do not result in inpatient admission. Arkansas
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  In Arkansas, all carriers use community pricing, so your premium will not
                  increase just because you get older. That shifts the decision entirely to financial
                  strength and price.
                </strong>{" "}
                For the best combination of low premium and strong rating, MedMutual Protect at
                $168/mo with an A AM Best rating is the top pick. If you want the absolute lowest
                premium and are comfortable with a lower-rated carrier, Aetna Plan G at $118/mo is
                hard to beat. For the highest financial strength with a local agent network, State
                Farm at $174/mo and A++ rated is the right call. Avoid Wellcare despite their low
                price: their AM Best B rating is below what most advisors recommend for a plan you
                may hold for 20 or 30 years.
              </>
            }
          />
        </div>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Arkansas Medigap Rules You Should Know
          </h2>

          <div className="space-y-4">
            {STATE_RULES.map((rule, i) => {
              const icons = [AlertTriangle, Info, Clock, Info, Shield, Building2, Users];
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                CMS Medicare Plan Finder, Arkansas Insurance Department, MoneyGeek
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your Arkansas ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              All carriers in Arkansas use community pricing, so your age will never drive a premium
              increase. Plan G starts at $118/mo in Little Rock. Compare all available carriers
              before enrolling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="arkansas_bottom_cta"
                triggerId="arkansas-bottom-cta-compare"
                coverageType="ms"
                title="Compare Arkansas Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Arkansas."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "arkansas_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
