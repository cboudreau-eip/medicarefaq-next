"use client";
/**
 * New Mexico Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/new-mexico/
 * Key differentiators: No birthday rule, birthday rule bill pending (HB 90 2025),
 *                      LifeShield National lowest Plan G at $138/mo,
 *                      State Farm A++ with local agents, Presbyterian Health Plan regional option,
 *                      SHIP free counseling at (800) 432-2080
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/new-mexico-medigap-data";
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-xs font-semibold text-teal-700 bg-teal-50 border border-teal-200 px-2 py-1 rounded-full">
                {carrier.badge}
              </span>
            </div>
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="new_mexico_carrier_card"
              triggerId={`nm-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in New Mexico`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of New Mexico.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "new_mexico_carrier_card",
                })
              }
...
export default function NewMexicoPageContent() {
  return (
    <div className="bg-white">
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 py-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">New Mexico</span>
          </div>
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
              <span className="text-2xl font-black text-white">NM</span>
            </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            New Mexico has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at{" "}
            {STATE_STATS.lowestPlanG} in Albuquerque and averages {STATE_STATS.avgPlanG} statewide.
            We compared {STATE_STATS.carriers} carriers to find the best coverage in the Land of Enchantment.
          </p>
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Users className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> NM residents with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> in Albuquerque
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                <strong className="text-white">{STATE_STATS.carriers}</strong> carriers licensed in NM
              </span>
            </div>
          </div>
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="new_mexico_hero"
              triggerId="nm-hero-compare"
              coverageType="ms"
              title="Compare New Mexico Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of New Mexico."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare NM Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                New Mexico Has No Birthday Rule: Your Initial Plan Choice Matters
              </p>
              <p className="text-sm text-amber-800">
                New Mexico does <strong>not</strong> currently have a birthday rule, though
                legislation (HB 90) was introduced in 2025 and may be reconsidered. Until a
                birthday rule is signed into law, your 6-month Open Enrollment Period when you
                first turn 65 and enroll in Part B is your best opportunity to lock in coverage
                without health questions. After that window closes, carriers can use medical
                underwriting to deny your application or charge higher premiums.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>No birthday rule yet: initial enrollment is critical</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Award className="w-4 h-4 text-amber-500" aria-hidden="true" />
              <span>State Farm A++ rated in New Mexico</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            New Mexico has over 115,000 residents enrolled in Medicare Supplement Insurance,
            also called Medigap. The state follows standard federal Medigap rules, offering plans
            A through N with no state-specific modifications. Plan G is the most popular choice
            for new enrollees, covering nearly all Medicare out-of-pocket costs except the annual
            Part B deductible ($283 in 2026).
          </p>
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            New Mexico does not currently have a birthday rule, which means your 6-month Open
            Enrollment Period when you first turn 65 and enroll in Part B is your best and most
            important opportunity to lock in coverage. After that window closes, carriers can use
            medical underwriting to deny your application or charge higher premiums based on your
            health history. Legislation to add a birthday rule was introduced in 2025 but did not
            pass; watch for updates in future legislative sessions.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G premiums in Albuquerque range from $138/mo (LifeShield National) to $244/mo
            (AARP/UHC) for a 65-year-old. LifeShield National and Mutual of Omaha are the top
            picks for most New Mexico seniors. State Farm stands out with an A++ AM Best rating
            and a local agent network across Albuquerque, Santa Fe, and Las Cruces.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Compare the Best Medicare Supplement Plans in New Mexico
          </h2>
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in New Mexico, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Albuquerque. Rates in
            Santa Fe, Las Cruces, and Rio Rancho may vary slightly.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in New Mexico
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Albuquerque for a 65-year-old female
            nonsmoker. Rates may include available household discounts. New Mexico uses
            attained-age rating for most carriers, so premiums will increase as you age.
          </p>
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                Source: NM Office of Superintendent of Insurance, FairSquare Medicare, MoneyGeek, May 2026.
                Rates shown for a 65-year-old female nonsmoker in Albuquerque.
              </p>
            </div>
          </div>
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="new_mexico_premium_table"
              triggerId="nm-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your New Mexico ZIP Code"
              subtitle="Premiums vary by city in New Mexico. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            Plan G and Plan N are the two most popular Medigap plans for new enrollees in New
            Mexico. Plan G offers more complete coverage; Plan N costs less each month but
            includes small copays.
          </p>
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Avg. monthly premium (Albuquerque)", g: "$138-$155", n: "$100-$115", bold: true },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office visits
                and up to $50 for ER visits that do not result in inpatient admission. New Mexico
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  New Mexico has no birthday rule yet, so your initial enrollment decision is the
                  most important one you will make.
                </strong>{" "}
                LifeShield National at $138/mo is the lowest Plan G in Albuquerque, but it is a
                smaller carrier with fewer local resources. Mutual of Omaha at $145/mo offers a
                better balance of price, A+ rating, and low complaint ratio. State Farm at $152/mo
                is the best pick if you want an A++ rating and prefer working with a local agent
                in Albuquerque, Santa Fe, or Las Cruces. If New Mexico passes a birthday rule in
                a future legislative session, you will gain an annual window to switch. Until then,
                compare carefully at 65. Call NM SHIP at {STATE_STATS.shipPhone} for free help.
              </>
            }
          />
        </div>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            New Mexico Medigap Rules You Should Know
          </h2>
          <div className="space-y-4">
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                CMS Medicare Plan Finder, NM Office of Superintendent of Insurance, FairSquare Medicare
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                The New Mexico SHIP (State Health Insurance Assistance Program) provides free,
                unbiased Medicare counseling. Call{" "}
                <strong>{STATE_STATS.shipPhone}</strong> or visit osi.state.nm.us to connect with
                a counselor in your area. SHIP counselors can help you compare plans, understand
                your enrollment rights, and navigate the Medicare system at no cost.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your New Mexico ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              New Mexico has no birthday rule, so your Open Enrollment Period is your best chance
              to lock in coverage without health questions. Plan G starts at $138/mo in
              Albuquerque. Compare all available carriers in your area before enrolling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="new_mexico_bottom_cta"
                triggerId="nm-bottom-cta-compare"
                coverageType="ms"
                title="Compare New Mexico Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of New Mexico."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "new_mexico_bottom_cta",
                  })
                }
                className="invoca-phone inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
