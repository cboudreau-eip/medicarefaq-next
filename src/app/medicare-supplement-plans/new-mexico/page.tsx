...
export default function Page() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Best Medicare Supplement Plans in New Mexico 2026 | MedicareFAQ",
    description: "Compare the best Medicare Supplement plans in New Mexico for 2026. See top-rated carriers, Plan G and Plan N rates, and state-specific rules.",
    url: "https://www.medicarefaq.com/medicare-supplement-plans/new-mexico/",
