...
/**
 * Tennessee Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/tennessee/
 * Key differentiators: 280,000+ Medigap enrollees, Plan G from $87/mo in Nashville,
 *                      no birthday/anniversary rule, OEP is only guaranteed-issue window,
 *                      Humana SilverSneakers strong in TN, Nashville is healthcare capital,
 *                      TN SHIP free counseling, very competitive premiums in Southeast
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/tennessee-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="tennessee_carrier_card"
              triggerId={`tennessee-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Tennessee`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Tennessee.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "tennessee_carrier_card",
                })
              }
...
/* Main Page Content */
export default function TennesseePageContent() {
  return (
    <article className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Tennessee</span>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            ...
            <span className="text-xs font-bold px-3 py-1 rounded-full border bg-emerald-100 text-emerald-800 border-emerald-200">
              Competitive Southeast Premiums
            </span>
          </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Tennessee has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at
            just {STATE_STATS.lowestPlanG} in Nashville. We compared{" "}
            {STATE_STATS.carriers} carriers to find the best coverage for the Volunteer
            State.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan N from <strong className="text-white">$58/mo</strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="tennessee_hero"
              triggerId="tennessee-hero-compare"
              coverageType="ms"
              title="Compare Tennessee Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Tennessee."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare TN Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
      ...
      {/* Competitive Premiums Spotlight Banner */}
      <section className="bg-emerald-50 border-b border-emerald-200">
        <div className="container py-5">
          <div className="flex items-start gap-4 max-w-4xl">
            <div className="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center shrink-0">
              <DollarSign className="w-5 h-5 text-emerald-700" aria-hidden="true" />
            </div>
            <div>
              <p className="font-bold text-emerald-900 text-base mb-1">
                Tennessee Has Some of the Most Competitive Medigap Premiums in the Southeast
              </p>
              <p className="text-sm text-emerald-800">
                With Plan G starting at just <strong>$87/mo</strong> in Nashville and over{" "}
                <strong>25 carriers</strong> competing for your business, Tennessee offers
                outstanding value for Medicare Supplement insurance. Nashville is also the
                headquarters of HCA Healthcare and Cigna, making it one of the most
                competitive healthcare markets in the country. Your 6-month Open Enrollment
                Period at age 65 is the best time to lock in these rates without medical
                underwriting.
              </p>
            </div>
          </div>
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Plan G from {STATE_STATS.lowestPlanG} in Nashville</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Award className="w-4 h-4 text-amber-500" aria-hidden="true" />
              <span>Mutual of Omaha rated #1 overall in Tennessee</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 280,000 people in Tennessee have Medicare Supplement Insurance, or
            Medigap. Tennessee is home to some of the most competitive Medigap premiums in
            the Southeast, with Plan G starting at just $87 per month in Nashville for a
            65-year-old female nonsmoker. Nashville is the headquarters of HCA Healthcare
            and Cigna, making it one of the most competitive healthcare markets in the
            country. Memphis, Knoxville, and Chattanooga also offer strong carrier
            competition and low premiums.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G is the most popular Medicare Supplement plan for new enrollees in
            Tennessee, chosen by about 47% of Medigap enrollees. It covers nearly all
            Medicare out-of-pocket costs except the annual Part B deductible ($257 in
            2026). Tennessee uses attained-age rating, meaning premiums increase as you
            age, so enrolling during your 6-month Open Enrollment Period at age 65 is the
            best way to lock in the lowest possible rate. Unlike California, Missouri, or
            Virginia, Tennessee has no birthday rule or anniversary rule. Your OEP is your
            primary guaranteed-issue window.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Compare the Best Medicare Supplement Plans in Tennessee
          </h2>
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Tennessee, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Nashville. Rates in
            Memphis, Knoxville, Chattanooga, and other regions may vary.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Tennessee
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Nashville. Rates shown are for a
            65-year-old female nonsmoker and may include available household discounts.
            Tennessee uses attained-age rating, so premiums will increase as you age.
            Memphis, Knoxville, and Chattanooga rates may differ slightly.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                <strong>Lowest available in Tennessee (Nashville):</strong> Plan G from{" "}
                {STATE_STATS.lowestPlanG} | Plan N from $58/mo | Source: FairSquare
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="tennessee_premium_table"
              triggerId="tennessee-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Tennessee ZIP Code"
              subtitle="Premiums vary by city in Tennessee. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            enrollees in Tennessee. Here is how they compare.
          </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    {
                      feature: "Avg. monthly premium (Nashville)",
                      g: { text: "$96-$128", bold: true },
                      n: { text: "$65-$89", bold: true },
                    },
                  ].map((row, i) => (
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  In Tennessee, Physicians Select is cheapest at $87/mo, but it is a
                  lesser-known carrier. Among nationally-recognized options, Cigna at
                  $96/mo is the best value.
                </strong>{" "}
                Cigna has a slightly elevated complaint ratio, so if customer service
                matters to you, Mutual of Omaha at $121/mo has one of the best complaint
                records in the state. Humana is also worth a look if you want SilverSneakers
                fitness benefits included. Tennessee has no birthday rule, so your 6-month
                Open Enrollment Period at age 65 is your best chance to enroll without
                medical underwriting. Do not wait.
              </>
            }
          />
        </div>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Tennessee Medigap Rules You Should Know
          </h2>

          <div className="space-y-4">
            {STATE_RULES.map((rule, i) => {
              const icons = [Clock, AlertTriangle, Info, Shield, Award, Info];
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                ratings, CMS Medicare Plan Finder, FairSquare Medicare
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your Tennessee ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              Tennessee has a competitive Medigap market with over 25 carriers and Plan G
              starting at just $87/mo in Nashville. Enter your ZIP code to see exact rates
              from all available carriers in your area. Your Open Enrollment Period at 65
              is the best time to lock in coverage without medical underwriting.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="tennessee_bottom_cta"
                triggerId="tennessee-bottom-cta-compare"
                coverageType="ms"
                title="Compare Tennessee Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Tennessee."
                buttonLabel="Compare Plans"
                trigger={
                  <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                    Compare TN Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "tennessee_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
