"use client";
/**
 * North Carolina Plan N Rate Comparison Page
 * Route: /medicare-supplement-plans/north-carolina/plan-n/
...
const PLAN_COMPARISON = [
  ...
  { feature: "Avg. monthly premium (FL)", planG: NC_STATS.averagePlanNPremium, planN: NC_STATS.averagePlanNPremium },
...
const FAQS = [
  {
    q: "What is the cheapest Plan N in North Carolina?",
    a: `Wellabe currently offers the lowest Plan N premium in ${STATE_NAME} at approximately $113 per month for a 65-year-old. However, rates vary by age, gender, zip code, and tobacco use. Comparing quotes from multiple carriers is the best way to find the lowest rate in your area.`,
  },
  {
    q: "Is Plan N worth it in North Carolina?",
  ...
  {
    q: "Can I switch from Plan N to Plan N in North Carolina?",
  ...
  {
    q: "Can I use Plan N with any doctor in North Carolina?",
  ...
  {
    q: "When is the best time to buy Plan N in North Carolina?",
  ...
  {
    q: "What happens if I miss my Medigap open enrollment in North Carolina?",
  ...
  {
    q: "Is there a birthday rule in North Carolina?",
...
export default function NorthCarolinaPlanGContent() {
    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-20">
          ...
          <nav className="flex items-center gap-2 text-sm text-blue-200 mb-8" aria-label="Breadcrumb">
            ...
            <span className="text-blue-400">&gt;</span>
            <Link href="/medicare-supplement-plans/north-carolina" className="hover:text-white transition-colors">{STATE_NAME}</Link>
            <span className="text-blue-400">&gt;</span>
          ...
          <div className="grid grid-cols-3 gap-4 mb-10 max-w-2xl">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              ...
              <p className="text-2xl md:text-3xl font-bold text-teal-400">{NC_STATS.lowestPlanNPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Average Rate</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{NC_STATS.averagePlanNPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <ZipFormModal
              coverageType="ms"
              pageSection="north_carolina_plan_n_hero"
              triggerId="nc-plan-n-hero-compare"
            ...
            <a
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "north_carolina_plan_n_hero" })}
      ...
      <section className="py-8">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="north_carolina_plan_n_mid"
           triggerId="nc-plan-n-mid-compare"
      ...
      {/* ─── SECTION 6: North Carolina-Specific Rules ─── */}
      <section className="py-16 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4">
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mt-10">
            <ZipFormModal
             coverageType="ms"
              pageSection="north_carolina_plan_n_enroll"
             triggerId="nc-plan-n-enroll-compare"
             buttonLabel="Compare Plan N Rates"
             title={`Compare Plan N Rates in ${STATE_NAME}`}
             subtitle="Enter your ZIP code to see personalized Plan N rates from top carriers in your area."
              trigger={
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="north_carolina_plan_n_bottom"
           triggerId="nc-plan-n-bottom-compare"
           buttonLabel="Compare Plan N Rates"
           title={`Compare Plan N Rates in ${STATE_NAME}`}
           subtitle="Enter your ZIP code to see personalized Plan N rates from top carriers in your area."
            trigger={
              <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl p-10 md:p-14 text-center cursor-pointer hover:shadow-2xl transition-shadow group border-l-4 border-teal-500">
                ...
                <p className="text-blue-300 text-sm mt-4">
                  ...
                  <a
                    href="tel:+18884410465"
                    onClick={(e) => { e.stopPropagation(); trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "north_carolina_plan_n_bottom" }); }}
      ...
      <section className="py-12 bg-slate-50 border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/medicare-supplement-plans/north-carolina" className="inline-flex items-center gap-1.5 text-sm text-blue-700 hover:text-blue-900 bg-white px-4 py-2 rounded-lg border border-slate-200 hover:border-blue-300 transition-colors">
