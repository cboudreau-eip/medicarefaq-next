 ...
 * Route: /medicare-supplement-plans/medigap-by-state/[stateSlug]
        ...
        <div className="container relative z-10">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a href="tel:+18883358996"  data-invoca-phone-number="18883358996"
              onClick={() => trackPhoneClick({ phone_number: "(888) 335-8996", page_section: "medigap_state_detail" })} className="invoca-phone inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20">
            ...
            <div className="mb-12">
              ...
              <div className="flex flex-wrap gap-3">
                {state.popularPlans.map((letter) => (
                  <Link
                    key={letter}
                    href={`/medicare-supplement-plans/${letter === "HD-G" ? "high-deductible-plan-g" : letter === "HD-F" ? "high-deductible-plan-f" : `plan-${letter.toLowerCase()}`}`}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {state.nearbyStates.map((nearbySlug) => {
                  ...
                  return (
                    <Link
                      key={nearbySlug}
                      href={`/medicare-supplement-plans/medigap-by-state/${nearbySlug}`}
