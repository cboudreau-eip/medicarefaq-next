 ...
 * Route: /medicare-supplement-plans/west-virginia/
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              ...
              triggerId={`west_virginia-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in West Virginia`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of West Virginia.`}
            ...
            <ZipFormModal
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare WV Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
