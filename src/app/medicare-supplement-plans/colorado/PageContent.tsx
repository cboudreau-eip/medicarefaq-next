...
/**
 * Colorado Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/colorado/
 * Key differentiators: 235,000+ Medigap enrollees, Plan G from $113/mo in Denver,
 *                      no birthday/anniversary rule, Denver/Boulder/Colorado Springs markets,
 *                      Humana SilverSneakers popular, household discount widely available,
 *                      Colorado DOI regulation, SHIP free counseling at (888) 696-7213
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/colorado-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="colorado_carrier_card"
              triggerId={`colorado-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Colorado`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Colorado.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "colorado_carrier_card",
                })
              }
...
/* Main Page Content */
export default function ColoradoPageContent() {
  return (
    <article className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Colorado</span>
          </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Colorado has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at
            just {STATE_STATS.lowestPlanG} in Denver. We compared{" "}
            {STATE_STATS.carriers} carriers to find the best coverage for retirees in the
            Centennial State.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan N from <strong className="text-white">$87/mo</strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="colorado_hero"
              triggerId="colorado-hero-compare"
              coverageType="ms"
              title="Compare Colorado Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Colorado."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare CO Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
      ...
      {/* Colorado Retirement Spotlight Banner */}
      <section className="bg-amber-50 border-b border-amber-200">
        <div className="container py-5">
          <div className="flex items-start gap-4 max-w-4xl">
            <div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center shrink-0">
              <Mountain className="w-5 h-5 text-amber-700" aria-hidden="true" />
            </div>
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Colorado Has One of the Youngest Medicare Populations in the Country
              </p>
              <p className="text-sm text-amber-800">
                Colorado&apos;s Medicare population is growing steadily, with over{" "}
                <strong>1.1 million</strong> total Medicare enrollees and{" "}
                <strong>235,000+</strong> Medigap policyholders. Denver, Boulder, Fort
                Collins, and Colorado Springs attract active retirees who value
                comprehensive coverage. Plan G starts at just{" "}
                <strong>{STATE_STATS.lowestPlanG}</strong> in Denver. Colorado has no
                birthday rule or anniversary rule, so your 6-month Open Enrollment Period
                at age 65 is your best chance to lock in coverage without medical
                underwriting.
              </p>
            </div>
          </div>
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Plan G from {STATE_STATS.lowestPlanG} in Denver</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Award className="w-4 h-4 text-amber-500" aria-hidden="true" />
              <span>Mutual of Omaha rated #1 overall in Colorado</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 235,000 people in Colorado have Medicare Supplement Insurance, or
            Medigap. Colorado is home to some of the most active retirees in the country,
            with Denver, Boulder, Fort Collins, Colorado Springs, and mountain communities
            like Aspen and Vail drawing retirees who want comprehensive healthcare
            coverage. With over 25 carriers licensed in the state, Colorado offers a
            competitive Medigap market where Plan G starts at just $113 per month in
            Denver.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G is the most popular Medicare Supplement plan for new enrollees in
            Colorado. It covers nearly all Medicare out-of-pocket costs except the annual
            Part B deductible ($283 in 2026). Colorado uses attained-age rating, meaning
            premiums increase as you age, so enrolling during your 6-month Open Enrollment
            Period at age 65 is the best way to lock in the lowest possible rate. Unlike
            California or Missouri, Colorado has no birthday rule or anniversary rule. Your
            OEP is your primary guaranteed-issue window.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Compare the Best Medicare Supplement Plans in Colorado
          </h2>
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Colorado, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Denver. Rates in
            Boulder, Colorado Springs, and other regions may vary.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Colorado
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Denver. Rates shown are for a
            65-year-old female nonsmoker and may include available household discounts.
            Colorado uses attained-age rating, so premiums will increase as you age.
            Boulder and Colorado Springs rates may differ slightly.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                <strong>Lowest available in Colorado (Denver):</strong> Plan G from{" "}
                {STATE_STATS.lowestPlanG} | Plan N from $87/mo | Source: FairSquare
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="colorado_premium_table"
              triggerId="colorado-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Colorado ZIP Code"
              subtitle="Premiums vary by city in Colorado. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            enrollees in Colorado. Here is how they compare.
          </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    {
                      feature: "Avg. monthly premium (Denver)",
                      g: { text: "$113-$159", bold: true },
                      n: { text: "$87-$115", bold: true },
                    },
                  ].map((row, i) => (
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  In Colorado, Cigna is competitive at $120/mo, but Mutual of Omaha at
                  $148/mo is the better long-term value.
                </strong>{" "}
                Cigna&apos;s complaint ratio runs higher than most competitors, and their
                rate increases have been steeper in recent years. Mutual of Omaha brings
                an A+ AM Best rating, U.S.-based customer service, and a 7% household
                discount if your spouse or partner also enrolls. Humana is worth a look
                if you are an active retiree in Denver or Boulder, since their
                SilverSneakers benefit gives you free access to thousands of gyms
                statewide. Colorado has no birthday rule, so your 6-month Open Enrollment
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Colorado Medigap Rules You Should Know
          </h2>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your Colorado ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              Colorado has a competitive Medigap market with over 25 carriers and Plan G
              starting at just $113/mo in Denver. Enter your ZIP code to see exact rates
              from all available carriers in your area. Remember, your Open Enrollment
              Period is the best time to lock in coverage without medical underwriting.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="colorado_bottom_cta"
                triggerId="colorado-bottom-cta-compare"
                coverageType="ms"
                title="Compare Colorado Medigap Rates"
                subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Colorado."
                buttonLabel="Compare Plans"
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "colorado_bottom_cta",
                  })
                }
                className="invoca-phone inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
