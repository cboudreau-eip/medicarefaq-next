 ...
 * Route: /medicare-supplement-plans/virginia/
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/virginia-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="virginia_carrier_card"
              triggerId={`virginia-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Virginia`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Virginia.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "virginia_carrier_card",
                })
              }
...
/* ─── Main Page Content ─── */
export default function VirginiaPageContent() {
  return (
    <article className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Virginia</span>
          </div>

          <div className="flex items-center gap-3 mb-4 flex-wrap">
            <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
              <span className="text-2xl font-black text-white">VA</span>
            </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            ...
            {STATE_STATS.carriers} carriers to find the best coverage in the Commonwealth.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan N from <strong className="text-white">$72/mo</strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="virginia_hero"
              triggerId="virginia-hero-compare"
              coverageType="ms"
              title="Compare Virginia Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Virginia."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare VA Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
      ...
      {/* Virginia Birthday Rule Spotlight Banner */}
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Virginia Birthday Rule: Switch Medigap Carriers Every Year Without Underwriting
              </p>
              <p className="text-sm text-amber-800">
                ...
                G). Unlike California, you cannot downgrade to a lesser plan using this
                rule.
              </p>
            </div>
          </div>
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>State Farm rated #1 overall in Virginia</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Compare the Best Medicare Supplement Plans in Virginia
          </h2>
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Virginia, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Richmond. Rates in
            Northern Virginia, Virginia Beach, and other regions may vary.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in Virginia
          </h2>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                <strong>Lowest available in Virginia (Richmond):</strong> Plan G from{" "}
                {STATE_STATS.lowestPlanG} | Plan N from $72/mo | Source: FairSquare
                Medicare, Virginia SCC Medigap Premium Finder, May 2026
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="virginia_premium_table"
              triggerId="virginia-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Virginia ZIP Code"
              subtitle="Premiums vary by city in Virginia. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            enrollees in Virginia. Here is how they compare.
          </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    {
                      feature: "Avg. monthly premium (Richmond)",
                      g: { text: "$100–$152", bold: true },
                      n: { text: "$72–$113", bold: true },
                    },
                  ].map((row, i) => (
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Virginia Medigap Rules You Should Know
          </h2>
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                ratings, CMS Medicare Plan Finder, FairSquare Medicare, Virginia SCC
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your Virginia ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              Virginia&apos;s birthday rule means you can shop for a better rate every
              year. With Plan G starting at $100/mo in Richmond and over 30 carriers
              licensed in the state, there is real competition to take advantage of. Enter
              your ZIP code to compare rates from all available carriers in your area.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="virginia_bottom_cta"
                triggerId="virginia-bottom-cta-compare"
                coverageType="ms"
                title="Compare Virginia Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Virginia."
                buttonLabel="Compare Plans"
                trigger={
                  <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                    Compare VA Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "virginia_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
