"use client";
/**
 * Illinois Plan N Rate Comparison Page
 * Route: /medicare-supplement-plans/illinois/plan-n/
...
import { ILLINOIS_CARRIERS, ILLINOIS_STATS, type IllinoisCarrier } from "@/lib/illinois-medigap-data";
...
const carriersByPlanG = [...ILLINOIS_CARRIERS].sort((a, b) => {
...
const PLAN_COMPARISON = [
  ...
  { feature: "Avg. monthly premium (FL)", planG: ILLINOIS_STATS.averagePlanNPremium, planN: ILLINOIS_STATS.averagePlanNPremium },
...
const FAQS = [
  {
    q: "What is the cheapest Plan N in Illinois?",
    a: `HealthSpring (formerly Cigna) currently offers the lowest Plan N premium in ${STATE_NAME} at approximately $118 per month for a 65-year-old. However, rates vary by age, gender, zip code, and tobacco use. Comparing quotes from multiple carriers is the best way to find the lowest rate in your area.`,
  },
  {
    q: "Is Plan N worth it in Illinois?",
  ...
  {
    q: "Can I switch from Plan N to Plan N in Illinois?",
    a: `Yes, but you will likely need to pass medical underwriting unless you have a guaranteed issue right. ${STATE_NAME} has a limited birthday rule for ages 65-75 that gives you 45 days to switch plans within your current insurer or its affiliates. To switch to a completely different carrier, you would need to pass medical underwriting.`,
  },
  {
  ...
  {
    q: "Can I use Plan N with any doctor in Illinois?",
  ...
  {
    q: "When is the best time to buy Plan N in Illinois?",
  ...
  {
    q: "What happens if I miss my Medigap open enrollment in Illinois?",
    a: `If you miss your 6-month open enrollment window, you can still apply for Plan N, but carriers can use medical underwriting to decide whether to accept you and what premium to charge. ${STATE_NAME} has a limited birthday rule for ages 65-75 that allows switching within your current insurer annually. However, your initial 6-month open enrollment period is still your best opportunity to choose any carrier without health questions.`,
  },
  {
    q: "Is there a birthday rule in Illinois?",
    a: `Yes, but with important limitations. ${STATE_NAME} has a birthday rule for policyholders aged 65-75 that gives you 45 days starting on your birthday to switch to a plan with equal or lesser benefits from your current insurer or its authorized affiliates. Unlike California, you cannot switch to a completely different carrier using this rule. The rule also ends at age 75.`,
  },
];

export default function IllinoisPlanGContent() {
    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-20">
          ...
          <nav className="flex items-center gap-2 text-sm text-blue-200 mb-8" aria-label="Breadcrumb">
            ...
            <span className="text-blue-400">&gt;</span>
            <Link href="/medicare-supplement-plans/illinois" className="hover:text-white transition-colors">{STATE_NAME}</Link>
            <span className="text-blue-400">&gt;</span>
          ...
          <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-3xl">
            ...
            Compare rates from {ILLINOIS_STATS.numberOfCarriers} carriers in {STATE_NAME} to find the lowest premium.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 mb-10 max-w-2xl">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              ...
              <p className="text-2xl md:text-3xl font-bold text-teal-400">{ILLINOIS_STATS.lowestPlanNPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Average Rate</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{ILLINOIS_STATS.averagePlanNPremium}</p>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center">
              <p className="text-sm text-blue-200">Carriers</p>
              <p className="text-2xl md:text-3xl font-bold text-white">{ILLINOIS_STATS.numberOfCarriers}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <ZipFormModal
              coverageType="ms"
              pageSection="illinois_plan_n_hero"
              triggerId="il-plan-n-hero-compare"
            ...
            <a
              ...
              onClick={() => trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "illinois_plan_n_hero" })}
      ...
      <section className="py-8">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="illinois_plan_n_mid"
           triggerId="il-plan-n-mid-compare"
      ...
      {/* ─── SECTION 6: Illinois-Specific Rules ─── */}
      <section className="py-16 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-bold text-slate-900">Birthday Rule (45 Days, Ages 65-75)</h3>
              </div>
              <p className="text-sm text-slate-700">
                {STATE_NAME} has a limited birthday rule for policyholders aged 65-75. Each year, starting on your birthday, you have 45 days to switch to a plan with equal or lesser benefits from your current insurer or its authorized affiliates without medical underwriting. Note: unlike California, you cannot switch to a completely different carrier using this rule.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-bold text-slate-900">Free Look Period Free Look Period & SHINE SHIP</h3>
              </div>
              <p className="text-sm text-slate-700">
                {STATE_NAME} provides a {ILLINOIS_STATS.freeLookPeriod} free look period after purchasing a Medigap policy. If you are not satisfied, you can cancel for a full refund. {STATE_NAME} also offers the Illinois SHIP program (State Health Insurance Assistance Program), which provides free, unbiased Medicare counseling.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-6">
            {[
              ...
              {
                step: 4,
                title: `Review your policy during the ${ILLINOIS_STATS.freeLookPeriod} free look period`,
                desc: `After your policy starts, you have ${ILLINOIS_STATS.freeLookPeriod} to review it. If you are not satisfied for any reason, you can cancel for a full refund of premiums paid.`,
              },
            ].map((item) => (
          ...
          <div className="mt-10">
            <ZipFormModal
             coverageType="ms"
              pageSection="illinois_plan_n_enroll"
             triggerId="il-plan-n-enroll-compare"
             buttonLabel="Compare Plan N Rates"
             title={`Compare Plan N Rates in ${STATE_NAME}`}
             subtitle="Enter your ZIP code to see personalized Plan N rates from top carriers in your area."
              trigger={
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          <ZipFormModal
           coverageType="ms"
              pageSection="illinois_plan_n_bottom"
           triggerId="il-plan-n-bottom-compare"
           buttonLabel="Compare Plan N Rates"
           title={`Compare Plan N Rates in ${STATE_NAME}`}
           subtitle="Enter your ZIP code to see personalized Plan N rates from top carriers in your area."
            trigger={
              <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl p-10 md:p-14 text-center cursor-pointer hover:shadow-2xl transition-shadow group border-l-4 border-teal-500">
                ...
                <p className="text-blue-200 mb-8 max-w-xl mx-auto">
                  ...
                  Compare rates from {ILLINOIS_STATS.numberOfCarriers} carriers in {STATE_NAME} to make sure you are not overpaying.
                </p>
                ...
                <p className="text-blue-300 text-sm mt-4">
                  ...
                  <a
                    href="tel:+18884410465"
                    onClick={(e) => { e.stopPropagation(); trackPhoneClick({ phone_number: "(888) 441-0465", page_section: "illinois_plan_n_bottom" }); }}
      ...
      <section className="py-12 bg-slate-50 border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/medicare-supplement-plans/illinois" className="inline-flex items-center gap-1.5 text-sm text-blue-700 hover:text-blue-900 bg-white px-4 py-2 rounded-lg border border-slate-200 hover:border-blue-300 transition-colors">
