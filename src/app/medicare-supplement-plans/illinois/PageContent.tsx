...
/**
 * Illinois Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/illinois/
 * Key differentiators: 750K enrollees (largest of our state pages so far),
 *                      BCBS Illinois dominates at 48.2% market share,
 *                      Plan G from $113/mo in Chicago, unusually high Plan F legacy adoption (44%),
...
import {
  ...
  ILLINOIS_FAQS,
  SCORING_METHODOLOGY,
  type IllinoisCarrier,
} from "@/lib/illinois-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="illinois_carrier_card"
              triggerId={`illinois-carrier-${carrier.id}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Illinois`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Illinois.`}
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 mt-2">
              <p className="text-xs text-slate-500">
                <strong>Plans offered in Illinois:</strong>{" "}
...
export default function IllinoisPageContent() {
  return (
    <article className="min-h-screen bg-white">
        ...
        <div className="container relative z-10">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
              <span className="text-2xl font-black text-white">IL</span>
            </div>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">
                  {ILLINOIS_STATS.lowestPlanGPremium}
                </strong>{" "}
                in Chicago
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan N from{" "}
                <strong className="text-white">
                  {ILLINOIS_STATS.lowestPlanNPremium}
                </strong>
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="illinois_hero"
              triggerId="illinois-hero-compare"
              coverageType="ms"
              title="Compare Illinois Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Illinois."
      ...
      {/* BCBS Illinois Spotlight Banner */}
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                ...
                recognition, and broad provider network make it a carrier worth
                comparing alongside the national options listed below.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            ...
            Medigap, giving enrollees a wide range of options at various price
            points.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            One notable feature of the Illinois market is the unusually high
            adoption of Plan F (44% of enrollees), reflecting a large base of
            legacy enrollees who enrolled before Plan F was discontinued for new
            Medicare beneficiaries in 2020. For new enrollees, Plan G is the
            most comprehensive option available, covering all out-of-pocket costs
            except the annual Part B deductible ($283 in 2026). Illinois uses
            attained-age rating, meaning premiums increase as you age, so
            enrolling during your Open Enrollment Period at 65 is the best
            strategy.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Illinois, ranked by the MedicareFAQ
            Score. Premiums shown are for a 65-year-old female nonsmoker in
            Chicago. Rates in Springfield, Rockford, and other regions may vary.
          </p>

          <div className="space-y-4">
            {ILLINOIS_CARRIERS.map((carrier, i) => (
        ...
        <div className="container max-w-4xl">
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                <strong>Lowest available in Illinois (Chicago):</strong> Plan G
                from {ILLINOIS_STATS.lowestPlanGPremium} | Plan N from{" "}
                {ILLINOIS_STATS.lowestPlanNPremium} | Source: CMS Medicare Plan
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="illinois_premium_table"
              triggerId="illinois-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Illinois ZIP Code"
              subtitle="Premiums vary by city in Illinois. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            for new enrollees in Illinois. Here is how they compare.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    {
                      feature: "Avg. monthly premium (Chicago)",
                      g: {
                        text: ILLINOIS_STATS.averagePlanGPremium,
                        bold: true,
                      },
                      n: {
                        text: ILLINOIS_STATS.averagePlanNPremium,
                        bold: true,
                      },
                    },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for
                some office visits and up to $50 for ER visits that do not result
          ...
          <div className="space-y-4">
            <div className="p-5 bg-white border border-slate-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Your Medigap Open Enrollment Period is a one-time 6-month
                  window that starts the first month you are 65 or older and
                  enrolled in Medicare Part B. During this period, carriers
                  cannot deny you coverage or charge more due to pre-existing
                  health conditions. This is the best time to enroll in Medigap
                  in Illinois.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-white border border-amber-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Illinois does not have a birthday rule. Unlike California, which
                  allows enrollees to switch to an equal or lesser plan during a
                  60-day window each year around their birthday, Illinois enrollees
                  can only switch Medigap plans after their OEP by passing medical
                  underwriting. This makes your initial enrollment decision
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Illinois uses attained-age rating, which means your Medigap
                  premium increases as you get older. Premiums are based on your
                  current age and rise each year. Enrolling during your OEP at
                  age 65 is the best strategy to lock in the lowest possible
                  starting rate.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Illinois has one of the highest Plan F adoption rates in the
                  country at 44%. Plan F is no longer available to new Medicare
                  enrollees who became eligible on or after January 1, 2020.
                  Existing Plan F enrollees can keep their coverage indefinitely,
                  but cannot switch to Plan G without passing medical underwriting
                  after their OEP ends. Plan G is the most comprehensive option
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  ...
                  provides free, unbiased Medicare counseling from trained
                  volunteers. SHIP counselors can help you compare Medigap plans,
                  understand your options, and navigate enrollment. The program is
                  available to all Illinois Medicare beneficiaries and their
                  families at no cost.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-xl flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  All Medigap plans in Illinois are regulated by the Illinois
                  Department of Insurance (IDOI). The IDOI maintains consumer
                  resources for comparing plans and handles complaints against
                  carriers. Illinois also enforces a 30-day free-look period,
                  allowing you to return a new policy for a full refund if you are
                  not satisfied.
                </p>
              </div>
            </div>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            The MedicareFAQ Score rates Medicare Supplement carriers on a scale
            of 1.0 to 5.0 based on five key factors. Our ratings are independent
            and not influenced by advertising relationships.
          </p>
      ...
      <section className="py-12 bg-white border-t border-slate-100">
        <div className="container max-w-5xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Explore Illinois Medicare Supplement Plans
          </h2>
          <p className="text-slate-600 mb-8">
            Compare rates and coverage details for specific plan types available to Illinois Medicare beneficiaries.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <a
              href="/medicare-supplement-plans/illinois/plan-g/"
            ...
            >
              ...
              <p className="text-sm text-slate-600 mb-3">
                Compare Plan G premiums from 30+ carriers in Illinois. Covers everything except the Part B deductible.
              </p>
              <p className="text-sm text-teal-700 mt-2 font-medium">Illinois has a limited birthday rule for ages 65-75 - you can switch within your current insurer annually.</p>
              <div className="flex items-center gap-1 text-teal-600 font-semibold text-sm group-hover:gap-2 transition-all mt-3">
                Compare IL Plan G Rates
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
              </div>
            </a>
            <a
              href="/medicare-supplement-plans/illinois/plan-n/"
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            ...
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="illinois_bottom_cta"
                triggerId="illinois-bottom-cta-compare"
                coverageType="ms"
                title="Compare Illinois Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Illinois."
                buttonLabel="Compare Plans"
                trigger={
                  <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                    Compare Illinois Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
