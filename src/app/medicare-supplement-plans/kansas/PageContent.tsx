...
/**
 * Kansas Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/kansas/
 * Key differentiators: No birthday rule,
 *                      Farm Bureau Insurance lowest Plan G at $141/mo and Plan N at $103/mo,
 *                      Blue Cross Blue Shield of Kansas local carrier,
 *                      SHICK at (800) 860-5260
 */
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-5">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="kansas_carrier_card"
              triggerId={`kansas-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in Kansas`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of Kansas.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "kansas_carrier_card",
                })
              }
...
export default function KansasPageContent() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 pt-8 pb-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">Kansas</span>
          </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            Kansas does not have a birthday rule, making your initial Open Enrollment Period
            critical. Farm Bureau Insurance offers the lowest Plan G at{" "}
            {STATE_STATS.lowestPlanG} and Plan N at {STATE_STATS.lowestPlanN}. Blue Cross
            Blue Shield of Kansas is the top local carrier. Over {STATE_STATS.carriers} carriers
            serve Kansas.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> Kansas seniors with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> (Farm Bureau)
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <TrendingDown className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                Plan N from <strong className="text-white">{STATE_STATS.lowestPlanN}</strong> (Farm Bureau)
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Award className="w-4 h-4 text-amber-400" aria-hidden="true" />
              <span>
                BCBS Kansas: <strong className="text-white">lowest Plan K at $85/mo</strong>
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="kansas_hero"
              triggerId="kansas-hero-compare"
              coverageType="ms"
              title="Compare Kansas Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of Kansas."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare KS Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                Kansas Does Not Have a Birthday Rule
              </p>
              <p className="text-sm text-amber-800">
                Kansas has no birthday rule or annual guaranteed switching window. After your
                initial six-month Open Enrollment Period, carriers can deny coverage or charge
                higher premiums based on your health. Your Open Enrollment Period, which starts
                when you turn 65 and enroll in Medicare Part B, is your most important window
                for choosing a Medigap plan. Contact Kansas SHICK at (800) 860-5260 for free
                counseling.
              </p>
            </div>
          </div>
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Farm Bureau Plan G from {STATE_STATS.lowestPlanG}</span>
            </div>
            <div className="flex items-center gap-1.5">
              <Award className="w-4 h-4 text-amber-500" aria-hidden="true" />
              <span>BCBS Kansas Plan K at $85/mo</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            More than 115,000 Kansas residents have Medicare Supplement Insurance, also called
            Medigap. Kansas follows standard federal Medigap rules, offering plans A through N.
            The state does not have a birthday rule, which means your initial Open Enrollment
            Period is the most important window for choosing your plan.
          </p>
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            ...
            premiums in Wichita range from $141/mo (Farm Bureau Insurance) to over $215/mo
            (Transamerica) for a 65-year-old. The state average is $201/mo, so shopping
            carefully can save $60/mo or more.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Farm Bureau Insurance is the standout carrier in Kansas, offering both the lowest
            Plan G ($141/mo) and the lowest Plan N ($103/mo). It is a regional carrier with
            deep Kansas roots and a local agent network. Blue Cross Blue Shield of Kansas is
            the dominant local insurer and offers the lowest cost-sharing Plans K ($85/mo) and
            L ($125/mo). For seniors who want the broadest plan selection, Aetna and New Era
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in Kansas, ranked by the MedicareFAQ Score. Rates
            shown are for a 65-year-old in the Wichita area and are updated for 2026.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Kansas Medigap Premium Comparison
          </h2>
          <p className="text-slate-600 mb-6">
            Monthly premiums for a 65-year-old in Wichita, Kansas. Rates are for standard
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                Rates are for a 65-year-old in Wichita, Kansas. N/A indicates the plan is not
                offered by that carrier in Kansas. Plan F is only available to Medicare
          ...
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="kansas_premium_table"
              triggerId="kansas-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your Kansas ZIP Code"
              subtitle="Enter your ZIP code to see exact rates from all available carriers in your area of Kansas."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            Kansas. Here is how they compare.
          </p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    { feature: "Monthly premium (lowest KS rate)", g: "$141/mo (Farm Bureau)", n: "$103/mo (Farm Bureau)" },
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  Kansas has no birthday rule, so your Open Enrollment Period at 65 is your
                  best and often only chance to get guaranteed Medigap coverage.
                </strong>{" "}
                Farm Bureau Insurance at $141/mo for Plan G is the lowest in the state and
                has a strong Kansas presence, but it only offers four plan types. If you want
                the broadest plan selection, Aetna or New Era Life offer five to six plan
                types. For the lowest cost-sharing plans, Blue Cross Blue Shield of Kansas
                has Plan K at $85/mo and Plan L at $125/mo. Call Kansas SHICK at
                (800) 860-5260 for free, unbiased counseling before you enroll.
              </>
            }
          />
        </div>
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl">
              Kansas has no birthday rule. Your Open Enrollment Period is your best opportunity
              for guaranteed coverage. Farm Bureau Insurance offers Plan G from $141/mo and
              Plan N from $103/mo. BCBS Kansas has Plan K at $85/mo. Call Kansas SHICK at
              (800) 860-5260 for free counseling.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="kansas_bottom_cta"
                triggerId="kansas-bottom-cta-compare"
                coverageType="ms"
                title="Compare Kansas Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of Kansas."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "kansas_bottom_cta",
                  })
                }
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
