"use client";
/**
 * New Hampshire Medicare Supplement Comparison Page
 * Route: /medicare-supplement-plans/new-hampshire/
 * Key differentiators: No birthday rule, issue-age pricing dominant,
 *                      Anthem lowest Plan G at $180/mo, First Health lowest Plan N at $129/mo,
 *                      State Farm A++ with local agents, Harvard Pilgrim regional option,
 *                      SHIP free counseling at (800) 852-3416
 */
...
import {
  ...
  PREMIUM_TABLE,
  type Carrier,
} from "@/lib/new-hampshire-medigap-data";
      ...
      <div className="p-5">
        <div className="flex flex-col md:flex-row md:items-start gap-4">
          ...
          <div className="flex flex-col gap-2 md:w-48 shrink-0">
            <ZipFormModal
              pageSection="new_hampshire_carrier_card"
              triggerId={`nh-carrier-${rank}`}
              coverageType="ms"
              title={`Compare ${carrier.name} Rates in New Hampshire`}
              subtitle={`Enter your ZIP code to see personalized ${carrier.name} Medigap rates in your area of New Hampshire.`}
            ...
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  ...
                  page_section: "new_hampshire_carrier_card",
                })
              }
...
export default function NewHampshirePageContent() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 py-16 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6 flex-wrap">
            ...
            <ChevronDown className="w-3 h-3 rotate-[-90deg]" aria-hidden="true" />
            <span className="text-teal-400">New Hampshire</span>
          </div>
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            <div className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center">
              <span className="text-2xl font-black text-white">NH</span>
            </div>
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-6">
            New Hampshire has over {STATE_STATS.enrollees} Medigap enrollees. Plan G starts at{" "}
            {STATE_STATS.lowestPlanG} in Manchester and averages {STATE_STATS.avgPlanG} statewide.
            We compared {STATE_STATS.carriers} carriers to find the best coverage in the Granite State.
          </p>
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 text-sm text-slate-300">
              <Users className="w-4 h-4 text-teal-400" aria-hidden="true" />
              <span>
                <strong className="text-white">{STATE_STATS.enrollees}</strong> NH residents with Medigap
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                Plan G from{" "}
                <strong className="text-white">{STATE_STATS.lowestPlanG}</strong> in Manchester
              </span>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-300">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-300">
              ...
              <span>
                <strong className="text-white">{STATE_STATS.carriers}</strong> carriers licensed in NH
              </span>
            </div>
          </div>
          <div className="flex flex-wrap gap-3">
            <ZipFormModal
              pageSection="new_hampshire_hero"
              triggerId="nh-hero-compare"
              coverageType="ms"
              title="Compare New Hampshire Medigap Rates"
              subtitle="Enter your ZIP code to see personalized rates from top Medigap carriers in your area of New Hampshire."
              ...
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                  Compare NH Rates <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </button>
              }
            />
            <a
              ...
              onClick={() =>
                trackPhoneClick({
                  phone_number: "(888) 335-8996",
                  page_section: "new_hampshire_hero",
                })
              }
          ...
          <div className="flex items-start gap-4 max-w-4xl">
            ...
            <div>
              <p className="font-bold text-amber-900 text-base mb-1">
                New Hampshire Has No Birthday Rule: Your Initial Plan Choice Matters
              </p>
              <p className="text-sm text-amber-800">
                Unlike California, Oregon, and other states with birthday rules, New Hampshire does{" "}
        ...
        <div className="container py-4">
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-slate-600">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>Issue-age pricing dominant in New Hampshire</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 border-b border-slate-100">
        <div className="container max-w-4xl">
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            New Hampshire has over 130,000 residents enrolled in Medicare Supplement Insurance,
          ...
          <p className="text-slate-700 text-base leading-relaxed mb-4">
            New Hampshire does not have a birthday rule or anniversary rule, which means your
            6-month Open Enrollment Period when you first turn 65 and enroll in Part B is your
            best and most important opportunity to lock in coverage. After that window closes,
            carriers can use medical underwriting to deny your application or charge higher
            premiums based on your health history.
          </p>
          <p className="text-slate-700 text-base leading-relaxed">
            Plan G premiums in Manchester range from $180/mo (Anthem) to $267/mo (AARP/UHC) for
            a 65-year-old. Most New Hampshire carriers use issue-age pricing, which locks your
            premium at your enrollment age. This makes New Hampshire one of the more favorable
            states for long-term Medigap cost stability. State Farm stands out with an A++ AM
            Best rating and a large local agent network across Manchester, Concord, and Nashua.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Compare the Best Medicare Supplement Plans in New Hampshire
          </h2>
          <p className="text-slate-600 mb-8">
            Our top-rated Medigap carriers in New Hampshire, ranked by the MedicareFAQ Score.
            Premiums shown are for a 65-year-old female nonsmoker in Manchester. Rates in
            Concord, Nashua, and Portsmouth may vary slightly.
          </p>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            Medicare Supplement Prices in New Hampshire
          </h2>
          <p className="text-slate-600 mb-6">
            Sample monthly premiums from top carriers in Manchester for a 65-year-old female
            nonsmoker. Most New Hampshire carriers use issue-age pricing, which locks your rate
            at your enrollment age.
          </p>
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                Source: NH Insurance Department, FairSquare Medicare, MoneyGeek, May 2026.
                Rates shown for a 65-year-old female nonsmoker in Manchester.
              </p>
            </div>
          </div>
          <div className="mt-6 text-center">
            <ZipFormModal
              pageSection="new_hampshire_premium_table"
              triggerId="nh-premium-table-cta"
              coverageType="ms"
              title="See Rates in Your New Hampshire ZIP Code"
              subtitle="Premiums vary by city in New Hampshire. Enter your ZIP code to see exact rates from all available carriers in your area."
              buttonLabel="Compare Plans"
              trigger={
                <button className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">
      ...
      <section className="py-12">
        <div className="container max-w-4xl">
          ...
          <p className="text-slate-600 mb-6">
            ...
            Hampshire. Plan G offers more complete coverage; Plan N costs less each month but
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Avg. monthly premium (Manchester)", g: "$180-$191", n: "$129-$144", bold: true },
                  ].map((row, i) => (
            ...
            <div className="px-5 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                *Plan N covers Part B coinsurance but may charge up to $20 for some office visits
                and up to $50 for ER visits that do not result in inpatient admission. New Hampshire
        ...
        <div className="container max-w-4xl">
          <EddieProTip
            tip={
              <>
                <strong>
                  New Hampshire has no birthday rule, so your initial enrollment decision is the
                  most important one you will make.
                </strong>{" "}
                Most carriers in New Hampshire use issue-age pricing, which is a major advantage
                over states dominated by attained-age pricing. Enrolling at 65 locks in your
                rate, and it will only increase due to general inflation, not because you are
                getting older. Anthem at $180/mo is the lowest Plan G, but State Farm at $186/mo
                with an A++ rating is worth the extra $6/mo for the financial strength and local
                agent access. If you want Plan N, First Health at $129/mo is the price leader.
                Call NH SHIP at {STATE_STATS.shipPhone} for free, unbiased help comparing plans.
              </>
            }
          />
        </div>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container max-w-4xl">
          <h2
            ...
            style={{ fontFamily: "'Merriweather', serif" }}
          >
            New Hampshire Medigap Rules You Should Know
          </h2>
          <div className="space-y-4">
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="px-4 py-3 bg-slate-50 border-t border-slate-200">
              <p className="text-xs text-slate-500">
                ...
                CMS Medicare Plan Finder, NH Insurance Department, FairSquare Medicare
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                The New Hampshire SHIP (State Health Insurance Assistance Program) provides free,
                unbiased Medicare counseling from certified volunteers. Call{" "}
                <strong>{STATE_STATS.shipPhone}</strong> or visit insurance.nh.gov to connect with
        ...
        <div className="container max-w-4xl">
          <div className="p-8 bg-gradient-to-br from-blue-900 to-slate-900 rounded-2xl text-white">
            <h3 className="text-2xl font-bold mb-3">
              Find the Best Medigap Rate in Your New Hampshire ZIP Code
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl">
              New Hampshire has no birthday rule, so your Open Enrollment Period is your best
              chance to lock in coverage without health questions. Plan G starts at $180/mo in
              Manchester. Most carriers use issue-age pricing, so enrolling at 65 gives you the
              lowest possible rate for life.
            </p>
            <div className="flex flex-wrap gap-3">
              <ZipFormModal
                pageSection="new_hampshire_bottom_cta"
                triggerId="nh-bottom-cta-compare"
                coverageType="ms"
                title="Compare New Hampshire Medigap Rates"
                subtitle="Enter your ZIP code to get personalized Medigap rates from all available carriers in your area of New Hampshire."
                buttonLabel="Compare Plans"
                trigger={
              ...
              <a
                ...
                onClick={() =>
                  trackPhoneClick({
                    phone_number: "(888) 335-8996",
                    page_section: "new_hampshire_bottom_cta",
                  })
                }
                className="invoca-phone inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-semibold px-6 py-3 rounded-lg transition-colors border border-white/20"
              >
