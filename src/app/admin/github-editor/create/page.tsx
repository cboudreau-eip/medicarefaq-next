...
export default function CreateArticlePage() {
  ...
  // If not authenticated, redirect to main CMS page
  if (!authenticated) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 max-w-md w-full text-center">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Please log in through the CMS dashboard first.
          </p>
          <button
            onClick={() => router.push("/admin/github-editor")}
            className="inline-flex items-center gap-2 text-sm font-semibold bg-teal-600 text-white rounded-lg px-5 py-2.5 hover:bg-teal-700 transition-colors"
          >
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                <div className="p-3">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[10px] font-bold text-white bg-red-500 px-1.5 py-0.5 rounded uppercase">
                      Blog
                    </span>
