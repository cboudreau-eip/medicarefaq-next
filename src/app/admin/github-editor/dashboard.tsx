  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative h-[160px] overflow-hidden bg-gray-100">
          ...
          <div className="absolute top-3 left-3 flex items-center gap-2">
            <span
              ...
              style={{ borderRadius: "120px 8px 120px 8px / 8px 120px 8px 120px", transform: "rotate(-2deg)" }}
            >
        ...
        <div className="p-4">
          <h3
            className="font-bold text-[#2b2b2b] text-base leading-snug mb-2 line-clamp-2"
          ...
          <div className="flex items-center justify-between text-xs text-[#888888]">
            ...
            <span className="font-mono text-[#9a9a9a] truncate max-w-[120px]">
              {article.slug.length > 20 ? article.slug.slice(0, 20) + "..." : article.slug}
            </span>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderBottom: "3px dashed #2b2b2b" }}
      >
        ...
        {!loading && !error && filtered.length > 0 && (
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-7">
            {filtered.map((article, i) => (
              <SketchArticleCard key={`${article.type}-${article.slug}`} article={article} index={i} />
            ))}
          </div>
        )}
      </div>
