...
const SEARCH_PAGES = [
  ...
  { title: "Medicare Supplement Plans", description: "Fill the gaps in Original Medicare coverage with Medigap", url: "/medicare-supplement-plans", category: "Plans" },
  { title: "Compare Medigap Plans", description: "Side-by-side comparison of Medigap plans A through N", url: "/medicare-supplement-plans/compare", category: "Plans" },
  { title: "Medigap Eligibility", description: "Who qualifies for Medicare Supplement insurance", url: "/medicare-supplement-plans/medigap-eligibility", category: "Plans" },
  { title: "Medicare Supplement Plans 2026", description: "Updated rates and plan details for 2026", url: "/medicare-supplement-plans/medicare-supplement-plans-2026", category: "Plans" },
  { title: "Medigap by Carrier", description: "Compare Medicare Supplement plans by insurance company", url: "/medicare-supplement-plans/medigap-by-carrier", category: "Plans" },
  { title: "Medigap by State", description: "Find Medicare Supplement plans available in your state", url: "/medicare-supplement-plans/medigap-by-state", category: "Plans" },
  ...
  { title: "Turning 65 Enrollment", description: "How to enroll when you first become eligible for Medicare", url: "/medicare-enrollment/turning-65", category: "Enrollment" },
  { title: "Working past 65", description: "Medicare and employer coverage coordination", url: "/medicare-enrollment/working-past-65", category: "Enrollment" },
  { title: "Annual Changes", description: "What changes each year and how it affects your Medicare", url: "/medicare-enrollment/annual-changes", category: "Enrollment" },
  { title: "Late Enrollment Penalties", description: "Avoid costly late enrollment penalties", url: "/medicare-enrollment/late-penalties", category: "Enrollment" },
  { title: "How to Enroll in Medicare", description: "Step-by-step enrollment process guide", url: "/medicare-enrollment/how-to-enroll", category: "Enrollment" },
  ...
  { title: "Medicare Plan G", description: "Details on Medicare Supplement Plan G coverage and costs", url: "/medicare-supplement-plans/plan-g", category: "Plans" },
  { title: "Medicare Plan F", description: "Details on Medicare Supplement Plan F coverage", url: "/medicare-supplement-plans/plan-f", category: "Plans" },
  { title: "Medicare Plan N", description: "Details on Medicare Supplement Plan N coverage and costs", url: "/medicare-supplement-plans/plan-n", category: "Plans" },
  { title: "High Deductible Plan F", description: "Lower premiums with higher deductible Medigap option", url: "/medicare-supplement-plans/high-deductible-plan-f", category: "Plans" },
  { title: "High Deductible Plan G", description: "Lower premiums with higher deductible Medigap option", url: "/medicare-supplement-plans/high-deductible-plan-g", category: "Plans" },
];
