...
When the user explicitly asks Codex to create or enhance a blog article, use the available image
generation skill for a new featured image when appropriate. Otherwise, use this order:
...
node --experimental-strip-types \
     --import ./.agents/skills/new-blog-article/scripts/register-hook.mjs \
     ./.agents/skills/new-blog-article/scripts/validate-article.mjs <sections.json>
```
...
node --experimental-strip-types \
     --import ./.agents/skills/new-blog-article/scripts/register-hook.mjs \
     ./.agents/skills/new-blog-article/scripts/extract-sections.mjs <slug> <out.json>
```
