...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // ── Old /medicare-supplements/ path redirects (WordPress → Next.js) ──
      // State pages: /medicare-supplements/medigap-by-state/{state}-medigap-plans/ → /medicare-supplement-plans/{state}/
      { source: "/medicare-supplements/medigap-by-state/alabama-medigap-plans", destination: "/medicare-supplement-plans/alabama", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/alaska-medigap-plans", destination: "/medicare-supplement-plans/alaska", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/arizona-medigap-plans", destination: "/medicare-supplement-plans/arizona", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/arkansas-medigap-plans", destination: "/medicare-supplement-plans/arkansas", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/california-medigap-plans", destination: "/medicare-supplement-plans/california", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/colorado-medigap-plans", destination: "/medicare-supplement-plans/colorado", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/connecticut-medigap-plans", destination: "/medicare-supplement-plans/connecticut", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/delaware-medigap-plans", destination: "/medicare-supplement-plans/delaware", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/florida-medigap-plans", destination: "/medicare-supplement-plans/florida", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/georgia-medigap-plans", destination: "/medicare-supplement-plans/georgia", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/hawaii-medigap-plans", destination: "/medicare-supplement-plans/hawaii", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/idaho-medigap-plans", destination: "/medicare-supplement-plans/idaho", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/illinois-medigap-plans", destination: "/medicare-supplement-plans/illinois", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/indiana-medigap-plans", destination: "/medicare-supplement-plans/indiana", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/iowa-medigap-plans", destination: "/medicare-supplement-plans/iowa", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/kansas-medigap-plans", destination: "/medicare-supplement-plans/kansas", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/kentucky-medigap-plans", destination: "/medicare-supplement-plans/kentucky", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/louisiana-medigap-plans", destination: "/medicare-supplement-plans/louisiana", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/maine-medigap-plans", destination: "/medicare-supplement-plans/maine", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/maryland-medigap-plans", destination: "/medicare-supplement-plans/maryland", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/massachusetts-medigap-plans", destination: "/medicare-supplement-plans/massachusetts", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/michigan-medigap-plans", destination: "/medicare-supplement-plans/michigan", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/minnesota-medigap-plans", destination: "/medicare-supplement-plans/minnesota", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/mississippi-medigap-plans", destination: "/medicare-supplement-plans/mississippi", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/missouri-medigap-plans", destination: "/medicare-supplement-plans/missouri", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/montana-medigap-plans", destination: "/medicare-supplement-plans/montana", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/nebraska-medigap-plans", destination: "/medicare-supplement-plans/nebraska", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/nevada-medigap-plans", destination: "/medicare-supplement-plans/nevada", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/new-hampshire-medigap-plans", destination: "/medicare-supplement-plans/new-hampshire", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/new-jersey-medigap-plans", destination: "/medicare-supplement-plans/new-jersey", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/new-mexico-medigap-plans", destination: "/medicare-supplement-plans/new-mexico", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/new-york-medigap-plans", destination: "/medicare-supplement-plans/new-york", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/north-carolina-medigap-plans", destination: "/medicare-supplement-plans/north-carolina", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/north-dakota-medigap-plans", destination: "/medicare-supplement-plans/north-dakota", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/ohio-medigap-plans", destination: "/medicare-supplement-plans/ohio", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/oklahoma-medigap-plans", destination: "/medicare-supplement-plans/oklahoma", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/oregon-medigap-plans", destination: "/medicare-supplement-plans/oregon", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/pennsylvania-medigap-plans", destination: "/medicare-supplement-plans/pennsylvania", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/rhode-island-medigap-plans", destination: "/medicare-supplement-plans/rhode-island", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/south-carolina-medigap-plans", destination: "/medicare-supplement-plans/south-carolina", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/south-dakota-medigap-plans", destination: "/medicare-supplement-plans/south-dakota", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/tennessee-medigap-plans", destination: "/medicare-supplement-plans/tennessee", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/texas-medigap-plans", destination: "/medicare-supplement-plans/texas", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/utah-medigap-plans", destination: "/medicare-supplement-plans/utah", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/vermont-medigap-plans", destination: "/medicare-supplement-plans/vermont", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/virginia-medigap-plans", destination: "/medicare-supplement-plans/virginia", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/washington-medigap-plans", destination: "/medicare-supplement-plans/washington", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/west-virginia-medigap-plans", destination: "/medicare-supplement-plans/west-virginia", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/wisconsin-medigap-plans", destination: "/medicare-supplement-plans/wisconsin", permanent: true },
      { source: "/medicare-supplements/medigap-by-state/wyoming-medigap-plans", destination: "/medicare-supplement-plans/wyoming", permanent: true },
      // Carrier pages: /medicare-supplements/medigap-by-carrier/{slug}/ → /medicare-supplement-plans/medigap-by-carrier/{slug}/
      { source: "/medicare-supplements/medigap-by-carrier/:slug", destination: "/medicare-supplement-plans/medigap-by-carrier/:slug", permanent: true },
      // Other old paths
      { source: "/medicare-supplements/high-deductible-plan-g", destination: "/medicare-supplement-plans/high-deductible-plan-g", permanent: true },
      { source: "/medicare-supplements/high-deductible-plan-f", destination: "/medicare-supplement-plans/high-deductible-plan-f", permanent: true },
      { source: "/medicare-supplements/medigap-by-state", destination: "/medicare-supplement-plans/medigap-by-state", permanent: true },
      { source: "/medicare-supplements/medigap-by-carrier", destination: "/medicare-supplement-plans/medigap-by-carrier", permanent: true },
      { source: "/medicare-supplements", destination: "/medicare-supplement-plans", permanent: true },
